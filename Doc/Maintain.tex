...
Most of the \siraba\ program has in principle no limitations on the
...
We have not yet decided on how often completely new versions\index{release} of the
...
authors. Thus the authors take no responsibility\index{responsibility}
for the performance 
...
reported will lead to a new patch\index{patches} of the program, distributed from the
\siraba\ homepage.
