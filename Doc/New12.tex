...
Dalton 1.2 includes several large modules that has been added in order
...
first-order optimization methods are also available.
...
\item {\bf MCD} The \cal{B}(0$\rightarrow$ f) term contributing to
magnetic circular dichroism (MCD) have been
implemented~\cite{scarkrjopjcpl300}. 
