...
%\section{New features in Dalton2012}
...
1.	Response functions in the CC3 iterative triple excitation model.
Ove Christiansen, Henrik Koch, and Poul J\o rgensen.
J. Chem. Phys. 103, 7429 (1995).

2.	Calculation of first-order one-electron properties using the
coupled-cluster approximate triples model CC3.
Kasper Hald and Poul J\o rgensen.
Phys. Chem. Chem. Phys. 4, 5221 (2002).

3.	Calculation of frequency-dependent polarizabilities using the
...
4.	Gauge invariance of oscillator strengths in the approximate
coupled
cluster triples model CC3.
Filip Pawlowski, Poul J\o rgensen and Christof H\"{a}ttig.
Chem. Phys. Lett. 389, 413 (2004).

5.	The hyperpolarizability of the Ne atom using the approximate
coupled cluster triples model CC3.
Filip Pawlowski, Poul J\o rgensen and Christof H\"{a}ttig.
Chem. Phys. Lett. 391, 27 (2004).

6.	The hyperpolarizability of the Ne atom using the approximate
coupled cluster triples model CC3.
Filip Pawlowski, Poul J\o rgensen and Christof H\"{a}ttig.
Chem. Phys. Lett. 391, 27 (2004).

7.	The second hyperpolarizability of the N2 molecule calculated using
the approximate coupled cluster triples model CC3.
Filip Pawlowski, Poul J\o rgensen and Christof H\"{a}ttig.
Chem. Phys. Lett. 413, 272 (2005).

8.	Cauchy Moments of Ne, Ar and Kr Atoms Calculated Using the
Approximate Coupled Cluster Triples Model CC3.
Filip Pawlowski, Poul J\o rgensen and Christof H\"{a}ttig
