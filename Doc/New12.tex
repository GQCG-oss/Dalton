...
Main authors: Alfredo Sanchez de Meras, Henrik Koch, Thomas Bondo Pedersen

\item{\bf Extensions to the coupled cluster module:} CC3 etc. \\
Main authors: Christof H\"{a}ttig, Ove Christiansen, ...

\item{\bf CCSD-R12 methods:} \\
Main authors: Christian Neiss, Wim Klopper, Christof H\"{a}ttig

\item{\bf Parllel, large scale configuration interaction (LUCITA):} \\
...
\item{\bf Code for vibrational and rotational g-factors, interface to WESTA for adiabatic corrections.}  \\
Main authors: Stephan P. A. Sauer, Hans J\o rgen Aa.\ Jensen. The WESTA
program can be obtained from Hans J\o rgen Aa.\ Jensen (contact e-mail
for this: westa@dirac.chem.sdu.dk).
