...
and will be used when in \sir\ for evaluating the interactions between the
...
electric field\index{electric field, external} is signaled by the keyword \Key{FIELD}. On the next line, the
