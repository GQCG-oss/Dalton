...
\item[\Key{GASSHE}] Number and specification of GAS orbitals. 
...
\item[\Key{GASSPC}] Number and specification of sequential CI calculations. The first line specifies 
...
\item[\Key{DENSI}]  Level of computed density matrices, ``1''\ means one-particle density only, ``2'' computes one- and two-particle density matrices (default: 0) \verb| |\newline
