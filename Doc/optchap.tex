...
calculations will in general not employ any symmetry,  a complete
...
these investigation indicate that the aug-cc-pVDZ or the d-aug-cc-pVDZ
...
{\bf Reference literature:}
\begin{list}{}{}
\item MCSCF: T.Helgaker, K.Ruud, K.L.Bak, P.{\o}rgensen, and
J.Olsen. \newblock {\em Faraday Discuss.}, {\bf 99},\hspace{0.25em}165, (1994).
\item P.~L.~Polavarapu \newblock {\em Mol.~Phys.}, {\bf 91},\hspace{0.25em}551, (1997).
\item DFT: K.Ruud and T.Helgaker. {\bf 352},\hspace{0.25em}553, (2002).
\end{list}
}}
\end{center}
...
In addition to the keyword \Key{VROA} in the different \aba\ input
modules, we still need to tell the program that frequencies of the
laser field are to be
read in the \Sec{ABALNR} section.
...
center-of-mass\index{center of mass} to 
