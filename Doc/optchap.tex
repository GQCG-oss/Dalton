...
\siraba\ controlled in the \Sec{VIBANA} submodule, and the reader is
...
be computed at the same origin. Therefore, the \Key{NOCMC}
...
oscillator strength\index{transition moment}. This property can be
