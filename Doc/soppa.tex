\chapter{SOPPA calculations}\label{ch:soppa}
...
energies\index{electronic excitation} and oscillator strenghts\index{transition moment} as well as the following list of
