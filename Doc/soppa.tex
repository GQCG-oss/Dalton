...
Doubles Amplitudes -- SOPPA(CCSD) \index{SOPPA(CCSD)} calculations of optical
properties like singlet or triplet excitation energies\index{electronic
  excitation} and oscillator strenghts\index{transition moment} as well as the
...
modules of Dalton program. The equations are essentially the same as for
SOPPA.  
...
\Sec{*PROPERTIES} or \Sec{*RESPONSE} input modules it has to specified 
