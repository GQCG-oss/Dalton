...
\item[ECP]\index{Effective core potentials} The Effective Core Potential approach of Pitzer and Winter~\cite{rmpnmwijqc40} is available 
...
\item[Spin-orbit Mean-Field]\index{AMFI}\index{pin-orbit mean-field} The spin-orbit mean-field approach can be used 
