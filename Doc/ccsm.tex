...
the electric dipole moment operator (\verb+DIPLEN+ in Sec.~\Sec{*INTEGRALS}).
%
\item[\Key{HALFFR}] 
Set the frequency argument for the two-photon transition moments
equal to  half the excitation energy of the final state $f$. This is the default unless \verb+SMFREQ+ is specified in \Key{SELSTA}.
%
