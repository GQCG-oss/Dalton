...
\item[BECKE] Becke exchange correction presented in reference
  ...
  sum \fn{Slater} + \fn{Becke}.\index{BECKE}

\item[KT] Keal and Tozer GGA exchange functional \cite{dft:kt12}\index{KT}
...
\item[OPTX] exchange functional of Handy \cite{dft:optx}.\index{OPTX}

\item[P86] non-local part of the correlation functional of Perdew
  \cite{dft:p86}. PZ81 is usually used for the local part of the
  functional. \index{P86}

\item[PBEx] exchange functional \index{PBEx}

\item[PW86x]Perdew and Wang exchange functional.\cite{dft:pw86x}.\index{PW86x}

\item[PW91c] correlation functional of Perdew and Wang.
  \cite{dft:pw91}\index{PW91}

\item[PZ81] correlation functional of Perdew and Zunger \cite{dft:pz81}.\index{PZ81}
...
\item[VWN5]  correlation functional Vosko, Wilk and Nusair (number
  V -- the recommended one) \cite{dft:vwn}.\index{VWN5}
...
\begin{description}
\item[Combine] it is an universal keyword allowing to manually
...
program.\index{B3LYP-G} This functional can be explicitely set up by
...
\item[B3P86] variant of \verb|B3LYP| with VWN3 used for local
  correlation  and P86 for the nonlocal part.
  \funexample{Combine hf=0.2 slater=0.8 becke=0.72 p86c=0.81 vwn3=1}
  \index{B3P86}

\item[BHandH] is an simple Half-and-half functional included for
  compatibility with Gaussian program
  \funexample{Combine hf=0.5 slater=0.5 lyp=1}
  \index{BHandH}

\item[BHandH] is another simple Half-and-half functional included for
  compatibility with Gaussian program
  \funexample{Combine hf=0.5 slater=0.5 becke=0.5 lyp=1}
  \index{BHandH}

\item[BPW91] is a sum of Slater functional, Becke correction and
  PW91 correlation functional.\index{BPW91}
...
\item[OLYP] is the sum of the OPTX exchange functional with the
  LYP correlation functional \cite{dft:optx}.
  \funexample{Combine slater=1.05151 optx=-1.43169 lyp=1}\\
  Mixed functionals such as OP86 and OPW91 may be constructed with
  \verb|Combine|.\index{OLYP}
...
\item[SVWN3] is a sum of Slater functional and VWN3 correlation
  functional.  It is equivalent to Gaussian's LSDA functional and can
  alternatively by selected by following set of keywords
