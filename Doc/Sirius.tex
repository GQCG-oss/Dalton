...
COREHOLE: These new options (summer 1994) are added to make SCF
single core hole\index{core hole} calculations simple. To perform
...
A new feature from 1992 is the automatic identification of "super
symmetry"\index{supersymmetry}, i.e. of irreps of the true point
