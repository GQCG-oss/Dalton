...
\item[BECKE] Becke exchange correction (Full Becke functional is BECKE +
  SLATER) from \cite{dft:becke88}.\index{BECKE}
...
Baerends\cite{dft:lb94}.\index{LB94}
...
\item[P86] correlation functional of Perdew \cite{dft:p86}.\index{P86}

\item[PBEx] exchange functional \index{PBEx}

\item[PW86x]Perdew and Wang exchange functional.\cite{dft:pw86x}.\index{PW86x}

\item[PW91] correlation functional of Perdew and Wang.\cite{dft:pw91}\index{PW91}
...
\item[GGAKey] it is an universal keyword allowing to manually
  construct arbitrary linear combinations of other functionals. Even\index{GGAKey}
...
\item[BLYP] is a sum of Slater functional, Becke88 correction and LYP
  correlation functional.\index{BLYP}

\item[B3LYP] hybrid functional \cite{dft:b3lyp}.\index{B3LYP}

\item[B3LYP-G] hybrid functional with VWN3 form used for correlation---this is the form used by the Gaussian quantum chemistry program.\index{B3LYP-G}\index{B3LYP, Gaussian version}

\item[BP86] Becke88 exchange functional and Perdew86 correlation
  functional.\index{BP86}


\item[B3P86] variant of \verb|B3LYP| with P86 used to get correlation.\index{B3P98}


\item[CAMB3LYP] Coulomb Attenuated Method Functional of Yanai and
Handy\cite{dft:camb3lyp}.\index{CAMB3LYP}
...
\item[KT2] differs from KT1 only in that the weights of the Slater and
 VWN5 functionals are from an empirical fit \cite{dft:kt12,dft:kt12a}.\index{KT2}

\item[KT3] a hybrid functional of Slater, OPTX and KT exhange with the
 LYP correlation functional \cite{dft:kt3}. \index{KT3}

\item[OLYP] is the sum of the OPTX exchange functional with the
 LYP correlation functional \cite{dft:optx}. Mixed functionals such
 as OP86 and OPW91 may be constructed with \verb|GGAKey|.\index{OLYP}
...
\item[PBE] same as above but with exchange estimated exclusively by
  ...
  used by eg. CADPAC and NWChem. Observe that quantum chemistry
  program Molpro uses \verb|PW91c| correlation functional instead of
  \verb|PBEC|.
