...
\item[FT97bx] Filatov and Thiel 1997 (FT97) exchange functional GGA correction,
  ...
  is a switching function dependent on the density gradient, $\del n_{\sigma}$ 
...
\item[G961LYP] is a 1-parameter B1LYP type functional with the exchange gradient correction
  provided by the G96x functional \cite{dft:g961lyp}.
...
\item[LG1LYP] is a 1-parameter B1LYP type functional with the exchange gradient correction
  provided by the LG93x functional \cite{dft:g961lyp}.
