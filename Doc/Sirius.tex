...
\item[\Key{LOCALIZATION}]
  ...
  Two options for localization of the orbitals is currently available:
  ...
  \item[{\tt SELECT\ }] Select a subset of orbitals to be localized. The first
  line following this option contains the number orbitals per symmetry 
  and the following lines, the orbital numbers within easy symmetry, one line per symmetry. This option is typically used for localizing degenerate 
  core orbitals, leaving all others intact.
  \begin{verbatim}
