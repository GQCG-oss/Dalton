...
Functionals in dalton can be divided into two groups: primitive and
combined functionals. Combined functionals are a linear combination of
primitive ones. One can always create own combined functionals by
using \verb|GGAKey| general functional. 

\subsubsection{Primitive functionals}
\begin{description}
\item[BECKE] Becke correction (Full becke functional is BECKE +
  SLATER). Reference
...
\item[OPTX] exchange functional of Handy.

\item[P86] correlation functional of Perdew.

\item[PBEx] exchange functional 

\item[PW86x] Phys. Rev. B 33. 8800 (1986)

\item[PW91] correlation functional of Perdew and Wang, 91.

\item[PZ81] correlation functional of Perdew and Zunger.
...
\item[CAMB3LYP] Coulomb Attenuated Method Functional of Yanai and Handy.
...
\item[PBE0] a hybrid functional of Perdew, Burke and Ernzerhof with
  ...
  \verb|PW91c| correlation functional.

\item[PBE] same as above but with exchange estimated exclusively by
  \verb|PBEx| functional.

\item[PW91] correlation functional of Perdew and Wang.
