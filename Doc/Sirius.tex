...
\item[LG93] 1993 GGA exchange functional~\cite{dft:lg93}.\index{LG93}
  The LG93 exchange functional includes Slater exchange (eqn 16 from original reference).
...
\item[mPW1K] optimizes mPW1PW91 for kinetics of H abstractions, with 42.8\% Hartree--Fock
  echange \cite{dft:mpw1k}.\index{mPW1PW91}
  \funexample{Combine HF=0.428 Slater=0.572 mPW=0.572 PW91c=1}.

\item[mPW1N] optimizes mPW1PW91 for kinetics of H abstractions, with 42.8\% Hartree--Fock
  echange \cite{dft:mpw1n}.\index{mPW1N}
  \funexample{Combine HF=0.428 Slater=0.572 mPW=0.572 PW91c=1}.

\item[mPW1S] optimizes mPW1PW91 for kinetics of H abstractions, with 6\% Hartree--Fock
  echange \cite{dft:mpw1s}.\index{mPW1S}
...
\item[RPBE] is a revised \funexample{PBE} functional that employs the 
  \exfn{RPBEx} exchange functional.
  \funexample{Combine RPBEx=1 PBEc=1}

\item[revPBE] is a revised \funexample{PBE} functional that employs the 
  \exfn{revPBEx} exchange functional.
  \funexample{Combine revPBEx=1 PBEc=1}

\item[mPBE] is a revised \funexample{PBE} functional that employs the 
...
\item[PW91PW91] is the combination of PW91 exchange and PW91 correlation functionals. 
  Equivalent to \funexample{PW91} keyword \cite{dft:pw91}.
