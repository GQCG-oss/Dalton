...
functions\index{linear response}\index{quadratic response}\index{cubic response}\index{response function},
respectively, which
...
A well-known example of a linear
response\index{linear response}\index{polarizability} function is the
polarizability.
...
All components of the static second
hyperpolarizability\index{cubic response}\index{second
hyperpolarizability}
