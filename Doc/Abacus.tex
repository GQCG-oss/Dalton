...
Set the natural abundance\index{abundance!spin-spin} threshold in per cent
...
containing the abundance threshold in per cent. The default value is~1.0 (i.e. 1\%),
