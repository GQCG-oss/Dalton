...
requires the \Key{FOSBOY}, \Key{FBOCIN}, \Key{FBOOCC} or \Key{MULLOC}
...
\item [\Key{MULLOC}] The occupied molecular orbitals are localized with
the Mulliken population localization procedure~\cite{Boyloc}. It
requires the \Key{SOSOCC} keyword in the \Sec{SPIN-S} section.
