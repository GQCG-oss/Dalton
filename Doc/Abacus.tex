...
This flag also invokes the \Key{DIPGRA} flag and the \Key{POLARI} flags. Note that the charges obtained in this approach is not without conceptual problems (as are the Mulliken charges)~\cite{hskrpeojcp???}.
