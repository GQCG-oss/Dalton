...
(Ref.~\cite{paololazz1,paololazz2,ctocd}) (keyword \Key{CTOCD}).
...
approximation~\cite{mjpekdtehjajjojcp}.\index{SOPPA} This requires that the MP2 energy and wave
...
Cluster Singles and Doubles Amplitudes~\cite{soppaccsd,tejospastcan100,ekdspasjpca102,ctocd}.\index{SOPPA(CCSD)} 
...
\verb|.SOPPA| or CCSD wave functins used together with the keyword \verb|.SOPPA(CCSD)|) 
in order to get reliable results, it is recommended to 
