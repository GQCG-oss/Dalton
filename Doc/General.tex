...
geometry optimization driver\index{geometry optimization} for HF, DFT, and MCSCF.
...
for locating minima and transition states\index{geometry optimization}\index{first-order optimization}
\index{geometry optimization!first-order}\index{second-order optimization}\index{geometry optimization!second-order}
