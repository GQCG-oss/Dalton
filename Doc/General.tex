...
Chapter~\ref{ch:hermit}\index{one-electron integral}\index{two-electron integral}.
...
trajectory studies\index{dynamics} or numerical
differentiation/vibrational averaging, as these
...
Cluster and MCSCF wave functions. See Chapter~\ref{chap:inpref}.
\end{description}
...
in each iterations, default is 5.
...
referred to as symmatric rank one (SR1) or Murtagh-Sargent (MS).
...
calculations of Raman intensities and optical activity\index{Raman intensity}\index{Raman optical activity}\index{ROA},
