...
message passing interface. Furthermore, the large-scale GASCI code \lucita\ 
is also available in a fully parallelized version in the \dalton\ release. The use of the parallel code requires,
