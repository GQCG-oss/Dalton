%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Examples of coupled cluster calculations}\label{sec:ccexamples}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

We collect in this Section a few examples of input files (DALTON.INP) 
...
all the response modules in \cc \ can be used 
simultaneously---assumed they are available for all 
chosen wavefunction model(s).
For instance,  linear, quadratic and cubic response functions 
can be obtained within the same calculation.

\subsection{Multiple model energy calculations}
%
...
\subsection{First-order property calculation}
...
\subsection{Static and frequency-dependent dipole polarizabilities and
...
\subsection{Static and frequency-dependent dipole hyperpolarizabilities 
...
The corresponding dispersion coefficients up to sixth are also calculated.
...
*END OF INPUT
\end{verbatim}
Obviously, linear, quadratic and cubic response modules can be also 
run separately. 

\subsection{Excitation energies and oscillator strengths}
...
\subsection{Gradient calculation, geometry optimization}
...
\subsection{Excited state geometry optimization}
