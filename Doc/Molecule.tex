...
Sadlej-pVTZ\index{sadlej basis set}\index{ANO basis set}\index{NQvD basis set}\index{basis set!sadlej}\index{basis set!ANO}\index{basis set!NQvD}
...
4-31G & H--Ar & \cite{rdwjhjapjcp54,msgjsbjapwjpwjhjacs104} \\
  & He, He & Note: He,Ne from Gaussian 90 \\
...
\hline
\multicolumn{2}{l}{\bf{\emph{Dunning's correlation consistent basis sets}}} & \\
cc-pVXZ (X = D,T,Q,5,6) & H--Ne, Al--Ar & \cite{thdjcp90,dewthdjcp100,dewthdjcp98} 
  Note: 6Z only includes H,C--O\\
cc-pVXZ-DK (X = D,T,Q,5) & H,He,B--Ne & \cite{thdjcp90,dewthdjcp100,dewthdjcp98,akwdewkapthdjcp110} 
  cc-pVXZ recontracted for \\
  & Al--Ar, Ga--Kr & Douglas-Kroll calculations.\\
cc-pCVXZ (X = D,T,Q,5) & H, He, B--Ne & cc-pVXZ, with core functions from
  \cite{thdjcp90,dewthdjcp103}. \\
  & & Note: H,He are included but are cc-pVXZ \\
%cc-pwCVXZ (X = D,T) & H, He, C--Ne  & cc-pCVXZ with core functions from 
%  \cite{thdjcp90,kapthdjcp117} \\
%  & Al--Ar & Note: H,He are included but are cc-pVXZ \\
aug-cc-pVXZ (X = D,T,Q,5) & H,He,B--Ne & cc-pVXZ, with aug. functions from 
  \cite{thdjcp90,rakthdrjhjcp96,dewthdjcp98,dewthdjcp100}.\\
  & Al--Ar, Ga--Kr & \\
aug-cc-pCVXZ & H,He,B--F & aug-cc-pVXZ and cc-pCVXZ and Ref.~\cite{kapthdjcp117}.\\
  & Ne & Available for TZ and QZ only \\
  & P--Cl & Available for DZ, TZ and QZ only \\
  & & Note: H,He are included but are aug-cc-pVXZ \\
...
$n$-aug-cc-pCVXZ ($n$ = d,t,q) & as aug-cc-pCVXZ & aug-cc-pCVXZ. See Sec.~\ref{sec:molbasis} \\
  & & Note: H,He are included but are $n$-aug-cc-pVXZ \\
\hline
\newpage
GAMESS-VTZ & H, Be--Ne & \cite{thdjcp55,admgscjcp72,ajhwjcp52} From GAMESS program \\
...
Sadlej-pVTZ & H--I & \cite{ajstca79,ajsmujmst234,ajstca81,ajstca81-2} \\
  &  & No rare-gas, B, Al, Ga or In basis sets\\
%
...
\hline
\bf{\emph{ANO basis sets}} & & \\
NQvD & & \cite{nqvdref} See Sec.~\ref{sec:molbasis} \\
