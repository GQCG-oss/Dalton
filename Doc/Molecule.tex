...
of the \dalton\ program --- with the exception of the ANO\index{ANO basis set}\index{basis set!ANO}, 
Sadlej-pVTZ\index{sadlej basis set}\index{basis set!sadlej} 
and NQvD basis sets\index{NQvD basis set}\index{basis set!NQvD} --- have been obtained 
