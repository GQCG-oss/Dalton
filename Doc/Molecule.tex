...
\item[Basis] \verb|(Character)|. If \verb|ATOMBASIS| has been specified,
  ...
  potentials}\index{ECD} can also by used by specifying
  \verb|Basis=ECP|.
...
Augmenting\index{basis!augmented} the correlation-consistent\index{basis!correlation-consistent} 
...
\endhead
\endfoot \endlastfoot
 STO-2G & H---He & \cite{wjhrfsjapjcp51} \\
 & Li---Ne; Na---Ar& \cite{wjhrdrfsjapjcp52} \\
 & K---Ca; Sr& \cite{wjhrdrfsjapjcp52} \\
%
 STO-3G & H---He; Li---Ne & \cite{wjhrfsjapjcp51} \\
 & Na---Ar & \cite{wjhrdrfsjapjcp52} \\
 & K---Ca; Ga---Kr & \cite{wjpbalwjhrfsic19} \\
 & Sc---Zn; Y---Cd & \cite{wjpwjhjcc4} \\
%
 STO-6G & H--Ne & \cite{wjhrfsjapjcp51} \\
 & Na---Ar & \cite{wjhrdrfsjapjcp52} \\
%
3-21G & H---Ne & \cite{jsbjapwjhjacs102}\\
  & Na---Ar & \cite{msgjsbjapwjpwjhjacs104}\\
  & K, Ca, Ga---Kr & \cite{kddwjhjcc7}\\
  & Sc---Zn & \cite{kddwjhjcc8-1}\\
  & Rb---Xe & \cite{kddwjhjcc8-2}\\
  & Cs & \cite{edgdfjpc99} \\
%
3-21G* & H---Cl & 3-21G, with polarization functions from
  Ref.\cite{wjpmmfwjhdjdjapjsbjacs104}.\\
  & & Note: Polarization functions only on Na---Cl \\
3-21++G & H; Li---Ar & 3-21G, with diffuse functions from
  Ref.~\cite{tcjcgwsprsjcc4}.\\
3-21++G* & H---Cl & 3-21++G and 3-21G*\\
%
4-31G & H; C---F, P---Cl & \cite{rdwjhjapjcp54}\\
  & He, Ne & Gaussian 90 \\
  & Li, Be & These are actually 5-21G basis sets \\
  & Na---Ar & \cite{msgjsbjapwjpwjhjacs104} \\ 
%
6-31G & H, Be, C--F & \cite{wjhrdjapjcp56}\\
  & Li, B & \cite{jddjapjcp62}\\
  & He, Ne & Gaussian 90 \\
  & K---Ar & \cite{mmfwjpwjhjsbmsgdjdjapjcp77} \\
  & Zn & \cite{vrjapmrtlwjcp109} \\
6-31G* & H---He, Li---Ne & 6-31G, with polarization functions from
  Ref.~\cite{pchjaptca28}\\
  & Na---Ar & 6-31G, with polarization functions from 
  Ref.~\cite{mmfwjpwjhjsbmsgdjdjapjcp77} \\
6-31G** & H---Ne, Na---Ar  & 6-31G*, with H polarization functions from
  Ref.~\cite{pchjaptca28}\\
...
6-31++G*  & H---Ar & 6-31++G and 6-31G*\\
6-31++G** & H---Ar & 6-31++G and 6-31G**\\
6-31G(3df,3pd) & H---Ar & 6-31G, with polarization functions from
  Ref.~\cite{mjfjapjsbjcp80}.\\
%
6-311G & H---Ne & \cite{rkjsbrsjapjcp72}\\
  & Na---Ar & \cite{admgscjcp72}\\
  & Br,I & \cite{lacmpmjpbnedrcblrjcp103,mngapmpmlrjcp103} \\
6-311G* & H---Ar & 6-311G, with polarization functions from
  Ref.~\cite{rkjsbrsjapjcp72}.\\
  & Br, I & 6-311G, with polarization functions from
  Ref.~\cite{lacmpmjpbnedrcblrjcp103} \\
6-311G** & H---Ar & 6-311G, with polarization functions from
  Ref.~\cite{rkjsbrsjapjcp72}.\\
  & Br, I & 6-311G, with polarization functions from
  Ref.~\cite{lacmpmjpbnedrcblrjcp103}.\\
...
6-311++G** & H---Ne & 6-311G** with diffuse functions from
  Ref.~\cite{tcjcgwsprsjcc4}.\\
6-311G(2df,2pd) & H---Ne & 6-311G, with polarization functions from
  Ref.~\cite{mjfjapjsbjcp80}.\\
6-311++G(2d,2p) & H---Ne & 6-311++G, with polarization functions from
  Ref.~\cite{mjfjapjsbjcp80}.\\
6-311++G(3df,3pd) & H---Ar & 6-311++G, with polarization functions from
  Ref.~\cite{mjfjapjsbjcp80}.\\
%
Huckel & & \\
%
...
SVP(Dunning-Hay) & H, Li---Ne & SV, with polarization functions from
  Ref.~\cite{thdpjhhfs1977,emhfsjcp83}.\\
SVP+Diffuse(Dunning-Hay) & H, Li---Ne & SVP with diffuse functions from
  Ref.~\cite{thdpjhhfs1977,emhfsjcp83}.\\
SV+Rydberg(Dunning-Hay) & H, Li---Ne & SV, with polarization functions from
  Ref.~\cite{thdpjhhfs1977-2}.\\
SV+DoubleRydberg(Dunning-Hay) & H, Li---Ne & SV, with polarization functions from
  Ref.~\cite{thdpjhhfs1977-2}.\\
DZ(Dunning) & H, B---Ne, Al---Cl & \cite{thdjcp53,thdpjhhfs1977} \\
DZP(Dunning) & H, B---Ne, Al---Cl & DZ, with polarization functions from 
  Ref.~\cite{thdpjhhfs1977,emhfsjcp83}.\\
DZP+Diffuse(Dunning) & H, B---Ne & DZP with diffuse functions from
  Ref.~\cite{thdpjhhfs1977,emhfsjcp83}.\\
DZ+Rydberg(Dunning) & H, B---Ne, Al---Cl & DZ, with polarization functions from
  Ref.~\cite{thdpjhhfs1977-2}.\\
DZP+Rydberg(Dunning) & H, B---Ne, Al---Cl & DZP, with polarization functions from 
  Ref.~\cite{thdpjhhfs1977-2}.\\
