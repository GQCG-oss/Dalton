...
file \verb|DALTON.BAS| by using the keyword \Key{MOLPRI} in the
\Sec{READIN} submodule.
...
when doing MCSCF\index{MCSCF} calculations, as symmetry
generators\index{symmetry generator} and their order 
...
diffuse, thight or polarizing\index{polarization function} functions,
