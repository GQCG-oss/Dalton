...
Augmenting the correlation-consistent\index{basis!correlation-consistent} 
sets of Dunning may be done in a simple manner in \dalton. 
The aug-cc-pVXZ basis sets are extended in an even-tempered manner 
by including a 'd', 't' or 'q' prefix to give doubly, triply or quadruply 
augmented basis sets, respectively. For example, specifying Basis=daug-cc-pVDZ will
produce a doubly augmented cc-pVDZ basis. These basis sets are not listed 
explicitly in the library\index{basis set!library}, 
