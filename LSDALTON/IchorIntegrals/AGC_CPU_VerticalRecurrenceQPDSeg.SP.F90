module SPAGC_CPU_OBS_VERTICALRECURRENCEMODDSeg
 use IchorPrecisionMod
  
 CONTAINS


subroutine SPVerticalRecurrenceCPUSeg1D(nPassP,nPrimP,nPrimQ,&
...
!$OMP         iP,iPrimQ,iPrimP,iPrimQP,iPassP)
  ...
  ENDDO !iP = 1,nPassP
!$OMP END DO
end subroutine SPVerticalRecurrenceCPUSeg1D

subroutine SPVerticalRecurrenceCPUSeg2D(nPassP,nPrimP,nPrimQ,&
...
subroutine SPVerticalRecurrenceCPUSeg3D(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Dcenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
