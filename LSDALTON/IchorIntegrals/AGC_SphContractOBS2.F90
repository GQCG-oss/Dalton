MODULE AGC_OBS_Sphcontract2Mod
!Automatic Generated Code (AGC) by runSphContractOBS2.f90 in tools directory
use IchorPrecisionModule  
  
 CONTAINS
  
subroutine SphericalContractOBS2_maxAngQ2_maxAngC2(nlmP,nContPasses,IN,OUT)
  implicit none
...
!$OMP PARALLEL DO DEFAULT(none) PRIVATE(iPass,ijkP) SHARED(nlmP,nContPasses,IN,OUT)
...
subroutine SphericalContractOBS2_maxAngQ2_maxAngC0(nlmP,nContPasses,IN,OUT)
  implicit none
  integer,intent(in)        :: nlmP,nContPasses
  real(realk),intent(in)    :: IN(nlmP,  6,nContPasses)
  real(realk),intent(inout) :: OUT(nlmP,  5,nContPasses)
...
subroutine SphericalContractOBS2_maxAngQ3_maxAngC2(nlmP,nContPasses,IN,OUT)
  implicit none
  integer,intent(in)        :: nlmP,nContPasses
...
subroutine SphericalContractOBS2_maxAngQ3_maxAngC1(nlmP,nContPasses,IN,OUT)
  implicit none
  integer,intent(in)        :: nlmP,nContPasses
  real(realk),intent(in)    :: IN(nlmP, 18,nContPasses)
  real(realk),intent(inout) :: OUT(nlmP, 15,nContPasses)
...
subroutine SphericalContractOBS2_maxAngQ4_maxAngC2(nlmP,nContPasses,IN,OUT)
  implicit none
  integer,intent(in)        :: nlmP,nContPasses
...
END MODULE AGC_OBS_Sphcontract2Mod
