module SPAGC_GPU_OBS_TRMODDtoASeg
 use IchorPrecisionMod
  
 CONTAINS
 subroutine SPTransferRecurrenceGPUP1Q2DtoASeg(nPasses,nPrimP,nPrimQ,reducedExponents,&
...
!$ACC LOOP SEQ
  ...
  ENDDO !iP = 1,nPasses
 end subroutine SPTransferRecurrenceGPUP1Q2DtoASeg
 subroutine SPTransferRecurrenceGPUP1Q3DtoASeg(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & Pexp,Qexp,Pdistance12,Qdistance12,Cexp,Bexp,nPrimA,nPrimB,nPrimC,nPrimD,&
         & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,Aux,Aux2,iASync)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ,nPrimA,nPrimB,nPrimC,nPrimD,nAtomsA,nAtomsB,MaxPasses
...
!$ACC LOOP SEQ
   ...
   ENDDO !iPrimQP = 1,nPrimQ*nPrimP
  ENDDO !iP = 1,nPasses
 end subroutine SPTransferRecurrenceGPUP1Q3DtoASeg
 subroutine SPTransferRecurrenceGPUP2Q3DtoASeg(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & Pexp,Qexp,Pdistance12,Qdistance12,Cexp,Bexp,nPrimA,nPrimB,nPrimC,nPrimD,&
         & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,Aux,Aux2,iASync)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ,nPrimA,nPrimB,nPrimC,nPrimD,nAtomsA,nAtomsB,MaxPasses
...
!$ACC LOOP SEQ
   ...
   ENDDO !iPrimQP = 1,nPrimQ*nPrimP
  ENDDO !iP = 1,nPasses
 end subroutine SPTransferRecurrenceGPUP2Q3DtoASeg
end module
