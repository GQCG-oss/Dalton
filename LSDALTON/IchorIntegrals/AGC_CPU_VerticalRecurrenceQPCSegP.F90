...
subroutine VerticalRecurrenceCPUSegP1C(nPassP,nPrimP,nPrimQ,&
...
!$OMP END DO
end subroutine VerticalRecurrenceCPUSegP1C

subroutine VerticalRecurrenceCPUSegP2C(nPassP,nPrimP,nPrimQ,&
...
subroutine VerticalRecurrenceCPUSegP3C(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Ccenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
...
subroutine VerticalRecurrenceCPUSegP4C(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Ccenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
