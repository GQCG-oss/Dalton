...
private   
public :: ICI_GPU_OBS_SegQ,ICI_GPU_OBS_general_sizeSegQ  
...
!    nlmD = 2*AngmomD+1
    ...
    CASE(1110)  !Angmom(A= 1,B= 1,C= 1,D= 0) combi
        ...
        ENDIF
#endif
        call HorizontalRR_GPU_RHS_Q1C1D0CtoD(nContP,nPasses,9,Qdistance12,TMParray1,&
            & LOCALINTS,lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(1111)  !Angmom(A= 1,B= 1,C= 1,D= 1) combi
        ...
        ENDIF
#endif
        call HorizontalRR_GPU_RHS_Q2C1D1CtoD(nContP,nPasses,9,Qdistance12,TMParray1,&
            & LOCALINTS,lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(2000)  !Angmom(A= 2,B= 0,C= 0,D= 0) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_GPU_maxAngP2_maxAngA2(1,nContP*nPasses,TMParray2,&
            & LOCALINTS,iASync)
        !no need for RHS Horizontal recurrence relations 
        !no Spherical Transformation RHS needed
    ...
    CASE(2022)  !Angmom(A= 2,B= 0,C= 2,D= 2) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_GPU_maxAngP2_maxAngA2(35,nContP*nPasses,TMParray1,&
            & TMParray2,iASync)
#ifdef VAR_DEBUGICHOR
    ...
    CASE(2100)  !Angmom(A= 2,B= 1,C= 0,D= 0) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_GPU_maxAngP3_maxAngA2(1,nContP*nPasses,TMParray2,&
            & LOCALINTS,iASync)
        !no need for RHS Horizontal recurrence relations 
        !no Spherical Transformation RHS needed
    ...
    CASE(2122)  !Angmom(A= 2,B= 1,C= 2,D= 2) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_GPU_maxAngP3_maxAngA2(35,nContP*nPasses,TMParray1,&
            & TMParray2,iASync)
#ifdef VAR_DEBUGICHOR
    ...
    CASE(2200)  !Angmom(A= 2,B= 2,C= 0,D= 0) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_GPU_maxAngP4_maxAngA2(1,nContP*nPasses,TMParray2,&
            & LOCALINTS,iASync)
        !no need for RHS Horizontal recurrence relations 
        !no Spherical Transformation RHS needed
    CASE(2210)  !Angmom(A= 2,B= 2,C= 1,D= 0) combi
        ...
        ENDIF
#endif
        call HorizontalRR_GPU_RHS_Q1C1D0CtoD(nContP,nPasses,25,Qdistance12,TMParray2,&
            & LOCALINTS,lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(2211)  !Angmom(A= 2,B= 2,C= 1,D= 1) combi
        ...
        ENDIF
#endif
        call HorizontalRR_GPU_RHS_Q2C1D1CtoD(nContP,nPasses,25,Qdistance12,TMParray2,&
            & LOCALINTS,lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(2220)  !Angmom(A= 2,B= 2,C= 2,D= 0) combi
        ...
        ENDIF
#endif
        call HorizontalRR_GPU_RHS_Q2C2D0CtoD(nContP,nPasses,25,Qdistance12,TMParray2,&
            & TMParray1,lupri,iASync)
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*125.GT.LOCALINTSmaxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call SphericalContractOBS2_GPU_maxAngQ2_maxAngC2(25,nContP*nPasses,TMParray1,&
            & LOCALINTS,iASync)
    CASE(2221)  !Angmom(A= 2,B= 2,C= 2,D= 1) combi
        ...
        ENDIF
#endif
        call HorizontalRR_GPU_RHS_Q3C2D1CtoD(nContP,nPasses,25,Qdistance12,TMParray2,&
            & TMParray1,lupri,iASync)
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*375.GT.LOCALINTSmaxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call SphericalContractOBS2_GPU_maxAngQ3_maxAngC2(25,nContP*nPasses,TMParray1,&
            & LOCALINTS,iASync)
    CASE(2222)  !Angmom(A= 2,B= 2,C= 2,D= 2) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_GPU_maxAngP4_maxAngA2(35,nContP*nPasses,TMParray1,&
            & TMParray2,iASync)
#ifdef VAR_DEBUGICHOR
        ...
        ENDIF
#endif
        call HorizontalRR_GPU_RHS_Q4C2D2CtoD(nContP,nPasses,25,Qdistance12,TMParray2,&
            & TMParray1,lupri,iASync)
#ifdef VAR_DEBUGICHOR
        ...
        ENDIF
#endif
        call SphericalContractOBS2_GPU_maxAngQ4_maxAngC2(25,nContP*nPasses,TMParray1,&
            & LOCALINTS,iASync)
  ...
  subroutine ICI_GPU_OBS_general_sizeSegQ(TMParray1maxsize,&
    ...
    END SELECT
  end subroutine ICI_GPU_OBS_general_sizeSegQ
