module SPIchorEriCoulombintegralCPUOBSGeneralModSeg1PrimSize
...
private   
public :: SPICI_CPU_OBS_general_sizeSeg1Prim  
  
CONTAINS
  subroutine SPICI_CPU_OBS_general_sizeSeg1Prim(TMParray1maxsize,&
    ...
    CASE DEFAULT
     call SPICI_CPU_McM_general_size(TMParray1maxsize,&
         ...
         & .TRUE.,.TRUE.)
    END SELECT
  end subroutine SPICI_CPU_OBS_general_sizeSeg1Prim
  
END module SPIchorEriCoulombintegralCPUOBSGeneralModSeg1PrimSize
