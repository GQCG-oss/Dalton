module SPAGC_CPU_OBS_VERTICALRECURRENCEMODBSegP
 use IchorPrecisionMod
  
 CONTAINS


subroutine SPVerticalRecurrenceCPUSegP1B(nPassP,nPrimP,nPrimQ,&
...
!$OMP END DO
end subroutine SPVerticalRecurrenceCPUSegP1B

subroutine SPVerticalRecurrenceCPUSegP2B(nPassP,nPrimP,nPrimQ,&
...
subroutine SPVerticalRecurrenceCPUSegP3B(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Pexp,Bcenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
