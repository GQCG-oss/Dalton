module SPAGC_GPU_OBS_VERTICALRECURRENCEMODBSegQ
 use IchorPrecisionMod
  
 CONTAINS


subroutine SPVerticalRecurrenceGPUSegQ1B(nPassP,nPrimP,nPrimQ,&
...
end subroutine SPVerticalRecurrenceGPUSegQ1B

subroutine SPVerticalRecurrenceGPUSegQ2B(nPassP,nPrimP,nPrimQ,&
...
subroutine SPVerticalRecurrenceGPUSegQ3B(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Pexp,Bcenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray,iASync)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
