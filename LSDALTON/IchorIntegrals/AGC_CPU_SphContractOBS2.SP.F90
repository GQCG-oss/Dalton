module SPAGC_CPU_OBS_Sphcontract2Mod
!Automatic Generated Code (AGC) by runSphContractOBS2.f90 in tools directory
use IchorPrecisionMod
  
 CONTAINS
  
 subroutine SPSphericalContractOBS2_CPU_maxAngQ2_maxAngC2(nlmP,nContPasses,IN,OUT)
  implicit none
  integer,intent(in)        :: nlmP,nContPasses
  real(reals),intent(in)    :: IN(nlmP,  6,nContPasses)
  real(reals),intent(inout) :: OUT(nlmP,  5,nContPasses)
...
!$OMP DO PRIVATE(iPass,ijkP)
  ...
  ENDDO
!$OMP END DO
end subroutine SPSphericalContractOBS2_CPU_maxAngQ2_maxAngC2 
  
  
 subroutine SPSphericalContractOBS2_CPU_maxAngQ2_maxAngC0(nlmP,nContPasses,IN,OUT)
  implicit none
  integer,intent(in)        :: nlmP,nContPasses
  real(reals),intent(in)    :: IN(nlmP,  6,nContPasses)
  real(reals),intent(inout) :: OUT(nlmP,  5,nContPasses)
...
!$OMP DO PRIVATE(iPass,ijkP)
  ...
  ENDDO
!$OMP END DO
end subroutine SPSphericalContractOBS2_CPU_maxAngQ2_maxAngC0 
  
  
 subroutine SPSphericalContractOBS2_CPU_maxAngQ3_maxAngC2(nlmP,nContPasses,IN,OUT)
  implicit none
  integer,intent(in)        :: nlmP,nContPasses
  real(reals),intent(in)    :: IN(nlmP, 18,nContPasses)
  real(reals),intent(inout) :: OUT(nlmP, 15,nContPasses)
  integer :: iPass,ijkP,iP
  real(reals),parameter :: SPHMAT1_3      =   -2.8867513459481292E-01_reals
  real(reals),parameter :: SPHMAT1_5      =    5.0000000000000000E-01_reals
  real(reals),parameter :: SPHMAT2_1      =    1.0000000000000000E+00_reals
...
!$OMP DO PRIVATE(iPass,ijkP)
  ...
  ENDDO
!$OMP END DO
end subroutine SPSphericalContractOBS2_CPU_maxAngQ3_maxAngC2 
  
  
 subroutine SPSphericalContractOBS2_CPU_maxAngQ3_maxAngC1(nlmP,nContPasses,IN,OUT)
  implicit none
  integer,intent(in)        :: nlmP,nContPasses
  real(reals),intent(in)    :: IN(nlmP, 18,nContPasses)
  real(reals),intent(inout) :: OUT(nlmP, 15,nContPasses)
...
!$OMP DO PRIVATE(iPass,ijkP)
  ...
  ENDDO
!$OMP END DO
end subroutine SPSphericalContractOBS2_CPU_maxAngQ3_maxAngC1 
  
  
 subroutine SPSphericalContractOBS2_CPU_maxAngQ4_maxAngC2(nlmP,nContPasses,IN,OUT)
  implicit none
  integer,intent(in)        :: nlmP,nContPasses
  real(reals),intent(in)    :: IN(nlmP, 36,nContPasses)
  real(reals),intent(inout) :: OUT(nlmP, 25,nContPasses)
  integer :: iPass,ijkP,iP
...
!$OMP DO PRIVATE(iPass,ijkP)
  ...
  ENDDO
!$OMP END DO
end subroutine SPSphericalContractOBS2_CPU_maxAngQ4_maxAngC2 
  
  
END module SPAGC_CPU_OBS_Sphcontract2Mod
