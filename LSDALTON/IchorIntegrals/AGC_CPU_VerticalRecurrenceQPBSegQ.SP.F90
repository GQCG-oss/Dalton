module SPAGC_CPU_OBS_VERTICALRECURRENCEMODBSegQ
 use IchorPrecisionMod
  
 CONTAINS


subroutine SPVerticalRecurrenceCPUSegQ1B(nPassP,nPrimP,nPrimQ,&
...
!$OMP END DO
end subroutine SPVerticalRecurrenceCPUSegQ1B

subroutine SPVerticalRecurrenceCPUSegQ2B(nPassP,nPrimP,nPrimQ,&
...
subroutine SPVerticalRecurrenceCPUSegQ3B(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Pexp,Bcenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
