module SPAGC_CPU_OBS_VERTICALRECURRENCEMODASeg
 use IchorPrecisionMod
  
 CONTAINS

subroutine SPVerticalRecurrenceCPUSeg0(nPassP,nPrimP,nPrimQ,&
...
!     !  0 < WVAL < 12 
  ...
  ENDDO !iP = 1,nPassP
!$OMP END DO
end subroutine SPVerticalRecurrenceCPUSeg0

subroutine SPVerticalRecurrenceCPUSeg1A(nPassP,nPrimP,nPrimQ,&
...
!$OMP DO PRIVATE(iPassP)
  DO iPassP = 1,nPassP
   AUXarray(1,iPassP)=0.0E0_reals
   AUXarray(2,iPassP)=0.0E0_reals
   AUXarray(3,iPassP)=0.0E0_reals
   AUXarray(4,iPassP)=0.0E0_reals
  ENDDO
!$OMP END DO
!$OMP DO &
!$OMP PRIVATE(iAtomA,iAtomB,Xpq,Ypq,Zpq,&
...
!$OMP         iP,iPrimQ,iPrimP,iPrimQP,iPassP)
  ...
  ENDDO !iP = 1,nPassP
!$OMP END DO
end subroutine SPVerticalRecurrenceCPUSeg1A

subroutine SPVerticalRecurrenceCPUSeg2A(nPassP,nPrimP,nPrimQ,&
...
!$OMP DO PRIVATE(iPassP,iTUV)
  DO iPassP = 1,nPassP
   DO iTUV=1,   10
    AUXarray(iTUV,iPassP)=0.0E0_reals
   ENDDO
  ENDDO
!$OMP END DO
!$OMP DO &
...
subroutine SPVerticalRecurrenceCPUSeg3A(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Pexp,Acenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
...
subroutine SPVerticalRecurrenceCPUSeg4A(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Pexp,Acenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
