module SPAGC_CPU_OBS_VERTICALRECURRENCEMODASeg1Prim
 use IchorPrecisionMod
  
 CONTAINS

subroutine SPVerticalRecurrenceCPUSeg1Prim0(nPassP,nPrimP,nPrimQ,&
...
!     !  0 < WVAL < 12 
  ...
  ENDDO !iP = 1,nPassP
!$OMP END DO
end subroutine SPVerticalRecurrenceCPUSeg1Prim0

subroutine SPVerticalRecurrenceCPUSeg1Prim1A(nPassP,nPrimP,nPrimQ,&
...
!$OMP         iP,iPassP)
  ...
  ENDDO !iP = 1,nPassP
!$OMP END DO
end subroutine SPVerticalRecurrenceCPUSeg1Prim1A

subroutine SPVerticalRecurrenceCPUSeg1Prim2A(nPassP,nPrimP,nPrimQ,&
...
subroutine SPVerticalRecurrenceCPUSeg1Prim3A(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Pexp,Acenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
...
subroutine SPVerticalRecurrenceCPUSeg1Prim4A(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Pexp,Acenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
...
subroutine SPVerticalRecurrenceCPUSeg1Prim5A(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Pexp,Acenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
...
subroutine SPVerticalRecurrenceCPUSeg1Prim6A(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Pexp,Acenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
...
subroutine SPVerticalRecurrenceCPUSeg1Prim7A(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Pexp,Acenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
...
subroutine SPVerticalRecurrenceCPUSeg1Prim8A(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Pexp,Acenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
  integer,intent(in) :: MaxPasses,nAtomsA,nAtomsB
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(in) :: RJ000Array(0: 8,nPassP)
  real(reals),intent(in) :: reducedExponents(1),Pexp(1)
  real(reals),intent(in) :: Pcent(3,nAtomsA,nAtomsB),Qcent(3),integralPrefactor(1),QpreExpFac(1),PpreExpFac(nAtomsA,nAtomsB)
  real(reals),intent(in) :: Acenter(3,nAtomsA)
  real(reals),intent(inout) :: AUXarray(  165,nPassP)
  !local variables
  integer :: iPassP,ipnt,IP,iTUV,iAtomA,iAtomB
