...
!    logical :: CREATED(-2:8,-2:8,-2:8)
    ...
    WRITE(*,'(A)')'subroutine VerticalRecurrence1C(nPasses,nPrimP,nPrimQ,reducedExponents,&'
    WRITE(*,'(A)')'         & TABFJW,Qexp,Ccenter,Pcent,Qcent,integralPrefactor,PpreExpFac,&'
...
!    WRITE(*,'(A)')'!  REAL(REALK),intent(in) :: RJ000(0:1,nPrimQ,nPrimP,nPasses)'
    ...
    WRITE(*,'(A)')'  real(realk),intent(in) :: Pcent(3,nPrimP),Qcent(3,nPrimQ,nPasses),Ccenter(3,nPasses)'
    ...
    WRITE(*,'(A)')'  real(realk) :: Cx,Cy,Cz,Pexpfac,PX,PY,PZ,Xqc,Yqc,Zqc,RJ000(0:1)'
    ...
    WRITE(*,'(A)')'   Cx = -Ccenter(1,iPassQ)'
    WRITE(*,'(A)')'   Cy = -Ccenter(2,iPassQ)'
    WRITE(*,'(A)')'   Cz = -Ccenter(3,iPassQ)'
    ...
    WRITE(*,'(A)')'     Xpq = PX - Qcent(1,iPrimQ,iPassQ)'
    WRITE(*,'(A)')'     Ypq = PY - Qcent(2,iPrimQ,iPassQ)'
    WRITE(*,'(A)')'     Zpq = PZ - Qcent(3,iPrimQ,iPassQ)'
    ...
    DO JMAX=2,MaxAngmomQP
       ...
       WRITE(*,'(A)')''
       WRITE(*,'(A,I1,A)')'subroutine VerticalRecurrence',JMAX,'C(nPasses,nPrimP,nPrimQ,reducedExponents,&'
       WRITE(*,'(A)')'         & TABFJW,Qexp,Ccenter,Pcent,Qcent,integralPrefactor,PpreExpFac,QpreExpFac,&'
       WRITE(*,'(A)')'         & AUXarray)'
       WRITE(*,'(A)')'  implicit none'
       WRITE(*,'(A)')'  integer,intent(in) :: nPasses,nPrimP,nPrimQ'
       WRITE(*,'(A)')'  real(realk),intent(in) :: reducedExponents(nPrimQ,nPrimP),Qexp(nPrimQ)'
       ...
       WRITE(*,'(A)')'  real(realk),intent(in) :: Pcent(3,nPrimP),Ccenter(3,nPasses),Qcent(3,nPrimQ,nPasses)'
       WRITE(*,'(A,I2,A)')'  REAL(REALK),intent(in) :: TABFJW(0:',JMAX+3,',0:1200)'
       WRITE(*,'(A)')'  !Local variables'
       WRITE(*,'(A)')'  integer :: iPassQ,iPrimP,iPrimQ,IPNT,IP'
       WRITE(*,'(A)')'  real(realk) :: Cx,Cy,Cz,Pexpfac,invexpQ,inv2expQ,PX,PY,PZ,Xqc,Yqc,Zqc,WVAL'
