module SPAGC_GPU_OBS_BUILDRJ000MODGen
 use IchorPrecisionMod
  
 CONTAINS

subroutine SPBuildRJ000GPUGen2(nPassP,nPrimP,nPrimQ,reducedExponents,&
  ...
  real(reals),intent(inout) :: RJ000array(nPrimQ*nPrimP*nPassP,0: 2)
...
subroutine SPBuildRJ000GPUGen3(nPassP,nPrimP,nPrimQ,reducedExponents,&
         & TABFJW,Pcent,Qcent,IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,&
         & RJ000array,iASync)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
  ...
  real(reals),intent(in) :: reducedExponents(nPrimQ,nPrimP)
  real(reals),intent(in) :: Pcent(3,nPrimP,nAtomsA,nAtomsB),Qcent(3,nPrimQ)
  real(reals),intent(inout) :: RJ000array(nPrimQ*nPrimP*nPassP,0: 3)
  integer(kind=acckind),intent(in) :: iASync
  !local variables
  integer :: iP,iPrimQ,iPrimP,iPassP,ipnt,iAtomA,iAtomB
  real(reals) :: mPX,mPY,mPZ,Xpq,Ypq,Zpq
...
subroutine SPBuildRJ000GPUGen4(nPassP,nPrimP,nPrimQ,reducedExponents,&
         & TABFJW,Pcent,Qcent,IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,&
         & RJ000array,iASync)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
  ...
  real(reals),intent(in) :: reducedExponents(nPrimQ,nPrimP)
  real(reals),intent(in) :: Pcent(3,nPrimP,nAtomsA,nAtomsB),Qcent(3,nPrimQ)
  real(reals),intent(inout) :: RJ000array(nPrimQ*nPrimP*nPassP,0: 4)
  integer(kind=acckind),intent(in) :: iASync
  !local variables
  integer :: iP,iPrimQ,iPrimP,iPassP,ipnt,iAtomA,iAtomB
  real(reals) :: mPX,mPY,mPZ,Xpq,Ypq,Zpq
...
subroutine SPBuildRJ000GPUGen5(nPassP,nPrimP,nPrimQ,reducedExponents,&
         & TABFJW,Pcent,Qcent,IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,&
         & RJ000array,iASync)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
  ...
  real(reals),intent(in) :: reducedExponents(nPrimQ,nPrimP)
  real(reals),intent(in) :: Pcent(3,nPrimP,nAtomsA,nAtomsB),Qcent(3,nPrimQ)
  real(reals),intent(inout) :: RJ000array(nPrimQ*nPrimP*nPassP,0: 5)
  integer(kind=acckind),intent(in) :: iASync
  !local variables
  integer :: iP,iPrimQ,iPrimP,iPassP,ipnt,iAtomA,iAtomB
  real(reals) :: mPX,mPY,mPZ,Xpq,Ypq,Zpq
...
subroutine SPBuildRJ000GPUGen6(nPassP,nPrimP,nPrimQ,reducedExponents,&
         & TABFJW,Pcent,Qcent,IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,&
         & RJ000array,iASync)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
  ...
  real(reals),intent(in) :: reducedExponents(nPrimQ,nPrimP)
  real(reals),intent(in) :: Pcent(3,nPrimP,nAtomsA,nAtomsB),Qcent(3,nPrimQ)
  real(reals),intent(inout) :: RJ000array(nPrimQ*nPrimP*nPassP,0: 6)
  integer(kind=acckind),intent(in) :: iASync
  !local variables
  integer :: iP,iPrimQ,iPrimP,iPassP,ipnt,iAtomA,iAtomB
  real(reals) :: mPX,mPY,mPZ,Xpq,Ypq,Zpq
...
subroutine SPBuildRJ000GPUGen7(nPassP,nPrimP,nPrimQ,reducedExponents,&
         & TABFJW,Pcent,Qcent,IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,&
         & RJ000array,iASync)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
  ...
  real(reals),intent(in) :: reducedExponents(nPrimQ,nPrimP)
  real(reals),intent(in) :: Pcent(3,nPrimP,nAtomsA,nAtomsB),Qcent(3,nPrimQ)
  real(reals),intent(inout) :: RJ000array(nPrimQ*nPrimP*nPassP,0: 7)
  integer(kind=acckind),intent(in) :: iASync
  !local variables
  integer :: iP,iPrimQ,iPrimP,iPassP,ipnt,iAtomA,iAtomB
  real(reals) :: mPX,mPY,mPZ,Xpq,Ypq,Zpq
...
subroutine SPBuildRJ000GPUGen8(nPassP,nPrimP,nPrimQ,reducedExponents,&
         & TABFJW,Pcent,Qcent,IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,&
         & RJ000array,iASync)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
  ...
  real(reals),intent(in) :: reducedExponents(nPrimQ,nPrimP)
  real(reals),intent(in) :: Pcent(3,nPrimP,nAtomsA,nAtomsB),Qcent(3,nPrimQ)
  real(reals),intent(inout) :: RJ000array(nPrimQ*nPrimP*nPassP,0: 8)
  integer(kind=acckind),intent(in) :: iASync
  !local variables
  integer :: iP,iPrimQ,iPrimP,iPassP,ipnt,iAtomA,iAtomB
  real(reals) :: mPX,mPY,mPZ,Xpq,Ypq,Zpq
