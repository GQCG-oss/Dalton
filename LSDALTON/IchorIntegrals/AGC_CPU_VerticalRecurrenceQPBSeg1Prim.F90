...
subroutine VerticalRecurrenceCPUSeg1Prim1B(nPasses,nPrimP,nPrimQ,reducedExponents,&
  ...
  DO iPassQ = 1,nPasses
    ...
    Zpb = Pcent(3) + Bz
     ...
     AUXarray(2,iPassQ) = Xpb*TMP1 + alphaXpq*TMP2
     AUXarray(3,iPassQ) = Ypb*TMP1 + alphaYpq*TMP2
     AUXarray(4,iPassQ) = Zpb*TMP1 + alphaZpq*TMP2
  enddo
end subroutine
  ...
  DO iPassQ = 1,nPasses
   iP = iPassQ
    ...
    Zpb = Pcent(3) + Bz
     ...
     enddo
     AuxArray(5,IPassQ) = Xpb*TMPAuxArray(2) + alphaXpq*TmpArray2(2,2) + TwoTerms(1)
     AuxArray(6,IPassQ) = Xpb*TMPAuxArray(3) + alphaXpq*TmpArray2(3,2)
     AuxArray(7,IPassQ) = Xpb*TMPAuxArray(4) + alphaXpq*TmpArray2(4,2)
     AuxArray(8,IPassQ) = Ypb*TMPAuxArray(3) + alphaYpq*TmpArray2(3,2) + TwoTerms(1)
     AuxArray(9,IPassQ) = Ypb*TMPAuxArray(4) + alphaYpq*TmpArray2(4,2)
     AuxArray(10,IPassQ) = Zpb*TMPAuxArray(4) + alphaZpq*TmpArray2(4,2) + TwoTerms(1)
  ENDDO
 end subroutine
   ...
   iP = iPassQ
    ...
    Zpb = Pcent(3) + Bz
     ...
     do iTUV = 1,   10
      AuxArray(iTUV,IPassQ) = TMPAuxarray(iTUV)
     enddo
     AuxArray(11,IPassQ) = Xpb*TMPAuxArray(5) + alphaXpq*TmpArray3(5,2) + 2*TwoTerms(1)
     AuxArray(12,IPassQ) = Ypb*TMPAuxArray(5) + alphaYpq*TmpArray3(5,2)
     AuxArray(13,IPassQ) = Zpb*TMPAuxArray(5) + alphaZpq*TmpArray3(5,2)
     AuxArray(14,IPassQ) = Xpb*TMPAuxArray(8) + alphaXpq*TmpArray3(8,2)
     AuxArray(15,IPassQ) = Xpb*TMPAuxArray(9) + alphaXpq*TmpArray3(9,2)
     AuxArray(16,IPassQ) = Xpb*TMPAuxArray(10) + alphaXpq*TmpArray3(10,2)
     AuxArray(17,IPassQ) = Ypb*TMPAuxArray(8) + alphaYpq*TmpArray3(8,2) + 2*TwoTerms(2)
     AuxArray(18,IPassQ) = Zpb*TMPAuxArray(8) + alphaZpq*TmpArray3(8,2)
     AuxArray(19,IPassQ) = Ypb*TMPAuxArray(10) + alphaYpq*TmpArray3(10,2)
     AuxArray(20,IPassQ) = Zpb*TMPAuxArray(10) + alphaZpq*TmpArray3(10,2) + 2*TwoTerms(3)
  ENDDO
 end subroutine
   ...
   iP = iPassQ
    ...
    Zpb = Pcent(3) + Bz
     ...
     do iTUV = 1,   20
      AuxArray(iTUV,IPassQ) = TMPAuxarray(iTUV)
     enddo
     AuxArray(21,IPassQ) = Xpb*TMPAuxArray(11) + alphaXpq*TmpArray4(11,2) + 3*TwoTerms(1)
     AuxArray(22,IPassQ) = Ypb*TMPAuxArray(11) + alphaYpq*TmpArray4(11,2)
     AuxArray(23,IPassQ) = Zpb*TMPAuxArray(11) + alphaZpq*TmpArray4(11,2)
     AuxArray(24,IPassQ) = Xpb*TMPAuxArray(14) + alphaXpq*TmpArray4(14,2) + TwoTerms(2)
     AuxArray(25,IPassQ) = Ypb*TMPAuxArray(13) + alphaYpq*TmpArray4(13,2)
     AuxArray(26,IPassQ) = Xpb*TMPAuxArray(16) + alphaXpq*TmpArray4(16,2) + TwoTerms(3)
     AuxArray(27,IPassQ) = Xpb*TMPAuxArray(17) + alphaXpq*TmpArray4(17,2)
     AuxArray(28,IPassQ) = Xpb*TMPAuxArray(18) + alphaXpq*TmpArray4(18,2)
     AuxArray(29,IPassQ) = Xpb*TMPAuxArray(19) + alphaXpq*TmpArray4(19,2)
     AuxArray(30,IPassQ) = Xpb*TMPAuxArray(20) + alphaXpq*TmpArray4(20,2)
     AuxArray(31,IPassQ) = Ypb*TMPAuxArray(17) + alphaYpq*TmpArray4(17,2) + 3*TwoTerms(2)
     AuxArray(32,IPassQ) = Zpb*TMPAuxArray(17) + alphaZpq*TmpArray4(17,2)
     AuxArray(33,IPassQ) = Ypb*TMPAuxArray(19) + alphaYpq*TmpArray4(19,2) + TwoTerms(3)
     AuxArray(34,IPassQ) = Ypb*TMPAuxArray(20) + alphaYpq*TmpArray4(20,2)
     AuxArray(35,IPassQ) = Zpb*TMPAuxArray(20) + alphaZpq*TmpArray4(20,2) + 3*TwoTerms(3)
  ENDDO
 end subroutine
   ...
   iP = iPassQ
    ...
    Zpb = Pcent(3) + Bz
     ...
     do iTUV = 1,   35
      AuxArray(iTUV,IPassQ) = TMPAuxarray(iTUV)
     enddo
     AuxArray(36,IPassQ) = Xpb*TMPAuxArray(21) + alphaXpq*TmpArray5(21,2) + 4*TwoTerms(1)
     AuxArray(37,IPassQ) = Ypb*TMPAuxArray(21) + alphaYpq*TmpArray5(21,2)
     AuxArray(38,IPassQ) = Zpb*TMPAuxArray(21) + alphaZpq*TmpArray5(21,2)
     AuxArray(39,IPassQ) = Xpb*TMPAuxArray(24) + alphaXpq*TmpArray5(24,2) + 2*TwoTerms(2)
     AuxArray(40,IPassQ) = Ypb*TMPAuxArray(23) + alphaYpq*TmpArray5(23,2)
     AuxArray(41,IPassQ) = Xpb*TMPAuxArray(26) + alphaXpq*TmpArray5(26,2) + 2*TwoTerms(3)
     AuxArray(42,IPassQ) = Xpb*TMPAuxArray(27) + alphaXpq*TmpArray5(27,2) + TwoTerms(4)
     AuxArray(43,IPassQ) = Zpb*TMPAuxArray(24) + alphaZpq*TmpArray5(24,2)
     AuxArray(44,IPassQ) = Ypb*TMPAuxArray(26) + alphaYpq*TmpArray5(26,2)
     AuxArray(45,IPassQ) = Xpb*TMPAuxArray(30) + alphaXpq*TmpArray5(30,2) + TwoTerms(6)
     AuxArray(46,IPassQ) = Xpb*TMPAuxArray(31) + alphaXpq*TmpArray5(31,2)
     AuxArray(47,IPassQ) = Xpb*TMPAuxArray(32) + alphaXpq*TmpArray5(32,2)
     AuxArray(48,IPassQ) = Xpb*TMPAuxArray(33) + alphaXpq*TmpArray5(33,2)
     AuxArray(49,IPassQ) = Xpb*TMPAuxArray(34) + alphaXpq*TmpArray5(34,2)
     AuxArray(50,IPassQ) = Xpb*TMPAuxArray(35) + alphaXpq*TmpArray5(35,2)
     AuxArray(51,IPassQ) = Ypb*TMPAuxArray(31) + alphaYpq*TmpArray5(31,2) + 4*TwoTerms(4)
     AuxArray(52,IPassQ) = Zpb*TMPAuxArray(31) + alphaZpq*TmpArray5(31,2)
     AuxArray(53,IPassQ) = Ypb*TMPAuxArray(33) + alphaYpq*TmpArray5(33,2) + 2*TwoTerms(5)
     AuxArray(54,IPassQ) = Ypb*TMPAuxArray(34) + alphaYpq*TmpArray5(34,2) + TwoTerms(6)
     AuxArray(55,IPassQ) = Ypb*TMPAuxArray(35) + alphaYpq*TmpArray5(35,2)
     AuxArray(56,IPassQ) = Zpb*TMPAuxArray(35) + alphaZpq*TmpArray5(35,2) + 4*TwoTerms(6)
  ENDDO
 end subroutine
   ...
   iP = iPassQ
    ...
    Zpb = Pcent(3) + Bz
     ...
     do iTUV = 1,   56
      AuxArray(iTUV,IPassQ) = TMPAuxarray(iTUV)
     enddo
     AuxArray(57,IPassQ) = Xpb*TMPAuxArray(36) + alphaXpq*TmpArray6(36,2) + 5*TwoTerms(1)
     AuxArray(58,IPassQ) = Ypb*TMPAuxArray(36) + alphaYpq*TmpArray6(36,2)
     AuxArray(59,IPassQ) = Zpb*TMPAuxArray(36) + alphaZpq*TmpArray6(36,2)
     AuxArray(60,IPassQ) = Xpb*TMPAuxArray(39) + alphaXpq*TmpArray6(39,2) + 3*TwoTerms(2)
     AuxArray(61,IPassQ) = Ypb*TMPAuxArray(38) + alphaYpq*TmpArray6(38,2)
     AuxArray(62,IPassQ) = Xpb*TMPAuxArray(41) + alphaXpq*TmpArray6(41,2) + 3*TwoTerms(3)
     AuxArray(63,IPassQ) = Xpb*TMPAuxArray(42) + alphaXpq*TmpArray6(42,2) + 2*TwoTerms(4)
     AuxArray(64,IPassQ) = Zpb*TMPAuxArray(39) + alphaZpq*TmpArray6(39,2)
     AuxArray(65,IPassQ) = Ypb*TMPAuxArray(41) + alphaYpq*TmpArray6(41,2)
     AuxArray(66,IPassQ) = Xpb*TMPAuxArray(45) + alphaXpq*TmpArray6(45,2) + 2*TwoTerms(5)
     AuxArray(67,IPassQ) = Xpb*TMPAuxArray(46) + alphaXpq*TmpArray6(46,2) + TwoTerms(6)
     AuxArray(68,IPassQ) = Zpb*TMPAuxArray(42) + alphaZpq*TmpArray6(42,2)
     AuxArray(69,IPassQ) = Xpb*TMPAuxArray(48) + alphaXpq*TmpArray6(48,2) + TwoTerms(7)
     AuxArray(70,IPassQ) = Ypb*TMPAuxArray(45) + alphaYpq*TmpArray6(45,2)
     AuxArray(71,IPassQ) = Xpb*TMPAuxArray(50) + alphaXpq*TmpArray6(50,2) + TwoTerms(9)
     AuxArray(72,IPassQ) = Xpb*TMPAuxArray(51) + alphaXpq*TmpArray6(51,2)
     AuxArray(73,IPassQ) = Xpb*TMPAuxArray(52) + alphaXpq*TmpArray6(52,2)
     AuxArray(74,IPassQ) = Xpb*TMPAuxArray(53) + alphaXpq*TmpArray6(53,2)
     AuxArray(75,IPassQ) = Xpb*TMPAuxArray(54) + alphaXpq*TmpArray6(54,2)
     AuxArray(76,IPassQ) = Xpb*TMPAuxArray(55) + alphaXpq*TmpArray6(55,2)
     AuxArray(77,IPassQ) = Xpb*TMPAuxArray(56) + alphaXpq*TmpArray6(56,2)
     AuxArray(78,IPassQ) = Ypb*TMPAuxArray(51) + alphaYpq*TmpArray6(51,2) + 5*TwoTerms(6)
     AuxArray(79,IPassQ) = Zpb*TMPAuxArray(51) + alphaZpq*TmpArray6(51,2)
     AuxArray(80,IPassQ) = Ypb*TMPAuxArray(53) + alphaYpq*TmpArray6(53,2) + 3*TwoTerms(7)
     AuxArray(81,IPassQ) = Ypb*TMPAuxArray(54) + alphaYpq*TmpArray6(54,2) + 2*TwoTerms(8)
     AuxArray(82,IPassQ) = Ypb*TMPAuxArray(55) + alphaYpq*TmpArray6(55,2) + TwoTerms(9)
     AuxArray(83,IPassQ) = Ypb*TMPAuxArray(56) + alphaYpq*TmpArray6(56,2)
     AuxArray(84,IPassQ) = Zpb*TMPAuxArray(56) + alphaZpq*TmpArray6(56,2) + 5*TwoTerms(9)
  ENDDO
 end subroutine
   ...
   iP = iPassQ
    ...
    Zpb = Pcent(3) + Bz
     ...
     do iTUV = 1,   84
      AuxArray(iTUV,IPassQ) = TMPAuxarray(iTUV)
     enddo
     AuxArray(85,IPassQ) = Xpb*TMPAuxArray(57) + alphaXpq*TmpArray7(57,2) + 6*TwoTerms(1)
     AuxArray(86,IPassQ) = Ypb*TMPAuxArray(57) + alphaYpq*TmpArray7(57,2)
     AuxArray(87,IPassQ) = Zpb*TMPAuxArray(57) + alphaZpq*TmpArray7(57,2)
     AuxArray(88,IPassQ) = Xpb*TMPAuxArray(60) + alphaXpq*TmpArray7(60,2) + 4*TwoTerms(2)
     AuxArray(89,IPassQ) = Ypb*TMPAuxArray(59) + alphaYpq*TmpArray7(59,2)
     AuxArray(90,IPassQ) = Xpb*TMPAuxArray(62) + alphaXpq*TmpArray7(62,2) + 4*TwoTerms(3)
     AuxArray(91,IPassQ) = Xpb*TMPAuxArray(63) + alphaXpq*TmpArray7(63,2) + 3*TwoTerms(4)
     AuxArray(92,IPassQ) = Zpb*TMPAuxArray(60) + alphaZpq*TmpArray7(60,2)
     AuxArray(93,IPassQ) = Ypb*TMPAuxArray(62) + alphaYpq*TmpArray7(62,2)
     AuxArray(94,IPassQ) = Xpb*TMPAuxArray(66) + alphaXpq*TmpArray7(66,2) + 3*TwoTerms(5)
     AuxArray(95,IPassQ) = Xpb*TMPAuxArray(67) + alphaXpq*TmpArray7(67,2) + 2*TwoTerms(6)
     AuxArray(96,IPassQ) = Zpb*TMPAuxArray(63) + alphaZpq*TmpArray7(63,2)
     AuxArray(97,IPassQ) = Xpb*TMPAuxArray(69) + alphaXpq*TmpArray7(69,2) + 2*TwoTerms(7)
     AuxArray(98,IPassQ) = Ypb*TMPAuxArray(66) + alphaYpq*TmpArray7(66,2)
     AuxArray(99,IPassQ) = Xpb*TMPAuxArray(71) + alphaXpq*TmpArray7(71,2) + 2*TwoTerms(8)
     AuxArray(100,IPassQ) = Xpb*TMPAuxArray(72) + alphaXpq*TmpArray7(72,2) + TwoTerms(9)
     AuxArray(101,IPassQ) = Zpb*TMPAuxArray(67) + alphaZpq*TmpArray7(67,2)
     AuxArray(102,IPassQ) = Xpb*TMPAuxArray(74) + alphaXpq*TmpArray7(74,2) + TwoTerms(10)
     AuxArray(103,IPassQ) = Xpb*TMPAuxArray(75) + alphaXpq*TmpArray7(75,2) + TwoTerms(11)
     AuxArray(104,IPassQ) = Ypb*TMPAuxArray(71) + alphaYpq*TmpArray7(71,2)
     AuxArray(105,IPassQ) = Xpb*TMPAuxArray(77) + alphaXpq*TmpArray7(77,2) + TwoTerms(13)
     AuxArray(106,IPassQ) = Xpb*TMPAuxArray(78) + alphaXpq*TmpArray7(78,2)
     AuxArray(107,IPassQ) = Xpb*TMPAuxArray(79) + alphaXpq*TmpArray7(79,2)
     AuxArray(108,IPassQ) = Xpb*TMPAuxArray(80) + alphaXpq*TmpArray7(80,2)
     AuxArray(109,IPassQ) = Xpb*TMPAuxArray(81) + alphaXpq*TmpArray7(81,2)
     AuxArray(110,IPassQ) = Xpb*TMPAuxArray(82) + alphaXpq*TmpArray7(82,2)
     AuxArray(111,IPassQ) = Xpb*TMPAuxArray(83) + alphaXpq*TmpArray7(83,2)
     AuxArray(112,IPassQ) = Xpb*TMPAuxArray(84) + alphaXpq*TmpArray7(84,2)
     AuxArray(113,IPassQ) = Ypb*TMPAuxArray(78) + alphaYpq*TmpArray7(78,2) + 6*TwoTerms(9)
     AuxArray(114,IPassQ) = Zpb*TMPAuxArray(78) + alphaZpq*TmpArray7(78,2)
     AuxArray(115,IPassQ) = Ypb*TMPAuxArray(80) + alphaYpq*TmpArray7(80,2) + 4*TwoTerms(10)
     AuxArray(116,IPassQ) = Ypb*TMPAuxArray(81) + alphaYpq*TmpArray7(81,2) + 3*TwoTerms(11)
     AuxArray(117,IPassQ) = Ypb*TMPAuxArray(82) + alphaYpq*TmpArray7(82,2) + 2*TwoTerms(12)
     AuxArray(118,IPassQ) = Ypb*TMPAuxArray(83) + alphaYpq*TmpArray7(83,2) + TwoTerms(13)
     AuxArray(119,IPassQ) = Ypb*TMPAuxArray(84) + alphaYpq*TmpArray7(84,2)
     AuxArray(120,IPassQ) = Zpb*TMPAuxArray(84) + alphaZpq*TmpArray7(84,2) + 6*TwoTerms(13)
  ENDDO
 end subroutine
   ...
   iP = iPassQ
    ...
    Zpb = Pcent(3) + Bz
     ...
     do iTUV = 1,  120
      AuxArray(iTUV,IPassQ) = TMPAuxarray(iTUV)
     enddo
     AuxArray(121,IPassQ) = Xpb*TMPAuxArray(85) + alphaXpq*TmpArray8(85,2) + 7*TwoTerms(1)
     AuxArray(122,IPassQ) = Ypb*TMPAuxArray(85) + alphaYpq*TmpArray8(85,2)
     AuxArray(123,IPassQ) = Zpb*TMPAuxArray(85) + alphaZpq*TmpArray8(85,2)
     AuxArray(124,IPassQ) = Xpb*TMPAuxArray(88) + alphaXpq*TmpArray8(88,2) + 5*TwoTerms(2)
     AuxArray(125,IPassQ) = Ypb*TMPAuxArray(87) + alphaYpq*TmpArray8(87,2)
     AuxArray(126,IPassQ) = Xpb*TMPAuxArray(90) + alphaXpq*TmpArray8(90,2) + 5*TwoTerms(3)
     AuxArray(127,IPassQ) = Xpb*TMPAuxArray(91) + alphaXpq*TmpArray8(91,2) + 4*TwoTerms(4)
     AuxArray(128,IPassQ) = Zpb*TMPAuxArray(88) + alphaZpq*TmpArray8(88,2)
     AuxArray(129,IPassQ) = Ypb*TMPAuxArray(90) + alphaYpq*TmpArray8(90,2)
     AuxArray(130,IPassQ) = Xpb*TMPAuxArray(94) + alphaXpq*TmpArray8(94,2) + 4*TwoTerms(5)
     AuxArray(131,IPassQ) = Xpb*TMPAuxArray(95) + alphaXpq*TmpArray8(95,2) + 3*TwoTerms(6)
     AuxArray(132,IPassQ) = Zpb*TMPAuxArray(91) + alphaZpq*TmpArray8(91,2)
     AuxArray(133,IPassQ) = Xpb*TMPAuxArray(97) + alphaXpq*TmpArray8(97,2) + 3*TwoTerms(7)
     AuxArray(134,IPassQ) = Ypb*TMPAuxArray(94) + alphaYpq*TmpArray8(94,2)
     AuxArray(135,IPassQ) = Xpb*TMPAuxArray(99) + alphaXpq*TmpArray8(99,2) + 3*TwoTerms(8)
     AuxArray(136,IPassQ) = Xpb*TMPAuxArray(100) + alphaXpq*TmpArray8(100,2) + 2*TwoTerms(9)
     AuxArray(137,IPassQ) = Zpb*TMPAuxArray(95) + alphaZpq*TmpArray8(95,2)
     AuxArray(138,IPassQ) = Xpb*TMPAuxArray(102) + alphaXpq*TmpArray8(102,2) + 2*TwoTerms(10)
     AuxArray(139,IPassQ) = Xpb*TMPAuxArray(103) + alphaXpq*TmpArray8(103,2) + 2*TwoTerms(11)
     AuxArray(140,IPassQ) = Ypb*TMPAuxArray(99) + alphaYpq*TmpArray8(99,2)
     AuxArray(141,IPassQ) = Xpb*TMPAuxArray(105) + alphaXpq*TmpArray8(105,2) + 2*TwoTerms(12)
     AuxArray(142,IPassQ) = Xpb*TMPAuxArray(106) + alphaXpq*TmpArray8(106,2) + TwoTerms(13)
     AuxArray(143,IPassQ) = Zpb*TMPAuxArray(100) + alphaZpq*TmpArray8(100,2)
     AuxArray(144,IPassQ) = Xpb*TMPAuxArray(108) + alphaXpq*TmpArray8(108,2) + TwoTerms(14)
     AuxArray(145,IPassQ) = Xpb*TMPAuxArray(109) + alphaXpq*TmpArray8(109,2) + TwoTerms(15)
     AuxArray(146,IPassQ) = Xpb*TMPAuxArray(110) + alphaXpq*TmpArray8(110,2) + TwoTerms(16)
     AuxArray(147,IPassQ) = Ypb*TMPAuxArray(105) + alphaYpq*TmpArray8(105,2)
     AuxArray(148,IPassQ) = Xpb*TMPAuxArray(112) + alphaXpq*TmpArray8(112,2) + TwoTerms(18)
     AuxArray(149,IPassQ) = Xpb*TMPAuxArray(113) + alphaXpq*TmpArray8(113,2)
     AuxArray(150,IPassQ) = Xpb*TMPAuxArray(114) + alphaXpq*TmpArray8(114,2)
     AuxArray(151,IPassQ) = Xpb*TMPAuxArray(115) + alphaXpq*TmpArray8(115,2)
     AuxArray(152,IPassQ) = Xpb*TMPAuxArray(116) + alphaXpq*TmpArray8(116,2)
     AuxArray(153,IPassQ) = Xpb*TMPAuxArray(117) + alphaXpq*TmpArray8(117,2)
     AuxArray(154,IPassQ) = Xpb*TMPAuxArray(118) + alphaXpq*TmpArray8(118,2)
     AuxArray(155,IPassQ) = Xpb*TMPAuxArray(119) + alphaXpq*TmpArray8(119,2)
     AuxArray(156,IPassQ) = Xpb*TMPAuxArray(120) + alphaXpq*TmpArray8(120,2)
     AuxArray(157,IPassQ) = Ypb*TMPAuxArray(113) + alphaYpq*TmpArray8(113,2) + 7*TwoTerms(13)
     AuxArray(158,IPassQ) = Zpb*TMPAuxArray(113) + alphaZpq*TmpArray8(113,2)
     AuxArray(159,IPassQ) = Ypb*TMPAuxArray(115) + alphaYpq*TmpArray8(115,2) + 5*TwoTerms(14)
     AuxArray(160,IPassQ) = Ypb*TMPAuxArray(116) + alphaYpq*TmpArray8(116,2) + 4*TwoTerms(15)
     AuxArray(161,IPassQ) = Ypb*TMPAuxArray(117) + alphaYpq*TmpArray8(117,2) + 3*TwoTerms(16)
     AuxArray(162,IPassQ) = Ypb*TMPAuxArray(118) + alphaYpq*TmpArray8(118,2) + 2*TwoTerms(17)
     AuxArray(163,IPassQ) = Ypb*TMPAuxArray(119) + alphaYpq*TmpArray8(119,2) + TwoTerms(18)
     AuxArray(164,IPassQ) = Ypb*TMPAuxArray(120) + alphaYpq*TmpArray8(120,2)
     AuxArray(165,IPassQ) = Zpb*TMPAuxArray(120) + alphaZpq*TmpArray8(120,2) + 7*TwoTerms(18)
  ENDDO
 end subroutine
end module
