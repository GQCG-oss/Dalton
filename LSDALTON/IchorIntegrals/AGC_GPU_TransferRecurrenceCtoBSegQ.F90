MODULE AGC_GPU_OBS_TRMODCtoBSegQ
 ...
 subroutine TransferRecurrenceGPUP1Q2CtoBSegQ(nPasses,nPrimP,nPrimQ,reducedExponents,&
  ...
  real(realk),intent(inout) :: Aux2(nPrimP*nPasses,    4,   10)
...
!$ACC PARALLEL LOOP PRIVATE(iP,iTUVP,iTUVQ) PRESENT(nPrimP,nPasses,Aux2) ASYNC(iASync)
...
!$ACC LOOP SEQ
 ...
 subroutine TransferRecurrenceGPUP1Q3CtoBSegQ(nPasses,nPrimP,nPrimQ,reducedExponents,&
  ...
  real(realk),intent(inout) :: Aux2(nPrimP*nPasses,    4,   20)
!  real(realk),intent(inout) :: Aux2(nPrimQ,nPrimP,nPasses,nTUVP,nTUVQ)
  integer(kind=acckind),intent(in) :: iASync
  !Local variables
...
!$ACC LOOP SEQ
 ...
 subroutine TransferRecurrenceGPUP1Q4CtoBSegQ(nPasses,nPrimP,nPrimQ,reducedExponents,&
  ...
  real(realk),intent(inout) :: Aux2(nPrimP*nPasses,    4,   35)
!  real(realk),intent(inout) :: Aux2(nPrimQ,nPrimP,nPasses,nTUVP,nTUVQ)
  integer(kind=acckind),intent(in) :: iASync
  !Local variables
...
!$ACC LOOP SEQ
 ...
 subroutine TransferRecurrenceGPUP2Q3CtoBSegQ(nPasses,nPrimP,nPrimQ,reducedExponents,&
  ...
  real(realk),intent(in) :: Dexp(nPrimD),Aexp(nPrimA)
  real(realk),intent(in) :: Aux(nPrimQ,nPrimP,nPasses,   56)
  real(realk),intent(inout) :: Aux2(nPrimP*nPasses,   10,   20)
!  real(realk),intent(inout) :: Aux2(nPrimQ,nPrimP,nPasses,nTUVP,nTUVQ)
  integer(kind=acckind),intent(in) :: iASync
  !Local variables
...
!$ACC LOOP SEQ
 ...
 subroutine TransferRecurrenceGPUP2Q4CtoBSegQ(nPasses,nPrimP,nPrimQ,reducedExponents,&
  ...
  real(realk),intent(inout) :: Aux2(nPrimP*nPasses,   10,   35)
!  real(realk),intent(inout) :: Aux2(nPrimQ,nPrimP,nPasses,nTUVP,nTUVQ)
  integer(kind=acckind),intent(in) :: iASync
  !Local variables
...
!$ACC LOOP SEQ
     do ituvqminus1 = 1,20
      ...
      Tmp0(iTUVQ,2) = Tmp0(iTUVQ,2) + IfacX1_35(ituvqminus1)*inv2expP*Aux(iPrimQ,iPrimP,iPassP,ituvqminus1) 
     enddo
!$ACC LOOP SEQ
     do ituvqminus1 = 1,20
      iTUVQ = TUVindexX2_56(ituvqminus1)
      Tmp0(iTUVQ,3) = Tmp0(iTUVQ,3) + IfacX2_35(ituvqminus1)*inv2expP*Aux(iPrimQ,iPrimP,iPassP,ituvqminus1) 
     enddo
!$ACC LOOP SEQ
     do ituvqminus1 = 1,20
      iTUVQ = TUVindexX3_56(ituvqminus1)
      Tmp0(iTUVQ,4) = Tmp0(iTUVQ,4) + IfacX3_35(ituvqminus1)*inv2expP*Aux(iPrimQ,iPrimP,iPassP,ituvqminus1) 
     enddo
!$ACC LOOP SEQ
     do ituvqminus1 = 21,35
      iTUVQ = TUVindexX1_56(ituvqminus1)
      Tmp1(iTUVQ,2) = Tmp1(iTUVQ,2) + IfacX1_35(ituvqminus1)*inv2expP*Aux(iPrimQ,iPrimP,iPassP,ituvqminus1) 
     enddo
!$ACC LOOP SEQ
     do ituvqminus1 = 21,35
      iTUVQ = TUVindexX2_56(ituvqminus1)
      Tmp1(iTUVQ,3) = Tmp1(iTUVQ,3) + IfacX2_35(ituvqminus1)*inv2expP*Aux(iPrimQ,iPrimP,iPassP,ituvqminus1) 
     enddo
!$ACC LOOP SEQ
     do ituvqminus1 = 21,35
      iTUVQ = TUVindexX3_56(ituvqminus1)
      Tmp1(iTUVQ,4) = Tmp1(iTUVQ,4) + IfacX3_35(ituvqminus1)*inv2expP*Aux(iPrimQ,iPrimP,iPassP,ituvqminus1) 
     enddo
!$ACC LOOP SEQ
     do iTUVQ = 1,35
...
!$ACC LOOP SEQ
 ...
 subroutine TransferRecurrenceGPUP3Q4CtoBSegQ(nPasses,nPrimP,nPrimQ,reducedExponents,&
  ...
  real(realk),intent(inout) :: Aux2(nPrimP*nPasses,   20,   35)
!  real(realk),intent(inout) :: Aux2(nPrimQ,nPrimP,nPasses,nTUVP,nTUVQ)
  integer(kind=acckind),intent(in) :: iASync
  !Local variables
...
!$ACC LOOP SEQ
     do ituvqminus1 = 1,20
      ...
      Tmp0(iTUVQ,2) = Tmp0(iTUVQ,2) + IfacX1_56(ituvqminus1)*inv2expP*Aux(iPrimQ,iPrimP,iPassP,ituvqminus1) 
     enddo
!$ACC LOOP SEQ
     do ituvqminus1 = 1,20
      iTUVQ = TUVindexX2_84(ituvqminus1)
      Tmp0(iTUVQ,3) = Tmp0(iTUVQ,3) + IfacX2_56(ituvqminus1)*inv2expP*Aux(iPrimQ,iPrimP,iPassP,ituvqminus1) 
     enddo
!$ACC LOOP SEQ
     do ituvqminus1 = 1,20
      iTUVQ = TUVindexX3_84(ituvqminus1)
      Tmp0(iTUVQ,4) = Tmp0(iTUVQ,4) + IfacX3_56(ituvqminus1)*inv2expP*Aux(iPrimQ,iPrimP,iPassP,ituvqminus1) 
     enddo
!$ACC LOOP SEQ
     do ituvqminus1 = 21,56
      iTUVQ = TUVindexX1_84(ituvqminus1)
      Tmp1(iTUVQ,2) = Tmp1(iTUVQ,2) + IfacX1_56(ituvqminus1)*inv2expP*Aux(iPrimQ,iPrimP,iPassP,ituvqminus1) 
     enddo
!$ACC LOOP SEQ
     do ituvqminus1 = 21,56
      iTUVQ = TUVindexX2_84(ituvqminus1)
      Tmp1(iTUVQ,3) = Tmp1(iTUVQ,3) + IfacX2_56(ituvqminus1)*inv2expP*Aux(iPrimQ,iPrimP,iPassP,ituvqminus1) 
     enddo
!$ACC LOOP SEQ
     do ituvqminus1 = 21,56
      iTUVQ = TUVindexX3_84(ituvqminus1)
      Tmp1(iTUVQ,4) = Tmp1(iTUVQ,4) + IfacX3_56(ituvqminus1)*inv2expP*Aux(iPrimQ,iPrimP,iPassP,ituvqminus1) 
     enddo
!$ACC LOOP SEQ
     do iTUVQ = 1,35
