...
!   TMP variables - allocated outside
  ...
  Dcenter_SP = Real(Dcenter,kind=reals)
   IF(.NOT.UseGeneralCode.AND.(((AngmomA.LE.2).AND.(AngmomA.GE.AngmomB)).AND.&
       ((AngmomA.GE.AngmomC).AND.(AngmomC.GE.AngmomD))))THEN
    IF((Psegmented.AND.Qsegmented).AND.(nPrimQP.EQ.1))THEN
     call SPICI_GPU_OBS_Seg1Prim(nPrimA,nPrimB,nPrimC,nPrimD,&
       & nPrimP,nPrimQ,nPrimQP,nPasses,MaxPasses,IntPrint,lupri,&
       ...
       & IatomAPass,iatomBPass,iASync)
    ELSEIF(Psegmented.AND.Qsegmented)THEN
     call SPICI_GPU_OBS_Seg(nPrimA,nPrimB,nPrimC,nPrimD,&
       & nPrimP,nPrimQ,nPrimQP,nPasses,MaxPasses,IntPrint,lupri,&
       & nContA,nContB,nContC,nContD,nContP,nContQ,pexp_SP,qexp_SP,&
       & ACC_SP,BCC_SP,CCC_SP,DCC_SP,&
       & nOrbCompA,nOrbCompB,nOrbCompC,nOrbCompD,&
       ...
       & IatomAPass,iatomBPass,iASync)
    ELSEIF(Psegmented)THEN
     call SPICI_GPU_OBS_SegP(nPrimA,nPrimB,nPrimC,nPrimD,&
       & nPrimP,nPrimQ,nPrimQP,nPasses,MaxPasses,IntPrint,lupri,&
       & nContA,nContB,nContC,nContD,nContP,nContQ,pexp_SP,qexp_SP,&
       & ACC_SP,BCC_SP,CCC_SP,DCC_SP,&
       & nOrbCompA,nOrbCompB,nOrbCompC,nOrbCompD,&
       ...
       & IatomAPass,iatomBPass,iASync)
    ELSEIF(Qsegmented)THEN
     call SPICI_GPU_OBS_SegQ(nPrimA,nPrimB,nPrimC,nPrimD,&
       & nPrimP,nPrimQ,nPrimQP,nPasses,MaxPasses,IntPrint,lupri,&
       & nContA,nContB,nContC,nContD,nContP,nContQ,pexp_SP,qexp_SP,&
       & ACC_SP,BCC_SP,CCC_SP,DCC_SP,&
       & nOrbCompA,nOrbCompB,nOrbCompC,nOrbCompD,&
       ...
       & IatomAPass,iatomBPass,iASync)
    ELSE
     call SPICI_GPU_OBS_Gen(nPrimA,nPrimB,nPrimC,nPrimD,&
       & nPrimP,nPrimQ,nPrimQP,nPasses,MaxPasses,IntPrint,lupri,&
       & nContA,nContB,nContC,nContD,nContP,nContQ,pexp_SP,qexp_SP,&
       & ACC_SP,BCC_SP,CCC_SP,DCC_SP,&
       & nOrbCompA,nOrbCompB,nOrbCompC,nOrbCompD,&
   ...
   ELSE
    IF((Psegmented.AND.Qsegmented).AND.(nPrimQP.EQ.1))THEN
     call SPICI_GPU_OBS_Seg1Prim2(nPrimA,nPrimB,nPrimC,nPrimD,&
       & nPrimP,nPrimQ,nPrimQP,nPasses,MaxPasses,IntPrint,lupri,&
       & nContA,nContB,nContC,nContD,nContP,nContQ,pexp_SP,qexp_SP,&
       & ACC_SP,BCC_SP,CCC_SP,DCC_SP,&
       & nOrbCompA,nOrbCompB,nOrbCompC,nOrbCompD,&
       ...
       & IatomAPass,iatomBPass,iASync)
    ELSEIF(Psegmented.AND.Qsegmented)THEN
     call SPICI_GPU_OBS_Seg2(nPrimA,nPrimB,nPrimC,nPrimD,&
       & nPrimP,nPrimQ,nPrimQP,nPasses,MaxPasses,IntPrint,lupri,&
       & nContA,nContB,nContC,nContD,nContP,nContQ,pexp_SP,qexp_SP,&
       & ACC_SP,BCC_SP,CCC_SP,DCC_SP,&
       & nOrbCompA,nOrbCompB,nOrbCompC,nOrbCompD,&
       ...
       & IatomAPass,iatomBPass,iASync)
    ELSEIF(Psegmented)THEN
     call SPICI_GPU_OBS_SegP2(nPrimA,nPrimB,nPrimC,nPrimD,&
       & nPrimP,nPrimQ,nPrimQP,nPasses,MaxPasses,IntPrint,lupri,&
       & nContA,nContB,nContC,nContD,nContP,nContQ,pexp_SP,qexp_SP,&
       & ACC_SP,BCC_SP,CCC_SP,DCC_SP,&
       & nOrbCompA,nOrbCompB,nOrbCompC,nOrbCompD,&
       ...
       & IatomAPass,iatomBPass,iASync)
    ELSEIF(Qsegmented)THEN
     call SPICI_GPU_OBS_SegQ2(nPrimA,nPrimB,nPrimC,nPrimD,&
       & nPrimP,nPrimQ,nPrimQP,nPasses,MaxPasses,IntPrint,lupri,&
       & nContA,nContB,nContC,nContD,nContP,nContQ,pexp_SP,qexp_SP,&
       & ACC_SP,BCC_SP,CCC_SP,DCC_SP,&
       & nOrbCompA,nOrbCompB,nOrbCompC,nOrbCompD,&
       ...
       & IatomAPass,iatomBPass,iASync)
    ELSE
     call SPICI_GPU_OBS_Gen2(nPrimA,nPrimB,nPrimC,nPrimD,&
       & nPrimP,nPrimQ,nPrimQP,nPasses,MaxPasses,IntPrint,lupri,&
       & nContA,nContB,nContC,nContD,nContP,nContQ,pexp_SP,qexp_SP,&
       & ACC_SP,BCC_SP,CCC_SP,DCC_SP,&
       & nOrbCompA,nOrbCompB,nOrbCompC,nOrbCompD,&
