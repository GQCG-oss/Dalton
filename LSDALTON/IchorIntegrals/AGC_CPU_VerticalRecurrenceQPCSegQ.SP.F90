module SPAGC_CPU_OBS_VERTICALRECURRENCEMODCSegQ
 use IchorPrecisionMod
  
 CONTAINS


subroutine SPVerticalRecurrenceCPUSegQ1C(nPassP,nPrimP,nPrimQ,&
  ...
  real(reals),intent(inout) :: AUXarray(4,nPrimP*nPassP)
  !local variables
...
!$OMP END DO
end subroutine SPVerticalRecurrenceCPUSegQ1C

subroutine SPVerticalRecurrenceCPUSegQ2C(nPassP,nPrimP,nPrimQ,&
  ...
  real(reals),intent(in) :: integralPrefactor(nprimQ,nPrimP),QpreExpFac(nPrimQ),PpreExpFac(nPrimP,nAtomsA,nAtomsB)
  real(reals),intent(in) :: Ccenter(3)
  real(reals),intent(inout) :: AUXarray(   10,nPrimP*nPassP)
  !local variables
...
subroutine SPVerticalRecurrenceCPUSegQ3C(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Ccenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
  ...
  real(reals),intent(in) :: integralPrefactor(nprimQ,nPrimP),QpreExpFac(nPrimQ),PpreExpFac(nPrimP,nAtomsA,nAtomsB)
  real(reals),intent(in) :: Ccenter(3)
  real(reals),intent(inout) :: AUXarray(   20,nPrimP*nPassP)
  !local variables
  integer :: iPassP,iPrimP,iPrimQ,ipnt,IP,iTUV,iAtomA,iAtomB
...
subroutine SPVerticalRecurrenceCPUSegQ4C(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Ccenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
  ...
  real(reals),intent(in) :: integralPrefactor(nprimQ,nPrimP),QpreExpFac(nPrimQ),PpreExpFac(nPrimP,nAtomsA,nAtomsB)
  real(reals),intent(in) :: Ccenter(3)
  real(reals),intent(inout) :: AUXarray(   35,nPrimP*nPassP)
  !local variables
  integer :: iPassP,iPrimP,iPrimQ,ipnt,IP,iTUV,iAtomA,iAtomB
