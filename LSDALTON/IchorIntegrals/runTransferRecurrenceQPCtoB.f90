...
CONTAINS
  subroutine PASSsub
    ...
    WRITE(*,'(A)')'MODULE AGC_OBS_TRANSFERRECURRENCEMODCtoB'
    ...
    DO JMAX=2,MaxAngmomQP
       DO JP = 1, JMAX
          ...
          IF(JP.LT.10)THEN
             IF(JQ.LT.10)THEN
                WRITE(*,'(A,I1,A,I1,A)')'subroutine TransferRecurrenceP',JP,'Q',JQ,'CtoB(nPasses,nPrimP,nPrimQ,reducedExponents,&'
             ELSE
                WRITE(*,'(A,I1,A,I2,A)')'subroutine TransferRecurrenceP',JP,'Q',JQ,'CtoB(nPasses,nPrimP,nPrimQ,reducedExponents,&'
             ENDIF
          ELSE
             IF(JQ.LT.10)THEN
                WRITE(*,'(A,I2,A,I1,A)')'subroutine TransferRecurrenceP',JP,'Q',JQ,'CtoB(nPasses,nPrimP,nPrimQ,reducedExponents,&'
             ELSE
                WRITE(*,'(A,I2,A,I2,A)')'subroutine TransferRecurrenceP',JP,'Q',JQ,'CtoB(nPasses,nPrimP,nPrimQ,reducedExponents,&'
             ENDIF
          ENDIF
...
!       ENDDO
          ...
          IF(JP.LT.10)THEN
             IF(JQ.LT.10)THEN
                WRITE(*,'(A,I1,A,I1,A)')'end subroutine TransferRecurrenceP',JP,'Q',JQ,'CtoB'
             ELSE
                WRITE(*,'(A,I1,A,I2,A)')'end subroutine TransferRecurrenceP',JP,'Q',JQ,'CtoB'
             ENDIF
          ELSE
             IF(JQ.LT.10)THEN
                WRITE(*,'(A,I2,A,I1,A)')'end subroutine TransferRecurrenceP',JP,'Q',JQ,'CtoB'
             ELSE
                WRITE(*,'(A,I2,A,I2,A)')'end subroutine TransferRecurrenceP',JP,'Q',JQ,'CtoB'
             ENDIF
          ENDIF
          deallocate(TUVINDEX)
          deallocate(TINDEX)
