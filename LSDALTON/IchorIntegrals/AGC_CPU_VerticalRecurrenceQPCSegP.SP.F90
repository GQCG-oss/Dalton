module SPAGC_CPU_OBS_VERTICALRECURRENCEMODCSegP
 use IchorPrecisionMod
  
 CONTAINS


subroutine SPVerticalRecurrenceCPUSegP1C(nPassP,nPrimP,nPrimQ,&
...
!$OMP END DO
end subroutine SPVerticalRecurrenceCPUSegP1C

subroutine SPVerticalRecurrenceCPUSegP2C(nPassP,nPrimP,nPrimQ,&
...
subroutine SPVerticalRecurrenceCPUSegP3C(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Ccenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
...
subroutine SPVerticalRecurrenceCPUSegP4C(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Ccenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
