module SPAGC_GPU_OBS_VERTICALRECURRENCEMODCSegP
 use IchorPrecisionMod
  
 CONTAINS


subroutine SPVerticalRecurrenceGPUSegP1C(nPassP,nPrimP,nPrimQ,&
...
end subroutine SPVerticalRecurrenceGPUSegP1C

subroutine SPVerticalRecurrenceGPUSegP2C(nPassP,nPrimP,nPrimQ,&
...
subroutine SPVerticalRecurrenceGPUSegP3C(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Ccenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray,iASync)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
...
subroutine SPVerticalRecurrenceGPUSegP4C(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Ccenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray,iASync)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
