MODULE IchorEriCoulombintegralCPUOBSGeneralModGenSize
...
private   
public :: ICI_CPU_OBS_general_sizeGen  
...
CONTAINS
  ...
  subroutine ICI_CPU_OBS_general_sizeGen(TMParray1maxsize,&
    ...
    CASE(   0)  !Angmom(A= 0,B= 0,C= 0,D= 0) combi
       TMParray2maxSize = MAX(TMParray2maxSize,1*nPrimQ*nPrimP)
    ...
    TMParray1maxSize = MAX(TMParray1maxSize,10*nContC*nContD*nContA*nContB)
       TMParray2maxSize = MAX(TMParray2maxSize,6*nContQ*nContP)
    ...
    TMParray1maxSize = MAX(TMParray1maxSize,20*nContC*nContD*nContA*nContB)
       TMParray2maxSize = MAX(TMParray2maxSize,18*nContQ*nContP)
    ...
    TMParray1maxSize = MAX(TMParray1maxSize,35*nContC*nContD*nContA*nContB)
       TMParray2maxSize = MAX(TMParray2maxSize,36*nContQ*nContP)
    ...
    CASE( 101)  !Angmom(A= 0,B= 1,C= 0,D= 1) combi
       TMParray2maxSize = MAX(TMParray2maxSize,3*nPrimQ*nPrimP)
       TMParray1maxSize = MAX(TMParray1maxSize,10*nPrimQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,16*nPrimQ*nPrimP)
    ...
    TMParray2maxSize = MAX(TMParray2maxSize,16*nContC*nContD*nContA*nContB)
       TMParray1maxSize = MAX(TMParray1maxSize,12*nContQ*nPrimP)
    CASE( 102)  !Angmom(A= 0,B= 1,C= 0,D= 2) combi
       TMParray2maxSize = MAX(TMParray2maxSize,4*nPrimQ*nPrimP)
       TMParray1maxSize = MAX(TMParray1maxSize,20*nPrimQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,40*nPrimQ*nPrimP)
    ...
    TMParray2maxSize = MAX(TMParray2maxSize,40*nContC*nContD*nContA*nContB)
       TMParray1maxSize = MAX(TMParray1maxSize,30*nContQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,18*nContQ*nContP)
    ...
    CASE( 112)  !Angmom(A= 0,B= 1,C= 1,D= 2) combi
       TMParray2maxSize = MAX(TMParray2maxSize,5*nPrimQ*nPrimP)
       TMParray1maxSize = MAX(TMParray1maxSize,35*nPrimQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,80*nPrimQ*nPrimP)
    ...
    TMParray2maxSize = MAX(TMParray2maxSize,80*nContC*nContD*nContA*nContB)
       TMParray1maxSize = MAX(TMParray1maxSize,60*nContQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,54*nContQ*nContP)
    ...
    CASE( 122)  !Angmom(A= 0,B= 1,C= 2,D= 2) combi
       ...
       TMParray2maxSize = MAX(TMParray2maxSize,140*nPrimQ*nPrimP)
    ...
    TMParray2maxSize = MAX(TMParray2maxSize,140*nContC*nContD*nContA*nContB)
       TMParray1maxSize = MAX(TMParray1maxSize,105*nContQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,108*nContQ*nContP)
    ...
    TMParray2maxSize = MAX(TMParray2maxSize,10*nContC*nContD*nContA*nPrimB)
    TMParray1maxSize = MAX(TMParray1maxSize,10*nContC*nContD*nContA*nContB)
       TMParray2maxSize = MAX(TMParray2maxSize,6*nContQ*nPrimP)
    ...
    TMParray1maxSize = MAX(TMParray1maxSize,40*nContC*nContD*nContA*nPrimB)
    TMParray2maxSize = MAX(TMParray2maxSize,40*nContC*nContD*nContA*nContB)
       TMParray1maxSize = MAX(TMParray1maxSize,24*nContQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,20*nContQ*nPrimP)
    CASE( 202)  !Angmom(A= 0,B= 2,C= 0,D= 2) combi
       TMParray2maxSize = MAX(TMParray2maxSize,5*nPrimQ*nPrimP)
       TMParray1maxSize = MAX(TMParray1maxSize,35*nPrimQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,100*nPrimQ*nPrimP)
    ...
    TMParray2maxSize = MAX(TMParray2maxSize,100*nContC*nContD*nContA*nContB)
       TMParray1maxSize = MAX(TMParray1maxSize,60*nContQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,50*nContQ*nPrimP)
       TMParray1maxSize = MAX(TMParray1maxSize,30*nContQ*nContP)
    ...
    CASE( 212)  !Angmom(A= 0,B= 2,C= 1,D= 2) combi
       TMParray2maxSize = MAX(TMParray2maxSize,6*nPrimQ*nPrimP)
       TMParray1maxSize = MAX(TMParray1maxSize,56*nPrimQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,200*nPrimQ*nPrimP)
    ...
    TMParray2maxSize = MAX(TMParray2maxSize,200*nContC*nContD*nContA*nContB)
       TMParray1maxSize = MAX(TMParray1maxSize,120*nContQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,100*nContQ*nPrimP)
       TMParray1maxSize = MAX(TMParray1maxSize,90*nContQ*nContP)
    ...
    CASE( 222)  !Angmom(A= 0,B= 2,C= 2,D= 2) combi
       ...
       TMParray2maxSize = MAX(TMParray2maxSize,350*nPrimQ*nPrimP)
    ...
    TMParray2maxSize = MAX(TMParray2maxSize,350*nContC*nContD*nContA*nContB)
       TMParray1maxSize = MAX(TMParray1maxSize,210*nContQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,175*nContQ*nPrimP)
       TMParray1maxSize = MAX(TMParray1maxSize,180*nContQ*nContP)
    ...
    TMParray1maxSize = MAX(TMParray1maxSize,40*nContC*nContD*nContA*nPrimB)
    TMParray2maxSize = MAX(TMParray2maxSize,40*nContC*nContD*nContA*nContB)
       TMParray1maxSize = MAX(TMParray1maxSize,36*nContQ*nPrimP)
    ...
    TMParray1maxSize = MAX(TMParray1maxSize,100*nContC*nContD*nContA*nPrimB)
    TMParray2maxSize = MAX(TMParray2maxSize,100*nContC*nContD*nContA*nContB)
       TMParray1maxSize = MAX(TMParray1maxSize,90*nContQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,54*nContQ*nContP)
    ...
    TMParray1maxSize = MAX(TMParray1maxSize,200*nContC*nContD*nContA*nPrimB)
    TMParray2maxSize = MAX(TMParray2maxSize,200*nContC*nContD*nContA*nContB)
       TMParray1maxSize = MAX(TMParray1maxSize,180*nContQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,162*nContQ*nContP)
    ...
    TMParray1maxSize = MAX(TMParray1maxSize,350*nContC*nContD*nContA*nPrimB)
    TMParray2maxSize = MAX(TMParray2maxSize,350*nContC*nContD*nContA*nContB)
       TMParray1maxSize = MAX(TMParray1maxSize,315*nContQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,324*nContQ*nContP)
    ...
    TMParray2maxSize = MAX(TMParray2maxSize,20*nContC*nContD*nContA*nPrimB)
    TMParray1maxSize = MAX(TMParray1maxSize,20*nContC*nContD*nContA*nContB)
       TMParray2maxSize = MAX(TMParray2maxSize,18*nContQ*nPrimP)
    ...
    TMParray1maxSize = MAX(TMParray1maxSize,80*nContC*nContD*nContA*nPrimB)
    TMParray2maxSize = MAX(TMParray2maxSize,80*nContC*nContD*nContA*nContB)
       TMParray1maxSize = MAX(TMParray1maxSize,72*nContQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,60*nContQ*nPrimP)
    ...
    TMParray2maxSize = MAX(TMParray2maxSize,200*nContC*nContD*nContA*nContB)
       TMParray1maxSize = MAX(TMParray1maxSize,180*nContQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,150*nContQ*nPrimP)
       TMParray1maxSize = MAX(TMParray1maxSize,90*nContQ*nContP)
    ...
    CASE(1212)  !Angmom(A= 1,B= 2,C= 1,D= 2) combi
       TMParray2maxSize = MAX(TMParray2maxSize,7*nPrimQ*nPrimP)
       TMParray1maxSize = MAX(TMParray1maxSize,84*nPrimQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,400*nPrimQ*nPrimP)
    ...
    TMParray2maxSize = MAX(TMParray2maxSize,400*nContC*nContD*nContA*nContB)
       TMParray1maxSize = MAX(TMParray1maxSize,360*nContQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,300*nContQ*nPrimP)
       TMParray1maxSize = MAX(TMParray1maxSize,270*nContQ*nContP)
    ...
    CASE(1222)  !Angmom(A= 1,B= 2,C= 2,D= 2) combi
       ...
       TMParray2maxSize = MAX(TMParray2maxSize,700*nPrimQ*nPrimP)
    ...
    TMParray2maxSize = MAX(TMParray2maxSize,700*nContC*nContD*nContA*nContB)
       TMParray1maxSize = MAX(TMParray1maxSize,630*nContQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,525*nContQ*nPrimP)
       TMParray1maxSize = MAX(TMParray1maxSize,540*nContQ*nContP)
    ...
    TMParray2maxSize = MAX(TMParray2maxSize,35*nContC*nContD*nContA*nPrimB)
    TMParray1maxSize = MAX(TMParray1maxSize,35*nContC*nContD*nContA*nContB)
       TMParray2maxSize = MAX(TMParray2maxSize,36*nContQ*nPrimP)
    ...
    TMParray1maxSize = MAX(TMParray1maxSize,140*nContC*nContD*nContA*nPrimB)
    TMParray2maxSize = MAX(TMParray2maxSize,140*nContC*nContD*nContA*nContB)
       TMParray1maxSize = MAX(TMParray1maxSize,144*nContQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,100*nContQ*nPrimP)
    ...
    TMParray2maxSize = MAX(TMParray2maxSize,350*nContC*nContD*nContA*nContB)
       TMParray1maxSize = MAX(TMParray1maxSize,360*nContQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,250*nContQ*nPrimP)
       TMParray1maxSize = MAX(TMParray1maxSize,150*nContQ*nContP)
    ...
    TMParray1maxSize = MAX(TMParray1maxSize,700*nContC*nContD*nContA*nPrimB)
    TMParray2maxSize = MAX(TMParray2maxSize,700*nContC*nContD*nContA*nContB)
       TMParray1maxSize = MAX(TMParray1maxSize,720*nContQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,500*nContQ*nPrimP)
       TMParray1maxSize = MAX(TMParray1maxSize,450*nContQ*nContP)
    ...
    CASE(2222)  !Angmom(A= 2,B= 2,C= 2,D= 2) combi
       ...
       TMParray2maxSize = MAX(TMParray2maxSize,1225*nPrimQ*nPrimP)
    ...
    TMParray2maxSize = MAX(TMParray2maxSize,1225*nContC*nContD*nContA*nContB)
       TMParray1maxSize = MAX(TMParray1maxSize,1260*nContQ*nPrimP)
       TMParray2maxSize = MAX(TMParray2maxSize,875*nContQ*nPrimP)
       TMParray1maxSize = MAX(TMParray1maxSize,900*nContQ*nContP)
    CASE DEFAULT
...
END MODULE IchorEriCoulombintegralCPUOBSGeneralModGenSize
