module SPIchorEriCoulombintegralCPUOBSGeneralModGenSize
...
private   
public :: SPICI_CPU_OBS_general_sizeGen  
  
CONTAINS
  
  subroutine SPICI_CPU_OBS_general_sizeGen(TMParray1maxsize,&
    ...
    CASE DEFAULT
     call SPICI_CPU_McM_general_size(TMParray1maxsize,&
         ...
         & .FALSE.,.FALSE.)
    END SELECT
  end subroutine SPICI_CPU_OBS_general_sizeGen
END module SPIchorEriCoulombintegralCPUOBSGeneralModGenSize
