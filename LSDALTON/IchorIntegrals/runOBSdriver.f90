...
!  WRITE(LUMOD2,'(A)')'use SPIchorEriCoulombintegral'//ARCSTRING//'OBSGeneralModSeg1Prim2'
  ...
  IF(.NOT.CPU)THEN
     WRITE(LUMOD3,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoCGen3'
     WRITE(LUMOD3,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoCGen4'
  ENDIF
  WRITE(LUMOD3,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDGen1'
  WRITE(LUMOD3,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDGen2'
  IF(.NOT.CPU)THEN
     WRITE(LUMOD3,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDGen3'
  ENDIF
  WRITE(LUMOD3,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoCGen1'
  IF(.NOT.CPU)THEN
     WRITE(LUMOD3,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoCGen2'
  ENDIF
  WRITE(LUMOD3,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoDGen1'
  IF(.NOT.CPU)WRITE(LUMOD3,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoDGen2'
  ...
  IF(.NOT.CPU)WRITE(LUMOD4,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoCSegQ4'
  WRITE(LUMOD4,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSegQ1'
  WRITE(LUMOD4,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSegQ2'
  IF(.NOT.CPU)WRITE(LUMOD4,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSegQ3'
  WRITE(LUMOD4,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoCSegQ1'
  IF(.NOT.CPU)WRITE(LUMOD4,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoCSegQ2'
  WRITE(LUMOD4,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoDSegQ1'
  IF(.NOT.CPU)WRITE(LUMOD4,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoDSegQ2'
  ...
  IF(.NOT.CPU)WRITE(LUMOD5,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoCSegP4'
  WRITE(LUMOD5,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSegP1'
  WRITE(LUMOD5,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSegP2'
  IF(.NOT.CPU)WRITE(LUMOD5,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSegP3'
  WRITE(LUMOD5,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoCSegP1'
  IF(.NOT.CPU)WRITE(LUMOD5,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoCSegP2'
  WRITE(LUMOD5,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoDSegP1'
  IF(.NOT.CPU)WRITE(LUMOD5,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoDSegP2'
  ...
  IF(.NOT.CPU)WRITE(LUMOD6,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoCSeg4'
  WRITE(LUMOD6,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSeg1'
  WRITE(LUMOD6,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSeg2'
  IF(.NOT.CPU)WRITE(LUMOD6,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSeg3'
  WRITE(LUMOD6,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoCSeg1'
  IF(.NOT.CPU)WRITE(LUMOD6,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoCSeg2'
  WRITE(LUMOD6,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoDSeg1'
  IF(.NOT.CPU)WRITE(LUMOD6,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoDSeg2'
  ...
  IF(.NOT.CPU)WRITE(LUMOD7,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoCSeg1Prim3'
  IF(.NOT.CPU)WRITE(LUMOD7,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoCSeg1Prim4'
  WRITE(LUMOD7,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSeg1Prim1'
  WRITE(LUMOD7,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSeg1Prim2'
  IF(.NOT.CPU)WRITE(LUMOD7,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSeg1Prim3'
  WRITE(LUMOD7,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoCSeg1Prim1'
  IF(.NOT.CPU)WRITE(LUMOD7,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoCSeg1Prim2'
  WRITE(LUMOD7,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoDSeg1Prim1'  
  IF(.NOT.CPU)WRITE(LUMOD7,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoDSeg1Prim2'  
  ...
  IF(.NOT.CPU)THEN
     WRITE(LUMOD8,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoCGen3'
     WRITE(LUMOD8,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoCGen4'
  ENDIF
  WRITE(LUMOD8,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDGen1'
  WRITE(LUMOD8,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDGen2'
  IF(.NOT.CPU)THEN
     WRITE(LUMOD8,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDGen3'
  ENDIF
  WRITE(LUMOD8,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoCGen1'
  IF(.NOT.CPU)THEN
     WRITE(LUMOD8,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoCGen2'
  ENDIF
  WRITE(LUMOD8,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoDGen1'
  IF(.NOT.CPU)WRITE(LUMOD8,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoDGen2'
  ...
  IF(.NOT.CPU)WRITE(LUMOD9,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoCSegQ4'
  WRITE(LUMOD9,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSegQ1'
  WRITE(LUMOD9,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSegQ2'
  IF(.NOT.CPU)WRITE(LUMOD9,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSegQ3'
  WRITE(LUMOD9,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoCSegQ1'
  IF(.NOT.CPU)WRITE(LUMOD9,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoCSegQ2'
  WRITE(LUMOD9,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoDSegQ1'
  IF(.NOT.CPU)WRITE(LUMOD9,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoDSegQ2'
  ...
  IF(.NOT.CPU)WRITE(LUMOD10,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoCSegP4'
  WRITE(LUMOD10,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSegP1'
  WRITE(LUMOD10,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSegP2'
  IF(.NOT.CPU)WRITE(LUMOD10,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSegP3'
  WRITE(LUMOD10,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoCSegP1'
  IF(.NOT.CPU)WRITE(LUMOD10,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoCSegP2'
  WRITE(LUMOD10,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoDSegP1'
  IF(.NOT.CPU)WRITE(LUMOD10,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoDSegP2'
  ...
  IF(.NOT.CPU)WRITE(LUMOD11,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoCSeg4'
  WRITE(LUMOD11,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSeg1'
  WRITE(LUMOD11,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSeg2'
  IF(.NOT.CPU)WRITE(LUMOD11,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSeg3'
  WRITE(LUMOD11,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoCSeg1'
  IF(.NOT.CPU)WRITE(LUMOD11,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoCSeg2'
  WRITE(LUMOD11,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoDSeg1'
  IF(.NOT.CPU)WRITE(LUMOD11,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoDSeg2'
  ...
  IF(.NOT.CPU)WRITE(LUMOD12,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoCSeg1Prim3'
  IF(.NOT.CPU)WRITE(LUMOD12,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoCSeg1Prim4'
  WRITE(LUMOD12,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSeg1Prim1'
  WRITE(LUMOD12,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSeg1Prim2'
  IF(.NOT.CPU)WRITE(LUMOD12,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODAtoDSeg1Prim3'
  WRITE(LUMOD12,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoCSeg1Prim1'
  IF(.NOT.CPU)WRITE(LUMOD12,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoCSeg1Prim2'
  WRITE(LUMOD12,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoDSeg1Prim1'
  IF(.NOT.CPU)WRITE(LUMOD12,'(A)')'use AGC_'//ARCSTRING//'_OBS_TRMODBtoDSeg1Prim2'
