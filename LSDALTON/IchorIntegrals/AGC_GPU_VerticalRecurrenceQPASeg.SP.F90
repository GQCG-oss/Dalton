module SPAGC_GPU_OBS_VERTICALRECURRENCEMODASeg
 use IchorPrecisionMod
  
 CONTAINS

subroutine SPVerticalRecurrenceGPUSeg0(nPassP,nPrimP,nPrimQ,&
...
!     !  0 < WVAL < 12 
  ...
  ENDDO !iP = 1,nPassP
end subroutine SPVerticalRecurrenceGPUSeg0

subroutine SPVerticalRecurrenceGPUSeg1A(nPassP,nPrimP,nPrimQ,&
...
!$ACC        nPrimP,nPrimQ,nPassP) ASYNC(iASync)
  DO iP = 1,nPassP
   ...
   ENDDO !iPrimQP = 1,nPrimQ*nPrimP
  ENDDO !iP = 1,nPassP
end subroutine SPVerticalRecurrenceGPUSeg1A

subroutine SPVerticalRecurrenceGPUSeg2A(nPassP,nPrimP,nPrimQ,&
...
subroutine SPVerticalRecurrenceGPUSeg3A(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Pexp,Acenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray,iASync)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
...
subroutine SPVerticalRecurrenceGPUSeg4A(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Pexp,Acenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray,iASync)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
