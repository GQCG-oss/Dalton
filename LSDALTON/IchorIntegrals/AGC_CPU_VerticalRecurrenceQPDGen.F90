MODULE AGC_CPU_OBS_VERTICALRECURRENCEMODDGen
 use IchorPrecisionModule
  
 CONTAINS


subroutine VerticalRecurrenceCPUGen1D(nPassP,nPrimP,nPrimQ,&
...
!$OMP END DO
end subroutine VerticalRecurrenceCPUGen1D

subroutine VerticalRecurrenceCPUGen2D(nPassP,nPrimP,nPrimQ,&
...
subroutine VerticalRecurrenceCPUGen3D(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Dcenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
...
subroutine VerticalRecurrenceCPUGen4D(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Dcenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
...
subroutine VerticalRecurrenceCPUGen5D(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Dcenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
