module SPIchorEriCoulombintegralCPUOBSGeneralModSegPSize
...
private   
public :: SPICI_CPU_OBS_general_sizeSegP  
  
CONTAINS
  
  subroutine SPICI_CPU_OBS_general_sizeSegP(TMParray1maxsize,&
    ...
    CASE DEFAULT
     call SPICI_CPU_McM_general_size(TMParray1maxsize,&
         ...
         & .TRUE.,.FALSE.)
    END SELECT
  end subroutine SPICI_CPU_OBS_general_sizeSegP
END module SPIchorEriCoulombintegralCPUOBSGeneralModSegPSize
