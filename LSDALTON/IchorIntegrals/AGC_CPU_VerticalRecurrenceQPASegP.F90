MODULE AGC_CPU_OBS_VERTICALRECURRENCEMODASegP
 use IchorPrecisionModule
  
 CONTAINS

subroutine VerticalRecurrenceCPUSegP0(nPasses,nPrimP,nPrimQ,&
  ...
  real(realk),intent(inout) :: AUXarray(nPrimQ,nPasses)
  !local variables
...
!     !  0 < WVAL < 12 
     ...
     ENDIF
     AUXarray(iPrimQ,iPassQ)=AUXarray(iPrimQ,iPassQ)+integralPrefactor(iPrimQ,iPrimP)*&
          & QpreExpFac(iPrimQ,iPassQ)*Pexpfac*RJ000
    enddo
   enddo
  enddo
end subroutine VerticalRecurrenceCPUSegP0

subroutine VerticalRecurrenceCPUSegP1A(nPasses,nPrimP,nPrimQ,reducedExponents,&
  ...
  DO iPassQ = 1,nPasses
   ...
   DO iPrimP=1, nPrimP
    ...
    DO iPrimQ=1, nPrimQ
     ...
     AUXarray(2,iPrimQ,iPassQ) = AUXarray(2,iPrimQ,iPassQ) + Xpa*TMP1 + alphaXpq*TMP2
     AUXarray(3,iPrimQ,iPassQ) = AUXarray(3,iPrimQ,iPassQ) + Ypa*TMP1 + alphaYpq*TMP2
     AUXarray(4,iPrimQ,iPassQ) = AUXarray(4,iPrimQ,iPassQ) + Zpa*TMP1 + alphaZpq*TMP2
    enddo
   enddo
  enddo
end subroutine

subroutine VerticalRecurrenceCPUSegP2A(nPasses,nPrimP,nPrimQ,reducedExponents,&
...
subroutine VerticalRecurrenceCPUSegP3A(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & TABFJW,Pexp,Acenter,Pcent,Qcent,integralPrefactor,PpreExpFac,QpreExpFac,&
         & AUXarray)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ
...
subroutine VerticalRecurrenceCPUSegP4A(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & TABFJW,Pexp,Acenter,Pcent,Qcent,integralPrefactor,PpreExpFac,QpreExpFac,&
         & AUXarray)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ
...
subroutine VerticalRecurrenceCPUSegP5A(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & TABFJW,Pexp,Acenter,Pcent,Qcent,integralPrefactor,PpreExpFac,QpreExpFac,&
         & AUXarray)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ
...
subroutine VerticalRecurrenceCPUSegP6A(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & TABFJW,Pexp,Acenter,Pcent,Qcent,integralPrefactor,PpreExpFac,QpreExpFac,&
         & AUXarray)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ
...
subroutine VerticalRecurrenceCPUSegP7A(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & TABFJW,Pexp,Acenter,Pcent,Qcent,integralPrefactor,PpreExpFac,QpreExpFac,&
         & AUXarray)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ
...
subroutine VerticalRecurrenceCPUSegP8A(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & TABFJW,Pexp,Acenter,Pcent,Qcent,integralPrefactor,PpreExpFac,QpreExpFac,&
         & AUXarray)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ
