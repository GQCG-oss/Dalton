MODULE AGC_CPU_OBS_VERTICALRECURRENCEMODB
 use IchorPrecisionModule
  
 CONTAINS

subroutine VerticalRecurrenceCPU1B(nPasses,nPrimP,nPrimQ,reducedExponents,&
...
subroutine VerticalRecurrenceCPU2B(nPasses,nPrimP,nPrimQ,reducedExponents,&
...
subroutine VerticalRecurrenceCPU3B(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & TABFJW,Pexp,Bcenter,Pcent,Qcent,integralPrefactor,PpreExpFac,QpreExpFac,&
         & AUXarray)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ
...
subroutine VerticalRecurrenceCPU4B(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & TABFJW,Pexp,Bcenter,Pcent,Qcent,integralPrefactor,PpreExpFac,QpreExpFac,&
         & AUXarray)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ
...
subroutine VerticalRecurrenceCPU5B(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & TABFJW,Pexp,Bcenter,Pcent,Qcent,integralPrefactor,PpreExpFac,QpreExpFac,&
         & AUXarray)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ
...
subroutine VerticalRecurrenceCPU6B(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & TABFJW,Pexp,Bcenter,Pcent,Qcent,integralPrefactor,PpreExpFac,QpreExpFac,&
         & AUXarray)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ
...
subroutine VerticalRecurrenceCPU7B(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & TABFJW,Pexp,Bcenter,Pcent,Qcent,integralPrefactor,PpreExpFac,QpreExpFac,&
         & AUXarray)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ
  ...
  DO iPassQ = 1,nPasses
   ...
   DO iPrimP=1, nPrimP
    ...
    DO iPrimQ=1, nPrimQ
     ...
     AuxArray(85,IP) = Xpb*AuxArray(57,IP) + alphaXpq*TmpArray7(57,2) + 6*TwoTerms(1)
     AuxArray(86,IP) = Ypb*AuxArray(57,IP) + alphaYpq*TmpArray7(57,2)
     AuxArray(87,IP) = Zpb*AuxArray(57,IP) + alphaZpq*TmpArray7(57,2)
     AuxArray(88,IP) = Xpb*AuxArray(60,IP) + alphaXpq*TmpArray7(60,2) + 4*TwoTerms(2)
     AuxArray(89,IP) = Ypb*AuxArray(59,IP) + alphaYpq*TmpArray7(59,2)
     AuxArray(90,IP) = Xpb*AuxArray(62,IP) + alphaXpq*TmpArray7(62,2) + 4*TwoTerms(3)
     AuxArray(91,IP) = Xpb*AuxArray(63,IP) + alphaXpq*TmpArray7(63,2) + 3*TwoTerms(4)
     AuxArray(92,IP) = Zpb*AuxArray(60,IP) + alphaZpq*TmpArray7(60,2)
     AuxArray(93,IP) = Ypb*AuxArray(62,IP) + alphaYpq*TmpArray7(62,2)
     AuxArray(94,IP) = Xpb*AuxArray(66,IP) + alphaXpq*TmpArray7(66,2) + 3*TwoTerms(5)
     AuxArray(95,IP) = Xpb*AuxArray(67,IP) + alphaXpq*TmpArray7(67,2) + 2*TwoTerms(6)
     AuxArray(96,IP) = Zpb*AuxArray(63,IP) + alphaZpq*TmpArray7(63,2)
     AuxArray(97,IP) = Xpb*AuxArray(69,IP) + alphaXpq*TmpArray7(69,2) + 2*TwoTerms(7)
     AuxArray(98,IP) = Ypb*AuxArray(66,IP) + alphaYpq*TmpArray7(66,2)
     AuxArray(99,IP) = Xpb*AuxArray(71,IP) + alphaXpq*TmpArray7(71,2) + 2*TwoTerms(8)
     AuxArray(100,IP) = Xpb*AuxArray(72,IP) + alphaXpq*TmpArray7(72,2) + TwoTerms(9)
     AuxArray(101,IP) = Zpb*AuxArray(67,IP) + alphaZpq*TmpArray7(67,2)
     AuxArray(102,IP) = Xpb*AuxArray(74,IP) + alphaXpq*TmpArray7(74,2) + TwoTerms(10)
     AuxArray(103,IP) = Xpb*AuxArray(75,IP) + alphaXpq*TmpArray7(75,2) + TwoTerms(11)
     AuxArray(104,IP) = Ypb*AuxArray(71,IP) + alphaYpq*TmpArray7(71,2)
     AuxArray(105,IP) = Xpb*AuxArray(77,IP) + alphaXpq*TmpArray7(77,2) + TwoTerms(13)
     ...
     AuxArray(113,IP) = Ypb*AuxArray(78,IP) + alphaYpq*TmpArray7(78,2) + 6*TwoTerms(9)
     AuxArray(114,IP) = Zpb*AuxArray(78,IP) + alphaZpq*TmpArray7(78,2)
     AuxArray(115,IP) = Ypb*AuxArray(80,IP) + alphaYpq*TmpArray7(80,2) + 4*TwoTerms(10)
     AuxArray(116,IP) = Ypb*AuxArray(81,IP) + alphaYpq*TmpArray7(81,2) + 3*TwoTerms(11)
     AuxArray(117,IP) = Ypb*AuxArray(82,IP) + alphaYpq*TmpArray7(82,2) + 2*TwoTerms(12)
     AuxArray(118,IP) = Ypb*AuxArray(83,IP) + alphaYpq*TmpArray7(83,2) + TwoTerms(13)
     AuxArray(119,IP) = Ypb*AuxArray(84,IP) + alphaYpq*TmpArray7(84,2)
     AuxArray(120,IP) = Zpb*AuxArray(84,IP) + alphaZpq*TmpArray7(84,2) + 6*TwoTerms(13)
    ENDDO
   ENDDO
  ENDDO
 end subroutine

subroutine VerticalRecurrenceCPU8B(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & TABFJW,Pexp,Bcenter,Pcent,Qcent,integralPrefactor,PpreExpFac,QpreExpFac,&
         & AUXarray)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ
  ...
  DO iPassQ = 1,nPasses
   ...
   DO iPrimP=1, nPrimP
    ...
    DO iPrimQ=1, nPrimQ
     ...
     AuxArray(121,IP) = Xpb*AuxArray(85,IP) + alphaXpq*TmpArray8(85,2) + 7*TwoTerms(1)
     AuxArray(122,IP) = Ypb*AuxArray(85,IP) + alphaYpq*TmpArray8(85,2)
     AuxArray(123,IP) = Zpb*AuxArray(85,IP) + alphaZpq*TmpArray8(85,2)
     AuxArray(124,IP) = Xpb*AuxArray(88,IP) + alphaXpq*TmpArray8(88,2) + 5*TwoTerms(2)
     AuxArray(125,IP) = Ypb*AuxArray(87,IP) + alphaYpq*TmpArray8(87,2)
     AuxArray(126,IP) = Xpb*AuxArray(90,IP) + alphaXpq*TmpArray8(90,2) + 5*TwoTerms(3)
     AuxArray(127,IP) = Xpb*AuxArray(91,IP) + alphaXpq*TmpArray8(91,2) + 4*TwoTerms(4)
     AuxArray(128,IP) = Zpb*AuxArray(88,IP) + alphaZpq*TmpArray8(88,2)
     AuxArray(129,IP) = Ypb*AuxArray(90,IP) + alphaYpq*TmpArray8(90,2)
     AuxArray(130,IP) = Xpb*AuxArray(94,IP) + alphaXpq*TmpArray8(94,2) + 4*TwoTerms(5)
     AuxArray(131,IP) = Xpb*AuxArray(95,IP) + alphaXpq*TmpArray8(95,2) + 3*TwoTerms(6)
     AuxArray(132,IP) = Zpb*AuxArray(91,IP) + alphaZpq*TmpArray8(91,2)
     AuxArray(133,IP) = Xpb*AuxArray(97,IP) + alphaXpq*TmpArray8(97,2) + 3*TwoTerms(7)
     AuxArray(134,IP) = Ypb*AuxArray(94,IP) + alphaYpq*TmpArray8(94,2)
     AuxArray(135,IP) = Xpb*AuxArray(99,IP) + alphaXpq*TmpArray8(99,2) + 3*TwoTerms(8)
     AuxArray(136,IP) = Xpb*AuxArray(100,IP) + alphaXpq*TmpArray8(100,2) + 2*TwoTerms(9)
     AuxArray(137,IP) = Zpb*AuxArray(95,IP) + alphaZpq*TmpArray8(95,2)
     AuxArray(138,IP) = Xpb*AuxArray(102,IP) + alphaXpq*TmpArray8(102,2) + 2*TwoTerms(10)
     AuxArray(139,IP) = Xpb*AuxArray(103,IP) + alphaXpq*TmpArray8(103,2) + 2*TwoTerms(11)
     AuxArray(140,IP) = Ypb*AuxArray(99,IP) + alphaYpq*TmpArray8(99,2)
     AuxArray(141,IP) = Xpb*AuxArray(105,IP) + alphaXpq*TmpArray8(105,2) + 2*TwoTerms(12)
     AuxArray(142,IP) = Xpb*AuxArray(106,IP) + alphaXpq*TmpArray8(106,2) + TwoTerms(13)
     AuxArray(143,IP) = Zpb*AuxArray(100,IP) + alphaZpq*TmpArray8(100,2)
     AuxArray(144,IP) = Xpb*AuxArray(108,IP) + alphaXpq*TmpArray8(108,2) + TwoTerms(14)
     AuxArray(145,IP) = Xpb*AuxArray(109,IP) + alphaXpq*TmpArray8(109,2) + TwoTerms(15)
     AuxArray(146,IP) = Xpb*AuxArray(110,IP) + alphaXpq*TmpArray8(110,2) + TwoTerms(16)
     AuxArray(147,IP) = Ypb*AuxArray(105,IP) + alphaYpq*TmpArray8(105,2)
     AuxArray(148,IP) = Xpb*AuxArray(112,IP) + alphaXpq*TmpArray8(112,2) + TwoTerms(18)
     ...
     AuxArray(157,IP) = Ypb*AuxArray(113,IP) + alphaYpq*TmpArray8(113,2) + 7*TwoTerms(13)
     AuxArray(158,IP) = Zpb*AuxArray(113,IP) + alphaZpq*TmpArray8(113,2)
     AuxArray(159,IP) = Ypb*AuxArray(115,IP) + alphaYpq*TmpArray8(115,2) + 5*TwoTerms(14)
     AuxArray(160,IP) = Ypb*AuxArray(116,IP) + alphaYpq*TmpArray8(116,2) + 4*TwoTerms(15)
     AuxArray(161,IP) = Ypb*AuxArray(117,IP) + alphaYpq*TmpArray8(117,2) + 3*TwoTerms(16)
     AuxArray(162,IP) = Ypb*AuxArray(118,IP) + alphaYpq*TmpArray8(118,2) + 2*TwoTerms(17)
     AuxArray(163,IP) = Ypb*AuxArray(119,IP) + alphaYpq*TmpArray8(119,2) + TwoTerms(18)
     AuxArray(164,IP) = Ypb*AuxArray(120,IP) + alphaYpq*TmpArray8(120,2)
     AuxArray(165,IP) = Zpb*AuxArray(120,IP) + alphaZpq*TmpArray8(120,2) + 7*TwoTerms(18)
    ENDDO
   ENDDO
  ENDDO
 end subroutine
