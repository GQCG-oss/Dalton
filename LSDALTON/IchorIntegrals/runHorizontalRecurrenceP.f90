...
CONTAINS
  subroutine PASSsub
    ...
    WRITE(*,'(A)')'MODULE AGC_OBS_HorizontalRecurrenceLHSMod'
    ...
    DO JMAX=0,MaxAngmomP
       ...
       DO AngmomA = 0,JP
          ...
          WRITE(*,'(A)')''
          IF(JP.LT.10)THEN
             WRITE(*,'(A,I1,A,I1,A,I1,A)')'subroutine HorizontalRR_LHS_P',JP,'A',AngmomA,'B',AngmomB,'(nContPasses,nTUVQ,&'
          ELSE
             WRITE(*,'(A,I2,A,I1,A,I1,A)')'subroutine HorizontalRR_LHS_P',JP,'A',AngmomA,'B',AngmomB,'(nContPasses,nTUVQ,&'
          ENDIF
          ...
          WRITE(*,'(A)')'  ENDDO'
          IF(JP.LT.10)THEN
             WRITE(*,'(A,I1,A,I1,A,I1)')'end subroutine HorizontalRR_LHS_P',JP,'A',AngmomA,'B',AngmomB
          ELSE
             WRITE(*,'(A,I2,A,I1,A,I1)')'end subroutine HorizontalRR_LHS_P',JP,'A',AngmomA,'B',AngmomB
          ENDIF
       enddo
       deallocate(TUVINDEX)
       deallocate(TINDEX)
