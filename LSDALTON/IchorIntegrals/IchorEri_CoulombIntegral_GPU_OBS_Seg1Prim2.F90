...
use AGC_GPU_OBS_TRMODAtoCSeg1Prim3
use AGC_GPU_OBS_TRMODAtoCSeg1Prim4
use AGC_GPU_OBS_TRMODAtoDSeg1Prim1
use AGC_GPU_OBS_TRMODAtoDSeg1Prim2
use AGC_GPU_OBS_TRMODAtoDSeg1Prim3
use AGC_GPU_OBS_TRMODBtoCSeg1Prim1
use AGC_GPU_OBS_TRMODBtoCSeg1Prim2
use AGC_GPU_OBS_TRMODBtoDSeg1Prim1
use AGC_GPU_OBS_TRMODBtoDSeg1Prim2
