module SPAGC_GPU_OBS_VERTICALRECURRENCEMODASegQ
 use IchorPrecisionMod
  
 CONTAINS

subroutine SPVerticalRecurrenceGPUSegQ0(nPassP,nPrimP,nPrimQ,&
  ...
  real(reals),intent(inout) :: AUXarray(nPrimP*nPassP)
...
end subroutine SPVerticalRecurrenceGPUSegQ0

subroutine SPVerticalRecurrenceGPUSegQ1A(nPassP,nPrimP,nPrimQ,&
  ...
  real(reals),intent(inout) :: AUXarray(nPrimP*nPassP,4)
  integer(kind=acckind),intent(in) :: iASync
  !local variables
...
!$ACC        nPrimP,nPrimQ,nPassP) ASYNC(iASync)
  DO iP = 1,nPrimP*nPassP
   ...
   ENDDO !iPrimP=1, nPrimP
  ENDDO !iP = 1,nPrimQ*nPassP
end subroutine SPVerticalRecurrenceGPUSegQ1A

subroutine SPVerticalRecurrenceGPUSegQ2A(nPassP,nPrimP,nPrimQ,&
  ...
  real(reals),intent(in) :: integralPrefactor(nprimQ,nPrimP),QpreExpFac(nPrimQ),PpreExpFac(nPrimP,nAtomsA,nAtomsB)
  real(reals),intent(in) :: Acenter(3,nAtomsA)
  real(reals),intent(inout) :: AUXarray(nPrimP*nPassP,   10)
  integer(kind=acckind),intent(in) :: iASync
  !local variables
...
subroutine SPVerticalRecurrenceGPUSegQ3A(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Pexp,Acenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray,iASync)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
  ...
  real(reals),intent(in) :: integralPrefactor(nprimQ,nPrimP),QpreExpFac(nPrimQ),PpreExpFac(nPrimP,nAtomsA,nAtomsB)
  real(reals),intent(in) :: Acenter(3,nAtomsA)
  real(reals),intent(inout) :: AUXarray(nPrimP*nPassP,   20)
  integer(kind=acckind),intent(in) :: iASync
  !local variables
  integer :: iPassP,iPrimP,iPrimQ,ipnt,IP,iTUV,iAtomA,iAtomB
...
subroutine SPVerticalRecurrenceGPUSegQ4A(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Pexp,Acenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray,iASync)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
  ...
  real(reals),intent(in) :: integralPrefactor(nprimQ,nPrimP),QpreExpFac(nPrimQ),PpreExpFac(nPrimP,nAtomsA,nAtomsB)
  real(reals),intent(in) :: Acenter(3,nAtomsA)
  real(reals),intent(inout) :: AUXarray(nPrimP*nPassP,   35)
  integer(kind=acckind),intent(in) :: iASync
  !local variables
  integer :: iPassP,iPrimP,iPrimQ,ipnt,IP,iTUV,iAtomA,iAtomB
