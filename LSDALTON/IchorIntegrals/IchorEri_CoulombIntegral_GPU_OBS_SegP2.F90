...
use AGC_GPU_OBS_TRMODAtoCSegP3
use AGC_GPU_OBS_TRMODAtoCSegP4
use AGC_GPU_OBS_TRMODAtoDSegP1
use AGC_GPU_OBS_TRMODAtoDSegP2
use AGC_GPU_OBS_TRMODAtoDSegP3
use AGC_GPU_OBS_TRMODBtoCSegP1
use AGC_GPU_OBS_TRMODBtoCSegP2
use AGC_GPU_OBS_TRMODBtoDSegP1
use AGC_GPU_OBS_TRMODBtoDSegP2
