...
!$OMP         iPrimP,iPrimQ,&
!$OMP         Dx,Dy,Dz,Xqd,Yqd,Zqd,alphaQ,&
  ...
  DO iPassP = 1,nPasses
   ...
   DO iPrimP=1, nPrimP
    ...
    DO iPrimQ=1, nPrimQ
     ...
     Xqd = Qcent(1,iPrimQ) + Dx
     Yqd = Qcent(2,iPrimQ) + Dy
     Zqd = Qcent(3,iPrimQ) + Dz
     ...
     AUXarray(2,iPrimQ,iPrimP,iPassP) = Xqd*TMP1 + alphaXpq*TMP2
     AUXarray(3,iPrimQ,iPrimP,iPassP) = Yqd*TMP1 + alphaYpq*TMP2
     AUXarray(4,iPrimQ,iPrimP,iPassP) = Zqd*TMP1 + alphaZpq*TMP2
    enddo
   enddo
  enddo
!$OMP END DO
...
!$OMP PRIVATE(iPassP,iAtomA,iAtomB,Xpq,Ypq,Zpq,&
!$OMP         iPrimP,iPrimQ,&
!$OMP         Dx,Dy,Dz,Xqd,Yqd,Zqd,alphaQ,inv2expQ,&
