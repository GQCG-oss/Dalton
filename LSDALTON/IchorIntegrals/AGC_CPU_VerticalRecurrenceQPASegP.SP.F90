module SPAGC_CPU_OBS_VERTICALRECURRENCEMODASegP
 use IchorPrecisionMod
  
 CONTAINS

subroutine SPVerticalRecurrenceCPUSegP0(nPassP,nPrimP,nPrimQ,&
...
!$OMP END DO
end subroutine SPVerticalRecurrenceCPUSegP0

subroutine SPVerticalRecurrenceCPUSegP1A(nPassP,nPrimP,nPrimQ,&
  ...
  real(reals),intent(inout) :: AUXarray(4,nPrimQ*nPassP)
  !local variables
...
!$OMP DO PRIVATE(iP)
  DO iP = 1,nPrimQ*nPassP
    AUXarray(1,iP)=0.0E0_reals
    AUXarray(2,iP)=0.0E0_reals
    AUXarray(3,iP)=0.0E0_reals
    AUXarray(4,iP)=0.0E0_reals
  ENDDO
!$OMP END DO
!$OMP DO &
!$OMP PRIVATE(iAtomA,iAtomB,Xpq,Ypq,Zpq,&
...
!$OMP         iP,iPrimQ,iPrimP,iPassP)
  ...
  ENDDO !iP = 1,nPrimP*nPassP
!$OMP END DO
end subroutine SPVerticalRecurrenceCPUSegP1A

subroutine SPVerticalRecurrenceCPUSegP2A(nPassP,nPrimP,nPrimQ,&
  ...
  real(reals),intent(in) :: integralPrefactor(nprimQ,nPrimP),QpreExpFac(nPrimQ),PpreExpFac(nPrimP,nAtomsA,nAtomsB)
  real(reals),intent(in) :: Acenter(3,nAtomsA)
  real(reals),intent(inout) :: AUXarray(   10,nPrimQ*nPassP)
  !local variables
...
subroutine SPVerticalRecurrenceCPUSegP3A(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Pexp,Acenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
  ...
  real(reals),intent(in) :: integralPrefactor(nprimQ,nPrimP),QpreExpFac(nPrimQ),PpreExpFac(nPrimP,nAtomsA,nAtomsB)
  real(reals),intent(in) :: Acenter(3,nAtomsA)
  real(reals),intent(inout) :: AUXarray(   20,nPrimQ*nPassP)
  !local variables
  integer :: iPassP,iPrimP,iPrimQ,ipnt,IP,iTUV,iAtomA,iAtomB
...
subroutine SPVerticalRecurrenceCPUSegP4A(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Pexp,Acenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
  ...
  real(reals),intent(in) :: integralPrefactor(nprimQ,nPrimP),QpreExpFac(nPrimQ),PpreExpFac(nPrimP,nAtomsA,nAtomsB)
  real(reals),intent(in) :: Acenter(3,nAtomsA)
  real(reals),intent(inout) :: AUXarray(   35,nPrimQ*nPassP)
  !local variables
  integer :: iPassP,iPrimP,iPrimQ,ipnt,IP,iTUV,iAtomA,iAtomB
