module SPAGC_CPU_OBS_HorizontalRecurrenceLHSModAtoB
 use IchorPrecisionMod
  
 CONTAINS

subroutine SPHorizontalRR_CPU_LHS_P1A1B0AtoB(nContQP,nPasses,nTUVQ,&
  ...
  real(reals),intent(inout) :: ThetaP(    2:    4,1,nTUVQ*nContQP*nPasses)
  !Local variables
...
!$OMP         iTUVA) 
  ...
  ENDDO
!$OMP END DO
end subroutine SPHorizontalRR_CPU_LHS_P1A1B0AtoB

subroutine SPHorizontalRR_CPU_LHS_P2A1B1AtoB(nContQP,nPasses,nTUVQ,&
         & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,AuxCont,ThetaP,lupri)
  implicit none
  integer,intent(in) :: nContQP,nPasses,nTUVQ,lupri,MaxPasses,nAtomsA,nAtomsB
  real(reals),intent(in) :: Pdistance12(3,nAtomsA,nAtomsB)
  ...
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(inout) :: ThetaP(    2:    4,    2:    4,nTUVQ*nContQP*nPasses)
  !Local variables
  integer :: iPassP,iP,iTUVQ,iTUVA,iAtomA,iAtomB
...
!    iContQP = mod((IP-(mod(IP-1,nTUVQ)+1))/nTUVQ,nContQP)+1
  ...
  ENDDO
!$OMP END DO
end subroutine SPHorizontalRR_CPU_LHS_P2A1B1AtoB

subroutine SPHorizontalRR_CPU_LHS_P2A2B0AtoB(nContQP,nPasses,nTUVQ,&
         & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,AuxCont,ThetaP,lupri)
  implicit none
  integer,intent(in) :: nContQP,nPasses,nTUVQ,lupri,MaxPasses,nAtomsA,nAtomsB
  real(reals),intent(in) :: Pdistance12(3,nAtomsA,nAtomsB)
  real(reals),intent(in) :: AuxCont(   10,nTUVQ*nContQP*nPasses)
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(inout) :: ThetaP(    5:   10,1,nTUVQ*nContQP*nPasses)
  !Local variables
  integer :: iPassP,iP,iTUVQ,iTUVA,iAtomA,iAtomB
!$OMP DO &
!$OMP PRIVATE(iP,&
!$OMP         iTUVA) 
  ...
  ENDDO
!$OMP END DO
end subroutine SPHorizontalRR_CPU_LHS_P2A2B0AtoB

subroutine SPHorizontalRR_CPU_LHS_P3A2B1AtoB(nContQP,nPasses,nTUVQ,&
         & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,AuxCont,ThetaP,lupri)
  implicit none
  integer,intent(in) :: nContQP,nPasses,nTUVQ,lupri,MaxPasses,nAtomsA,nAtomsB
  real(reals),intent(in) :: Pdistance12(3,nAtomsA,nAtomsB)
  ...
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(inout) :: ThetaP(    5:   10,    2:    4,nTUVQ*nContQP*nPasses)
  !Local variables
  integer :: iPassP,iP,iTUVQ,iTUVA,iAtomA,iAtomB
  real(reals) :: Xab,Yab,Zab
!$OMP DO &
...
!    iContQP = mod((IP-(mod(IP-1,nTUVQ)+1))/nTUVQ,nContQP)+1
  ...
  ENDDO
!$OMP END DO
end subroutine SPHorizontalRR_CPU_LHS_P3A2B1AtoB

subroutine SPHorizontalRR_CPU_LHS_P4A2B2AtoB(nContQP,nPasses,nTUVQ,&
         & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,AuxCont,ThetaP,lupri)
  implicit none
  integer,intent(in) :: nContQP,nPasses,nTUVQ,lupri,MaxPasses,nAtomsA,nAtomsB
  real(reals),intent(in) :: Pdistance12(3,nAtomsA,nAtomsB)
  real(reals),intent(in) :: AuxCont(   35,nTUVQ*nContQP*nPasses)
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(inout) :: ThetaP(    5:   10,    5:   10,nTUVQ*nContQP*nPasses)
  !Local variables
  integer :: iPassP,iP,iTUVQ,iTUVA,iAtomA,iAtomB
  real(reals) :: Xab,Yab,Zab
...
!    iContQP = mod((IP-(mod(IP-1,nTUVQ)+1))/nTUVQ,nContQP)+1
  ...
  ENDDO
!$OMP END DO
end subroutine SPHorizontalRR_CPU_LHS_P4A2B2AtoB
end module
