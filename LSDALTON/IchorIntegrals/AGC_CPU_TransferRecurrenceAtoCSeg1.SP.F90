module SPAGC_CPU_OBS_TRMODAtoCSeg1
 use IchorPrecisionMod
  
 CONTAINS
 subroutine SPTransferRecurrenceCPUP1Q1AtoCSeg(nPasses,nPrimP,nPrimQ,reducedExponents,&
...
!$OMP         invexpQ,inv2expQ,facX,facY,facZ,pinvq,iTUVQ,iTUVP,iTUVplus1)
 ...
 ! Building for Angular momentum Jq = 1
  ...
  ENDDO !iP = 1,nPasses
!$OMP END DO
 end subroutine SPTransferRecurrenceCPUP1Q1AtoCSeg
 subroutine SPTransferRecurrenceCPUP2Q1AtoCSeg(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
         & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,Aux,Aux2)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ,nPrimA,nPrimB,nPrimC,nPrimD,nAtomsA,nAtomsB,MaxPasses
...
!$OMP         invexpQ,inv2expQ,facX,facY,facZ,pinvq,iTUVQ,iTUVP,iTUVplus1)
 ...
 ! Building for Angular momentum Jq = 1
  ...
  ENDDO !iP = 1,nPasses
!$OMP END DO
 end subroutine SPTransferRecurrenceCPUP2Q1AtoCSeg
 subroutine SPTransferRecurrenceCPUP2Q2AtoCSeg(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
         & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,Aux,Aux2)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ,nPrimA,nPrimB,nPrimC,nPrimD,nAtomsA,nAtomsB,MaxPasses
...
!$OMP         invexpQ,inv2expQ,facX,facY,facZ,pinvq,iTUVQ,iTUVP,iTUVplus1)
 ...
 ! Building for Angular momentum Jq = 2
  ...
  ENDDO !iP = 1,nPasses
!$OMP END DO
 end subroutine SPTransferRecurrenceCPUP2Q2AtoCSeg
 subroutine SPTransferRecurrenceCPUP3Q1AtoCSeg(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
         & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,Aux,Aux2)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ,nPrimA,nPrimB,nPrimC,nPrimD,nAtomsA,nAtomsB,MaxPasses
...
!$OMP         invexpQ,inv2expQ,facX,facY,facZ,pinvq,iTUVQ,iTUVP,iTUVplus1)
 ...
 ! Building for Angular momentum Jq = 1
  ...
  ENDDO !iP = 1,nPasses
!$OMP END DO
 end subroutine SPTransferRecurrenceCPUP3Q1AtoCSeg
 subroutine SPTransferRecurrenceCPUP3Q2AtoCSeg(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
         & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,Aux,Aux2)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ,nPrimA,nPrimB,nPrimC,nPrimD,nAtomsA,nAtomsB,MaxPasses
...
!$OMP         invexpQ,inv2expQ,facX,facY,facZ,pinvq,iTUVQ,iTUVP,iTUVplus1)
 ...
 ! Building for Angular momentum Jq = 2
  ...
  ENDDO !iP = 1,nPasses
!$OMP END DO
 end subroutine SPTransferRecurrenceCPUP3Q2AtoCSeg
 subroutine SPTransferRecurrenceCPUP4Q1AtoCSeg(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
         & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,Aux,Aux2)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ,nPrimA,nPrimB,nPrimC,nPrimD,nAtomsA,nAtomsB,MaxPasses
...
!$OMP         invexpQ,inv2expQ,facX,facY,facZ,pinvq,iTUVQ,iTUVP,iTUVplus1)
 ...
 ! Building for Angular momentum Jq = 1
  ...
  ENDDO !iP = 1,nPasses
!$OMP END DO
 end subroutine SPTransferRecurrenceCPUP4Q1AtoCSeg
END module SPAGC_CPU_OBS_TRMODAtoCSeg1
