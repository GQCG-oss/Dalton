...
subroutine VerticalRecurrenceGPUSeg1Prim0(nPassP,nPrimP,nPrimQ,&
...
!     !  0 < WVAL < 12 
  ...
  ENDDO !iP = 1,nPassP
end subroutine VerticalRecurrenceGPUSeg1Prim0
...
!$ACC        nPrimP,nPrimQ,nPassP)
  ...
  ENDDO !iP = 1,nPassP
end subroutine VerticalRecurrenceGPUSeg1Prim1A
