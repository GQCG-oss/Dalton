MODULE AGC_CPU_OBS_TRMODAtoDGen1
 use IchorPrecisionMod
  
 CONTAINS
 subroutine TransferRecurrenceCPUP1Q1AtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
...
END MODULE AGC_CPU_OBS_TRMODAtoDGen1
