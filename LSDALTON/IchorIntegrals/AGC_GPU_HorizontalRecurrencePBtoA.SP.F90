module SPAGC_GPU_OBS_HorizontalRecurrenceLHSModBtoA
 use IchorPrecisionMod
  
 CONTAINS

subroutine SPHorizontalRR_GPU_LHS_P1A0B1BtoA(nContQP,nPasses,nTUVQ,&
  ...
  real(reals),intent(inout) :: ThetaP(nContQP*nPasses,    1:    1,    2:    4,nTUVQ)
...
!$ACC         AuxCont,ThetaP) ASYNC(iASync)
  DO iP = 1,nContQP*nPasses
   ...
   ENDDO
  ENDDO
end subroutine SPHorizontalRR_GPU_LHS_P1A0B1BtoA

subroutine SPHorizontalRR_GPU_LHS_P2A0B2BtoA(nContQP,nPasses,nTUVQ,&
         & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,AuxCont,ThetaP,lupri,iASync)
  implicit none
  integer,intent(in) :: nContQP,nPasses,nTUVQ,lupri,MaxPasses,nAtomsA,nAtomsB
  real(reals),intent(in) :: Pdistance12(3,nAtomsA,nAtomsB)
  ...
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(inout) :: ThetaP(nContQP*nPasses,    1:    1,    5:   10,nTUVQ)
  integer(kind=acckind) :: iASync
  !Local variables
  integer :: iPassP,iP,iTUVQ,iTUVB,iAtomA,iAtomB
!$ACC PARALLEL LOOP &
...
!$ACC         AuxCont,ThetaP) ASYNC(iASync)
  DO iP = 1,nContQP*nPasses
   ...
   ENDDO
  ENDDO
end subroutine SPHorizontalRR_GPU_LHS_P2A0B2BtoA

subroutine SPHorizontalRR_GPU_LHS_P3A1B2BtoA(nContQP,nPasses,nTUVQ,&
         & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,AuxCont,ThetaP,lupri,iASync)
  implicit none
  integer,intent(in) :: nContQP,nPasses,nTUVQ,lupri,MaxPasses,nAtomsA,nAtomsB
  real(reals),intent(in) :: Pdistance12(3,nAtomsA,nAtomsB)
  ...
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(inout) :: ThetaP(nContQP*nPasses,    2:    4,    5:   10,nTUVQ)
  integer(kind=acckind) :: iASync
  !Local variables
  integer :: iPassP,iP,iTUVQ,iTUVB,iAtomA,iAtomB
...
!$ACC         iAtomApass,iAtomBpass,Pdistance12,AuxCont,ThetaP) ASYNC(iASync)
  DO iP = 1,nContQP*nPasses
   ...
   ENDDO
  ENDDO
end subroutine SPHorizontalRR_GPU_LHS_P3A1B2BtoA
end module
