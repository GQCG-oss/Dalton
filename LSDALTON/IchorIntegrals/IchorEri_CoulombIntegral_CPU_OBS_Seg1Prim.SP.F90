module SPIchorEriCoulombintegralCPUOBSGeneralModSeg1Prim
...
private   
public :: SPICI_CPU_OBS_Seg1Prim
  
CONTAINS
  
  
  subroutine SPICI_CPU_OBS_Seg1Prim(nPrimA,nPrimB,nPrimC,nPrimD,&
...
!    nlmD = 2*AngmomD+1
    ...
    CASE(   0)  !Angmom(A= 0,B= 0,C= 0,D= 0) combi
        call SPVerticalRecurrenceCPUSeg1Prim0(nPasses,nPrimP,nPrimQ,&
    ...
    CASE(1000)  !Angmom(A= 1,B= 0,C= 0,D= 0) combi
        call SPVerticalRecurrenceCPUSeg1Prim1A(nPasses,nPrimP,nPrimQ,reducedExponents,&
    ...
    CASE(1010)  !Angmom(A= 1,B= 0,C= 1,D= 0) combi
        ...
        call SPVerticalRecurrenceCPUSeg1Prim2A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1)
        call SPTransferRecurrenceCPUP1Q1AtoCSeg1Prim(nPasses,nPrimP,nPrimQ,reducedExponents,&
    ...
    CASE(1110)  !Angmom(A= 1,B= 1,C= 1,D= 0) combi
        ...
        call SPVerticalRecurrenceCPUSeg1Prim3A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1)
        call SPTransferRecurrenceCPUP2Q1AtoCSeg1Prim(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2)
        !Primitive Contraction have already been done
    ...
    CASE(2110)  !Angmom(A= 2,B= 1,C= 1,D= 0) combi
        ...
        call SPVerticalRecurrenceCPUSeg1Prim4A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1)
        call SPTransferRecurrenceCPUP3Q1AtoCSeg1Prim(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2)
        !Primitive Contraction have already been done
    ...
    CASE(2111)  !Angmom(A= 2,B= 1,C= 1,D= 1) combi
        ...
        call SPVerticalRecurrenceCPUSeg1Prim5A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1)
        call SPTransferRecurrenceCPUP3Q2AtoCSeg1Prim(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2)
        !Primitive Contraction have already been done
    ...
    CASE(2121)  !Angmom(A= 2,B= 1,C= 2,D= 1) combi
        ...
        call SPVerticalRecurrenceCPUSeg1Prim6A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1)
        call SPTransferRecurrenceCPUP3Q3AtoCSeg1Prim(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2)
        !Primitive Contraction have already been done
    ...
    CASE(2122)  !Angmom(A= 2,B= 1,C= 2,D= 2) combi
        ...
        call SPVerticalRecurrenceCPUSeg1Prim7C(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1)
        call SPTransferRecurrenceCPUP3Q4CtoASeg1Prim(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Dexp,Bexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2)
        !Primitive Contraction have already been done
    ...
    CASE(2210)  !Angmom(A= 2,B= 2,C= 1,D= 0) combi
        ...
        call SPVerticalRecurrenceCPUSeg1Prim5A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1)
        call SPTransferRecurrenceCPUP4Q1AtoCSeg1Prim(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2)
        !Primitive Contraction have already been done
    ...
    CASE(2211)  !Angmom(A= 2,B= 2,C= 1,D= 1) combi
        ...
        call SPVerticalRecurrenceCPUSeg1Prim6A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1)
        call SPTransferRecurrenceCPUP4Q2AtoCSeg1Prim(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2)
        !Primitive Contraction have already been done
    ...
    CASE(2221)  !Angmom(A= 2,B= 2,C= 2,D= 1) combi
        ...
        call SPVerticalRecurrenceCPUSeg1Prim7A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1)
        call SPTransferRecurrenceCPUP4Q3AtoCSeg1Prim(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2)
        !Primitive Contraction have already been done
    ...
    CASE(2222)  !Angmom(A= 2,B= 2,C= 2,D= 2) combi
        call SPBuildRJ000CPUSeg1Prim8(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & TABFJW,Pcent,Qcent,IatomApass,IatomBpass,&
               & MaxPasses,nAtomsA,nAtomsB,TMParray2)
        call SPVerticalRecurrenceCPUSeg1Prim8A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & TMParray2,Pexp,Acenter,Pcent,Qcent,integralPrefactor,&
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1)
        call SPTransferRecurrenceCPUP4Q4AtoCSeg1Prim(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2)
        !Primitive Contraction have already been done
        ...
        call SPSphericalContractOBS2_CPU_maxAngQ4_maxAngC2(25,nPasses,TMParray1,&
            & LOCALINTS)
    CASE DEFAULT
        call ichorquit('Unknown Case in ICI_CPU_OBS_Seg1Prim',-1)
    END SELECT
  end subroutine SPICI_CPU_OBS_Seg1Prim
  
END module SPIchorEriCoulombintegralCPUOBSGeneralModSeg1Prim
