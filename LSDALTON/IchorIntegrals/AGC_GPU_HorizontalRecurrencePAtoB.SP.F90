module SPAGC_GPU_OBS_HorizontalRecurrenceLHSModAtoB
 use IchorPrecisionMod
  
 CONTAINS

subroutine SPHorizontalRR_GPU_LHS_P1A1B0AtoB(nContQP,nPasses,nTUVQ,&
  ...
  real(reals),intent(in) :: AuxCont(nContQP*nPasses,    4,nTUVQ)
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(inout) :: ThetaP(nContQP*nPasses,    2:    4,1,nTUVQ)
...
!$ACC         AuxCont,ThetaP) ASYNC(iASync)
  ...
  ENDDO
   ENDDO
end subroutine SPHorizontalRR_GPU_LHS_P1A1B0AtoB

subroutine SPHorizontalRR_GPU_LHS_P2A1B1AtoB(nContQP,nPasses,nTUVQ,&
         & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,AuxCont,ThetaP,lupri,iASync)
  implicit none
  integer,intent(in) :: nContQP,nPasses,nTUVQ,lupri,MaxPasses,nAtomsA,nAtomsB
  real(reals),intent(in) :: Pdistance12(3,nAtomsA,nAtomsB)
  real(reals),intent(in) :: AuxCont(nContQP*nPasses,   10,nTUVQ)
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(inout) :: ThetaP(nContQP*nPasses,    2:    4,    2:    4,nTUVQ)
  integer(kind=acckind),intent(in) :: iASync
  !Local variables
  integer :: iPassP,iP,iTUVQ,iTUVA,iAtomA,iAtomB
...
!$ACC         iAtomApass,iAtomBpass,Pdistance12,AuxCont,ThetaP) ASYNC(iASync)
  ...
  ENDDO
   ENDDO
end subroutine SPHorizontalRR_GPU_LHS_P2A1B1AtoB

subroutine SPHorizontalRR_GPU_LHS_P2A2B0AtoB(nContQP,nPasses,nTUVQ,&
         & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,AuxCont,ThetaP,lupri,iASync)
  implicit none
  integer,intent(in) :: nContQP,nPasses,nTUVQ,lupri,MaxPasses,nAtomsA,nAtomsB
  real(reals),intent(in) :: Pdistance12(3,nAtomsA,nAtomsB)
  real(reals),intent(in) :: AuxCont(nContQP*nPasses,   10,nTUVQ)
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(inout) :: ThetaP(nContQP*nPasses,    5:   10,1,nTUVQ)
  integer(kind=acckind),intent(in) :: iASync
  !Local variables
  integer :: iPassP,iP,iTUVQ,iTUVA,iAtomA,iAtomB
!$ACC PARALLEL LOOP &
...
!$ACC         AuxCont,ThetaP) ASYNC(iASync)
  ...
  ENDDO
   ENDDO
end subroutine SPHorizontalRR_GPU_LHS_P2A2B0AtoB

subroutine SPHorizontalRR_GPU_LHS_P3A2B1AtoB(nContQP,nPasses,nTUVQ,&
         & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,AuxCont,ThetaP,lupri,iASync)
  implicit none
  integer,intent(in) :: nContQP,nPasses,nTUVQ,lupri,MaxPasses,nAtomsA,nAtomsB
  real(reals),intent(in) :: Pdistance12(3,nAtomsA,nAtomsB)
  real(reals),intent(in) :: AuxCont(nContQP*nPasses,   20,nTUVQ)
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(inout) :: ThetaP(nContQP*nPasses,    5:   10,    2:    4,nTUVQ)
  integer(kind=acckind),intent(in) :: iASync
  !Local variables
  integer :: iPassP,iP,iTUVQ,iTUVA,iAtomA,iAtomB
  real(reals) :: Xab,Yab,Zab
...
!$ACC         iAtomApass,iAtomBpass,Pdistance12,AuxCont,ThetaP) ASYNC(iASync)
  ...
  ENDDO
   ENDDO
end subroutine SPHorizontalRR_GPU_LHS_P3A2B1AtoB

subroutine SPHorizontalRR_GPU_LHS_P4A2B2AtoB(nContQP,nPasses,nTUVQ,&
         & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,AuxCont,ThetaP,lupri,iASync)
  implicit none
  integer,intent(in) :: nContQP,nPasses,nTUVQ,lupri,MaxPasses,nAtomsA,nAtomsB
  real(reals),intent(in) :: Pdistance12(3,nAtomsA,nAtomsB)
  real(reals),intent(in) :: AuxCont(nContQP*nPasses,   35,nTUVQ)
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(inout) :: ThetaP(nContQP*nPasses,    5:   10,    5:   10,nTUVQ)
  integer(kind=acckind),intent(in) :: iASync
  !Local variables
  integer :: iPassP,iP,iTUVQ,iTUVA,iAtomA,iAtomB
  real(reals) :: Xab,Yab,Zab
...
!$ACC         iAtomApass,iAtomBpass,Pdistance12,AuxCont,ThetaP) ASYNC(iASync)
  ...
  ENDDO
   ENDDO
end subroutine SPHorizontalRR_GPU_LHS_P4A2B2AtoB
end module
