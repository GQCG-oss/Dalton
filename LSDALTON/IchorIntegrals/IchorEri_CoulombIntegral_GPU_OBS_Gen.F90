...
!    nlmD = 2*AngmomD+1
    ...
    CASE(2000)  !Angmom(A= 2,B= 0,C= 0,D= 0) combi
        ...
        call SphericalContractOBS1_GPU_maxAngP2_maxAngA2(1,nContQ*nContP*nPasses,TMParray2(1),&
            & LOCALINTS(1),iASync)
        !no need for RHS Horizontal recurrence relations 
        !no Spherical Transformation RHS needed
    ...
    CASE(2022)  !Angmom(A= 2,B= 0,C= 2,D= 2) combi
        ...
        call HorizontalRR_GPU_LHS_P2A2B0AtoB(nContQ,nContP,nPasses,35,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP2_maxAngA2(35,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
    ...
    CASE(2100)  !Angmom(A= 2,B= 1,C= 0,D= 0) combi
        ...
        call HorizontalRR_GPU_LHS_P3A2B1AtoB(nContQ,nContP,nPasses,1,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray1(1),&
            & TMParray2(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP3_maxAngA2(1,nContQ*nContP*nPasses,TMParray2(1),&
            & LOCALINTS(1),iASync)
        !no need for RHS Horizontal recurrence relations 
        !no Spherical Transformation RHS needed
    ...
    CASE(2122)  !Angmom(A= 2,B= 1,C= 2,D= 2) combi
        ...
        call HorizontalRR_GPU_LHS_P3A2B1AtoB(nContQ,nContP,nPasses,35,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP3_maxAngA2(35,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
    ...
    CASE(2200)  !Angmom(A= 2,B= 2,C= 0,D= 0) combi
        ...
        call HorizontalRR_GPU_LHS_P4A2B2AtoB(nContQ,nContP,nPasses,1,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray1(1),&
            & TMParray2(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP4_maxAngA2(1,nContQ*nContP*nPasses,TMParray2(1),&
            & LOCALINTS(1),iASync)
        !no need for RHS Horizontal recurrence relations 
        !no Spherical Transformation RHS needed
    ...
    CASE(2220)  !Angmom(A= 2,B= 2,C= 2,D= 0) combi
        ...
        call HorizontalRR_GPU_RHS_Q2C2D0CtoD(nContQ,nContP,nPasses,25,Qdistance12,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ2_maxAngC2(25,nContQ*nContP*nPasses,TMParray1(1),&
            & LOCALINTS(1),iASync)
    CASE(2221)  !Angmom(A= 2,B= 2,C= 2,D= 1) combi
        ...
        call HorizontalRR_GPU_RHS_Q3C2D1CtoD(nContQ,nContP,nPasses,25,Qdistance12,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ3_maxAngC2(25,nContQ*nContP*nPasses,TMParray1(1),&
            & LOCALINTS(1),iASync)
    CASE(2222)  !Angmom(A= 2,B= 2,C= 2,D= 2) combi
        ...
        call HorizontalRR_GPU_LHS_P4A2B2AtoB(nContQ,nContP,nPasses,35,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP4_maxAngA2(35,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q4C2D2CtoD(nContQ,nContP,nPasses,25,Qdistance12,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ4_maxAngC2(25,nContQ*nContP*nPasses,TMParray1(1),&
            & LOCALINTS(1),iASync)
    CASE DEFAULT
