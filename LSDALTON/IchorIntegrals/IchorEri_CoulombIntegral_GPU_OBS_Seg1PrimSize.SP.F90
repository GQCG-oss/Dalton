module SPIchorEriCoulombintegralGPUOBSGeneralModSeg1PrimSize
...
private   
public :: SPICI_GPU_OBS_general_sizeSeg1Prim  
  
CONTAINS
  subroutine SPICI_GPU_OBS_general_sizeSeg1Prim(TMParray1maxsize,&
    ...
    END SELECT
  end subroutine SPICI_GPU_OBS_general_sizeSeg1Prim
  
END module SPIchorEriCoulombintegralGPUOBSGeneralModSeg1PrimSize
