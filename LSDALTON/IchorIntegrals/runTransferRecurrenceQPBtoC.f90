  ...
  subroutine PASSsub
    ...
    DO JMAX=2,MaxAngmomQP
       DO JP = 1, JMAX
          ...
          WRITE(*,'(A)')'  integer :: iPassQ,iPrimP,iPrimQ,IP,iTUVP,iPrimA,iPrimD'
...
!          WRITE(*,'(A)')'    iPrimB = (iPrimP-1)/nPrimA+1'
          ...
          WRITE(*,'(A)')'     facX = -(expAX+Dexp(iPrimD)*Xcd)*invexpQ'
          WRITE(*,'(A)')'     facY = -(expAY+Dexp(iPrimD)*Ycd)*invexpQ'
          WRITE(*,'(A)')'     facZ = -(expAZ+Dexp(iPrimD)*Zcd)*invexpQ'
