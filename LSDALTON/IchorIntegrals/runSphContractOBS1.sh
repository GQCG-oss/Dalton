...
ifort -g -check all -debug all -openmp -o AutoGenCoderunSphContractOBS1_new.x AutoGenCoderunSphContractOBS1_new.F90 mathfile.o IchorPresicion.o

cp AutoGenCoderunSphContractOBS1_new.F90 AGC_SphContractOBS1.F90
