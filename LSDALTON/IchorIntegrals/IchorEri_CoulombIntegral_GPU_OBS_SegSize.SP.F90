module SPIchorEriCoulombintegralGPUOBSGeneralModSegSize
!Automatic Generated Code (AGC) by runOBSdriver.f90 in tools directory
!Contains routines for Segmented contracted Basisset 
use IchorCommonMod
  
private   
public :: SPICI_GPU_OBS_general_sizeSeg  
  
CONTAINS
  subroutine SPICI_GPU_OBS_general_sizeSeg(TMParray1maxsize,&
    ...
    END SELECT
  end subroutine SPICI_GPU_OBS_general_sizeSeg
  
END module SPIchorEriCoulombintegralGPUOBSGeneralModSegSize
