module SPIchorEriCoulombintegralCPUOBSGeneralModSegSize
...
private   
public :: SPICI_CPU_OBS_general_sizeSeg  
  
CONTAINS
  subroutine SPICI_CPU_OBS_general_sizeSeg(TMParray1maxsize,&
    ...
    CASE DEFAULT
     call SPICI_CPU_McM_general_size(TMParray1maxsize,&
         ...
         & .TRUE.,.TRUE.)
    END SELECT
  end subroutine SPICI_CPU_OBS_general_sizeSeg
  
END module SPIchorEriCoulombintegralCPUOBSGeneralModSegSize
