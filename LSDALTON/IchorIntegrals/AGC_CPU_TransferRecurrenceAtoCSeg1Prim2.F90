MODULE AGC_CPU_OBS_TRMODAtoCSeg1Prim2
...
!$OMP         invexpQ,inv2expQ,facX,facY,facZ,pinvq,iTUVQ,iTUVP,iTUVplus1)
 ...
 ! Building for Angular momentum Jq = 1
     ...
     do ituvpminus1 = 1,20
      ...
      Tmp0(iTUVP,2) = Tmp0(iTUVP,2) + IfacX1_56(ituvpminus1)*inv2expQ*Aux(ituvpminus1,IP) 
     enddo
     do ituvpminus1 = 1,20
      iTUVP = TUVindexX2_84(ituvpminus1)
      Tmp0(iTUVP,3) = Tmp0(iTUVP,3) + IfacX2_56(ituvpminus1)*inv2expQ*Aux(ituvpminus1,IP) 
     enddo
     do ituvpminus1 = 1,20
      iTUVP = TUVindexX3_84(ituvpminus1)
      Tmp0(iTUVP,4) = Tmp0(iTUVP,4) + IfacX3_56(ituvpminus1)*inv2expQ*Aux(ituvpminus1,IP) 
     enddo
     do ituvpminus1 = 21,56
      iTUVP = TUVindexX1_84(ituvpminus1)
      Tmp1(iTUVP,2) = Tmp1(iTUVP,2) + IfacX1_56(ituvpminus1)*inv2expQ*Aux(ituvpminus1,IP) 
     enddo
     do ituvpminus1 = 21,56
      iTUVP = TUVindexX2_84(ituvpminus1)
      Tmp1(iTUVP,3) = Tmp1(iTUVP,3) + IfacX2_56(ituvpminus1)*inv2expQ*Aux(ituvpminus1,IP) 
     enddo
     do ituvpminus1 = 21,56
      iTUVP = TUVindexX3_84(ituvpminus1)
      Tmp1(iTUVP,4) = Tmp1(iTUVP,4) + IfacX3_56(ituvpminus1)*inv2expQ*Aux(ituvpminus1,IP) 
     enddo
     do iTUVP = 1,35
...
!$OMP         invexpQ,inv2expQ,facX,facY,facZ,pinvq,iTUVQ,iTUVP,iTUVplus1)
 ...
 ! Building for Angular momentum Jq = 1
     ...
     do ituvpminus1 = 1,20
      ...
      Tmp0(iTUVP,2) = Tmp0(iTUVP,2) + IfacX1_84(ituvpminus1)*inv2expQ*Aux(ituvpminus1,IP) 
     enddo
     do ituvpminus1 = 1,20
      iTUVP = TUVindexX2_120(ituvpminus1)
      Tmp0(iTUVP,3) = Tmp0(iTUVP,3) + IfacX2_84(ituvpminus1)*inv2expQ*Aux(ituvpminus1,IP) 
     enddo
     do ituvpminus1 = 1,20
      iTUVP = TUVindexX3_120(ituvpminus1)
      Tmp0(iTUVP,4) = Tmp0(iTUVP,4) + IfacX3_84(ituvpminus1)*inv2expQ*Aux(ituvpminus1,IP) 
     enddo
     do ituvpminus1 = 21,84
      iTUVP = TUVindexX1_120(ituvpminus1)
      Tmp1(iTUVP,2) = Tmp1(iTUVP,2) + IfacX1_84(ituvpminus1)*inv2expQ*Aux(ituvpminus1,IP) 
     enddo
     do ituvpminus1 = 21,84
      iTUVP = TUVindexX2_120(ituvpminus1)
      Tmp1(iTUVP,3) = Tmp1(iTUVP,3) + IfacX2_84(ituvpminus1)*inv2expQ*Aux(ituvpminus1,IP) 
     enddo
     do ituvpminus1 = 21,84
      iTUVP = TUVindexX3_120(ituvpminus1)
      Tmp1(iTUVP,4) = Tmp1(iTUVP,4) + IfacX3_84(ituvpminus1)*inv2expQ*Aux(ituvpminus1,IP) 
     enddo
     do iTUVP = 1,35
