...
CONTAINS
  ...
  subroutine IchorCoulombIntegral_OBS_general(nPrimA,nPrimB,nPrimC,nPrimD,&
    ...
    real(realk),intent(in) :: pcent(3*nPrimP)           !pcent(3,nPrimP)
...
!   TMP variables - allocated outside
    ...
    real(realk) :: BasisCont1(BasisCont1maxsize) !nTUVP*nTUVQ*nPrimD*nPrimA*nPrimB
    real(realk) :: BasisCont2(BasisCont1maxsize) !nTUVP*nTUVQ*nPrimA*nPrimB
    real(realk) :: BasisCont3(BasisCont1maxsize) !nTUVP*nTUVQ*nPrimB or nTUVP*nTUVQ*nPrimD
