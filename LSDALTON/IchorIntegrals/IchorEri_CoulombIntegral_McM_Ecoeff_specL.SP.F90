...
!> \author T. Kjaergaard
!> \date 2013 
module SPIchorEriCoulombintegralCPUMcMspecLEcoeffMod
use IchorPrecisionMod
use SPIchorEriCoulombintegralCPUMcMGeneralWTUVMod

CONTAINS
subroutine SPICHOR_Ecoeffn_maxAngP0_maxAngA0_LHS(nPrimP,nPass,Ecoeffn,ETIJ,PreExpFac,&
     & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass)
  implicit none
  integer,intent(in) :: nPrimP,nPass,MaxPasses,nAtomsA,nAtomsB
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(in) :: ETIJ(nprimP,nPass,3),PreExpFac(nPrimP,nAtomsA,nAtomsB)
  real(reals),intent(inout) :: Ecoeffn(nPrimP,nPass,1,  1)
!  
...
!$OMP END MASTER
!$OMP BARRIER 
End subroutine SPICHOR_Ecoeffn_maxAngP0_maxAngA0_LHS
  
subroutine SPICHOR_Ecoeffn_maxAngP1_maxAngA1_LHS(nPrimP,nPass,Ecoeffn,ETIJ,PreExpFac,&
     & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass)
  implicit none
  integer,intent(in) :: nPrimP,nPass,MaxPasses,nAtomsA,nAtomsB
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(in) :: ETIJ(nprimP,nPass,0:1,0:1,0:0,3)
  real(reals),intent(in) :: PreExpFac(nPrimP,nAtomsA,nAtomsB)
  real(reals),intent(inout) :: Ecoeffn(nPrimP,nPass,  4,  3)
!  
  integer :: i,ii,iAtomA,iAtomB
!$OMP MASTER
!!$OMP DO COLLAPSE(2) PRIVATE(I,II)
...
!$OMP END MASTER
!$OMP BARRIER 
End subroutine SPICHOR_Ecoeffn_maxAngP1_maxAngA1_LHS
  
  
subroutine SPICHOR_Ecoeffn_maxAngP1_maxAngA0_LHS(nPrimP,nPass,Ecoeffn,ETIJ,PreExpFac,&
     & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass)
  implicit none
  integer,intent(in) :: nPrimP,nPass,MaxPasses,nAtomsA,nAtomsB
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(in) :: ETIJ(nprimP,nPass,0:1,0:0,0:1,3)
  real(reals),intent(in) :: PreExpFac(nPrimP,nAtomsA,nAtomsB)
  real(reals),intent(inout) :: Ecoeffn(nPrimP,nPass,  4,  3)
!  
  integer :: i,ii,iAtomA,iAtomB
...
!$OMP END MASTER
!$OMP BARRIER 
End subroutine SPICHOR_Ecoeffn_maxAngP1_maxAngA0_LHS
  
  
subroutine SPICHOR_Ecoeffn_maxAngP2_maxAngA2_LHS(nPrimP,nPass,Ecoeffn,ETIJ,PreExpFac,&
     & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass)
  implicit none
  integer,intent(in) :: nPrimP,nPass,MaxPasses,nAtomsA,nAtomsB
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(in) :: ETIJ(nprimP,nPass,0:2,0:2,0:0,3)
  real(reals),intent(in) :: PreExpFac(nPrimP,nAtomsA,nAtomsB)
  real(reals),intent(inout) :: Ecoeffn(nPrimP,nPass, 10,  6)
!  
  integer :: i,ii,iAtomA,iAtomB
!$OMP MASTER
!!$OMP DO COLLAPSE(2) PRIVATE(I,II)
...
!$OMP END MASTER
!$OMP BARRIER 
End subroutine SPICHOR_Ecoeffn_maxAngP2_maxAngA2_LHS
  
  
subroutine SPICHOR_Ecoeffn_maxAngP2_maxAngA1_LHS(nPrimP,nPass,Ecoeffn,ETIJ,PreExpFac,&
     & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass)
  implicit none
  integer,intent(in) :: nPrimP,nPass,MaxPasses,nAtomsA,nAtomsB
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(in) :: ETIJ(nprimP,nPass,0:2,0:1,0:1,3)
  real(reals),intent(in) :: PreExpFac(nPrimP,nAtomsA,nAtomsB)
  real(reals),intent(inout) :: Ecoeffn(nPrimP,nPass, 10,  9)
!  
  integer :: i,ii,iAtomA,iAtomB
!$OMP MASTER
!!$OMP DO COLLAPSE(2) PRIVATE(I,II)
...
!$OMP END MASTER
!$OMP BARRIER 
End subroutine SPICHOR_Ecoeffn_maxAngP2_maxAngA1_LHS

  
subroutine SPICHOR_Ecoeffn_maxAngP2_maxAngA0_LHS(nPrimP,nPass,Ecoeffn,ETIJ,PreExpFac,&
     & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass)
  implicit none
  integer,intent(in) :: nPrimP,nPass,MaxPasses,nAtomsA,nAtomsB
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(in) :: ETIJ(nprimP,nPass,0:2,0:0,0:2,3)
  real(reals),intent(in) :: PreExpFac(nPrimP,nAtomsA,nAtomsB)
  real(reals),intent(inout) :: Ecoeffn(nPrimP,nPass, 10,  6)
!  
  integer :: i,ii,iAtomA,iAtomB
...
!$OMP END MASTER
!$OMP BARRIER 
End subroutine SPICHOR_Ecoeffn_maxAngP2_maxAngA0_LHS
  
  
subroutine SPICHOR_Ecoeffn_maxAngP3_maxAngA3_LHS(nPrimP,nPass,Ecoeffn,ETIJ,PreExpFac,&
     & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass)
  implicit none
  integer,intent(in) :: nPrimP,nPass,MaxPasses,nAtomsA,nAtomsB
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(in) :: ETIJ(nprimP,nPass,0:3,0:3,0:0,3)
  real(reals),intent(in) :: PreExpFac(nPrimP,nAtomsA,nAtomsB)
  real(reals),intent(inout) :: Ecoeffn(nPrimP,nPass, 20, 10)
!  
  integer :: i,ii,iAtomA,iAtomB
!$OMP MASTER
!!$OMP DO COLLAPSE(2) PRIVATE(I,II)
...
!$OMP END MASTER
!$OMP BARRIER 
End subroutine SPICHOR_Ecoeffn_maxAngP3_maxAngA3_LHS
  
  
subroutine SPICHOR_Ecoeffn_maxAngP3_maxAngA2_LHS(nPrimP,nPass,Ecoeffn,ETIJ,PreExpFac,&
     & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass)
  implicit none
  integer,intent(in) :: nPrimP,nPass,MaxPasses,nAtomsA,nAtomsB
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(in) :: ETIJ(nprimP,nPass,0:3,0:2,0:1,3)
  real(reals),intent(in) :: PreExpFac(nPrimP,nAtomsA,nAtomsB)
  real(reals),intent(inout) :: Ecoeffn(nPrimP,nPass, 20, 18)
!  
  integer :: i,ii,iAtomA,iAtomB
!$OMP MASTER
!!$OMP DO COLLAPSE(2) PRIVATE(I,II)
...
!$OMP END MASTER
!$OMP BARRIER 
End subroutine SPICHOR_Ecoeffn_maxAngP3_maxAngA2_LHS
  
  
subroutine SPICHOR_Ecoeffn_maxAngP3_maxAngA1_LHS(nPrimP,nPass,Ecoeffn,ETIJ,PreExpFac,&
     & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass)
  implicit none
  integer,intent(in) :: nPrimP,nPass,MaxPasses,nAtomsA,nAtomsB
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(in) :: ETIJ(nprimP,nPass,0:3,0:1,0:2,3)
  real(reals),intent(in) :: PreExpFac(nPrimP,nAtomsA,nAtomsB)
  real(reals),intent(inout) :: Ecoeffn(nPrimP,nPass, 20, 18)
!  
  integer :: i,ii,iAtomA,iAtomB
...
!$OMP END MASTER
!$OMP BARRIER 
End subroutine SPICHOR_Ecoeffn_maxAngP3_maxAngA1_LHS
  
  
subroutine SPICHOR_Ecoeffn_maxAngP3_maxAngA0_LHS(nPrimP,nPass,Ecoeffn,ETIJ,PreExpFac,&
     & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass)
  implicit none
  integer,intent(in) :: nPrimP,nPass,MaxPasses,nAtomsA,nAtomsB
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(in) :: ETIJ(nprimP,nPass,0:3,0:0,0:3,3)
  real(reals),intent(in) :: PreExpFac(nPrimP,nAtomsA,nAtomsB)
  real(reals),intent(inout) :: Ecoeffn(nPrimP,nPass, 20, 10)
!  
  integer :: i,ii,iAtomA,iAtomB
...
!$OMP END MASTER
!$OMP BARRIER 
End subroutine SPICHOR_Ecoeffn_maxAngP3_maxAngA0_LHS
  
subroutine SPICHOR_Ecoeffn_general_LHS(nPrimP,nPass,nTUV,ijk,JMAX,l1,l2,EcoeffN,ETIJ,PreExpFac,&
     & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass)
  implicit none
  integer,intent(in) :: nPrimP,nPass,nTUV,ijk,JMAX,MaxPasses,nAtomsA,nAtomsB
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(in) :: ETIJ(nPrimP,nPass,0:JMAX,0:l1,0:l2,3)
  real(reals),intent(in) :: PreExpFac(nPrimP,nAtomsA,nAtomsB)
  real(reals),intent(inout) :: EcoeffN(nPrimP,nPass,nTUV,ijk)
  !
...
!$OMP END MASTER
!$OMP BARRIER 
end subroutine SPICHOR_Ecoeffn_general_LHS

end module SPIchorEriCoulombintegralCPUMcMspecLEcoeffMod
