module SPAGC_GPU_OBS_VERTICALRECURRENCEMODBSegP
 use IchorPrecisionMod
  
 CONTAINS


subroutine SPVerticalRecurrenceGPUSegP1B(nPassP,nPrimP,nPrimQ,&
...
end subroutine SPVerticalRecurrenceGPUSegP1B

subroutine SPVerticalRecurrenceGPUSegP2B(nPassP,nPrimP,nPrimQ,&
...
subroutine SPVerticalRecurrenceGPUSegP3B(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Pexp,Bcenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray,iASync)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
