module SPAGC_CPU_OBS_VERTICALRECURRENCEMODDSegQ
 use IchorPrecisionMod
  
 CONTAINS


subroutine SPVerticalRecurrenceCPUSegQ1D(nPassP,nPrimP,nPrimQ,&
...
!$OMP END DO
end subroutine SPVerticalRecurrenceCPUSegQ1D

subroutine SPVerticalRecurrenceCPUSegQ2D(nPassP,nPrimP,nPrimQ,&
...
subroutine SPVerticalRecurrenceCPUSegQ3D(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Dcenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
