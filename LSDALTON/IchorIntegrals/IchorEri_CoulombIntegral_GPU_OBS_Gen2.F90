MODULE IchorEriCoulombintegralGPUOBSGeneralModGen2
...
private   
public :: ICI_GPU_OBS_Gen2
  
CONTAINS
  
  
  subroutine ICI_GPU_OBS_Gen2(nPrimA,nPrimB,nPrimC,nPrimD,&
...
!    nlmD = 2*AngmomD+1
    ...
    CASE(   1)  !Angmom(A= 0,B= 0,C= 0,D= 1) combi
        ...
        call HorizontalRR_GPU_RHS_Q1C0D1DtoC(nContQ,nContP,nPasses,1,Qdistance12,TMParray2(1),&
    ...
    CASE(   2)  !Angmom(A= 0,B= 0,C= 0,D= 2) combi
        ...
        !no need for LHS Horizontal recurrence relations, it would be a simply copy
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q2C0D2DtoC(nContQ,nContP,nPasses,1,Qdistance12,TMParray1(1),&
            & TMParray2(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ2_maxAngC0(1,nContQ*nContP*nPasses,TMParray2(1),&
            & LOCALINTS(1),iASync)
    CASE(  10)  !Angmom(A= 0,B= 0,C= 1,D= 0) combi
        ...
        !no need for LHS Horizontal recurrence relations, it would be a simply copy
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q1C1D0CtoD(nContQ,nContP,nPasses,1,Qdistance12,TMParray2(1),&
            & LOCALINTS(1),lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(  11)  !Angmom(A= 0,B= 0,C= 1,D= 1) combi
        ...
        !no need for LHS Horizontal recurrence relations, it would be a simply copy
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q2C1D1CtoD(nContQ,nContP,nPasses,1,Qdistance12,TMParray1(1),&
            & LOCALINTS(1),lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(  12)  !Angmom(A= 0,B= 0,C= 1,D= 2) combi
        ...
        !no need for LHS Horizontal recurrence relations, it would be a simply copy
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q3C1D2DtoC(nContQ,nContP,nPasses,1,Qdistance12,TMParray1(1),&
            & TMParray2(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ3_maxAngC1(1,nContQ*nContP*nPasses,TMParray2(1),&
            & LOCALINTS(1),iASync)
    CASE(  20)  !Angmom(A= 0,B= 0,C= 2,D= 0) combi
        ...
        !no need for LHS Horizontal recurrence relations, it would be a simply copy
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q2C2D0CtoD(nContQ,nContP,nPasses,1,Qdistance12,TMParray1(1),&
            & TMParray2(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ2_maxAngC2(1,nContQ*nContP*nPasses,TMParray2(1),&
            & LOCALINTS(1),iASync)
    CASE(  21)  !Angmom(A= 0,B= 0,C= 2,D= 1) combi
        ...
        !no need for LHS Horizontal recurrence relations, it would be a simply copy
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q3C2D1CtoD(nContQ,nContP,nPasses,1,Qdistance12,TMParray1(1),&
            & TMParray2(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ3_maxAngC2(1,nContQ*nContP*nPasses,TMParray2(1),&
            & LOCALINTS(1),iASync)
    CASE(  22)  !Angmom(A= 0,B= 0,C= 2,D= 2) combi
        ...
        !no need for LHS Horizontal recurrence relations, it would be a simply copy
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q4C2D2CtoD(nContQ,nContP,nPasses,1,Qdistance12,TMParray1(1),&
            & TMParray2(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ4_maxAngC2(1,nContQ*nContP*nPasses,TMParray2(1),&
            & LOCALINTS(1),iASync)
    CASE( 100)  !Angmom(A= 0,B= 1,C= 0,D= 0) combi
        ...
        !No reason for the Electron Transfer Recurrence Relation 
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,4,1,iASync)
        call HorizontalRR_GPU_LHS_P1A0B1BtoA(nContQ,nContP,nPasses,1,&
    ...
    CASE( 101)  !Angmom(A= 0,B= 1,C= 0,D= 1) combi
        ...
        call TransferRecurrenceGPUP1Q1BtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,4,4,iASync)
        call HorizontalRR_GPU_LHS_P1A0B1BtoA(nContQ,nContP,nPasses,4,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q1C0D1DtoC(nContQ,nContP,nPasses,3,Qdistance12,TMParray1(1),&
            & LOCALINTS(1),lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE( 102)  !Angmom(A= 0,B= 1,C= 0,D= 2) combi
        ...
        call TransferRecurrenceGPUP1Q2DtoBGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,4,10,iASync)
        call HorizontalRR_GPU_LHS_P1A0B1BtoA(nContQ,nContP,nPasses,10,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q2C0D2DtoC(nContQ,nContP,nPasses,3,Qdistance12,TMParray1(1),&
            & TMParray2(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ2_maxAngC0(3,nContQ*nContP*nPasses,TMParray2(1),&
            & LOCALINTS(1),iASync)
    CASE( 110)  !Angmom(A= 0,B= 1,C= 1,D= 0) combi
        ...
        call HorizontalRR_GPU_LHS_P1A0B1BtoA(nContQ,nContP,nPasses,4,&
            ...
            & TMParray1(1),lupri,iASync)
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q1C1D0CtoD(nContQ,nContP,nPasses,3,Qdistance12,TMParray1(1),&
            & LOCALINTS(1),lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE( 111)  !Angmom(A= 0,B= 1,C= 1,D= 1) combi
        ...
        call HorizontalRR_GPU_LHS_P1A0B1BtoA(nContQ,nContP,nPasses,10,&
            ...
            & TMParray1(1),lupri,iASync)
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q2C1D1CtoD(nContQ,nContP,nPasses,3,Qdistance12,TMParray1(1),&
            & LOCALINTS(1),lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE( 112)  !Angmom(A= 0,B= 1,C= 1,D= 2) combi
        ...
        call TransferRecurrenceGPUP1Q3DtoBGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,4,20,iASync)
        call HorizontalRR_GPU_LHS_P1A0B1BtoA(nContQ,nContP,nPasses,20,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q3C1D2DtoC(nContQ,nContP,nPasses,3,Qdistance12,TMParray1(1),&
            & TMParray2(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ3_maxAngC1(3,nContQ*nContP*nPasses,TMParray2(1),&
            & LOCALINTS(1),iASync)
    CASE( 120)  !Angmom(A= 0,B= 1,C= 2,D= 0) combi
        ...
        call HorizontalRR_GPU_LHS_P1A0B1BtoA(nContQ,nContP,nPasses,10,&
            ...
            & TMParray1(1),lupri,iASync)
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q2C2D0CtoD(nContQ,nContP,nPasses,3,Qdistance12,TMParray1(1),&
            & TMParray2(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ2_maxAngC2(3,nContQ*nContP*nPasses,TMParray2(1),&
            & LOCALINTS(1),iASync)
    CASE( 121)  !Angmom(A= 0,B= 1,C= 2,D= 1) combi
        ...
        call HorizontalRR_GPU_LHS_P1A0B1BtoA(nContQ,nContP,nPasses,20,&
            ...
            & TMParray1(1),lupri,iASync)
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q3C2D1CtoD(nContQ,nContP,nPasses,3,Qdistance12,TMParray1(1),&
            & TMParray2(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ3_maxAngC2(3,nContQ*nContP*nPasses,TMParray2(1),&
            & LOCALINTS(1),iASync)
    CASE( 122)  !Angmom(A= 0,B= 1,C= 2,D= 2) combi
        ...
        call TransferRecurrenceGPUP1Q4CtoBGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,4,35,iASync)
        call HorizontalRR_GPU_LHS_P1A0B1BtoA(nContQ,nContP,nPasses,35,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q4C2D2CtoD(nContQ,nContP,nPasses,3,Qdistance12,TMParray1(1),&
            & TMParray2(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ4_maxAngC2(3,nContQ*nContP*nPasses,TMParray2(1),&
            & LOCALINTS(1),iASync)
    CASE( 200)  !Angmom(A= 0,B= 2,C= 0,D= 0) combi
        ...
        !No reason for the Electron Transfer Recurrence Relation 
         ...
         call PrimitiveContractionBGPUGen(TMParray2,TMParray1,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,10,1,iASync)
        call HorizontalRR_GPU_LHS_P2A0B2BtoA(nContQ,nContP,nPasses,1,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray1(1),&
            & TMParray2(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP2_maxAngA0(1,nContQ*nContP*nPasses,TMParray2(1),&
            & LOCALINTS(1),iASync)
        !no need for RHS Horizontal recurrence relations 
        !no Spherical Transformation RHS needed
    CASE( 201)  !Angmom(A= 0,B= 2,C= 0,D= 1) combi
        ...
        call TransferRecurrenceGPUP2Q1BtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,10,4,iASync)
        call HorizontalRR_GPU_LHS_P2A0B2BtoA(nContQ,nContP,nPasses,4,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP2_maxAngA0(4,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q1C0D1DtoC(nContQ,nContP,nPasses,5,Qdistance12,TMParray2(1),&
            & LOCALINTS(1),lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE( 202)  !Angmom(A= 0,B= 2,C= 0,D= 2) combi
        ...
        call TransferRecurrenceGPUP2Q2BtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,10,10,iASync)
        call HorizontalRR_GPU_LHS_P2A0B2BtoA(nContQ,nContP,nPasses,10,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP2_maxAngA0(10,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q2C0D2DtoC(nContQ,nContP,nPasses,5,Qdistance12,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ2_maxAngC0(5,nContQ*nContP*nPasses,TMParray1(1),&
            & LOCALINTS(1),iASync)
    CASE( 210)  !Angmom(A= 0,B= 2,C= 1,D= 0) combi
        ...
        call SphericalContractOBS1_GPU_maxAngP2_maxAngA0(4,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q1C1D0CtoD(nContQ,nContP,nPasses,5,Qdistance12,TMParray2(1),&
            & LOCALINTS(1),lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE( 211)  !Angmom(A= 0,B= 2,C= 1,D= 1) combi
        ...
        call SphericalContractOBS1_GPU_maxAngP2_maxAngA0(10,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q2C1D1CtoD(nContQ,nContP,nPasses,5,Qdistance12,TMParray2(1),&
            & LOCALINTS(1),lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE( 212)  !Angmom(A= 0,B= 2,C= 1,D= 2) combi
        ...
        call TransferRecurrenceGPUP2Q3DtoBGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,10,20,iASync)
        call HorizontalRR_GPU_LHS_P2A0B2BtoA(nContQ,nContP,nPasses,20,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP2_maxAngA0(20,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q3C1D2DtoC(nContQ,nContP,nPasses,5,Qdistance12,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ3_maxAngC1(5,nContQ*nContP*nPasses,TMParray1(1),&
            & LOCALINTS(1),iASync)
    CASE( 220)  !Angmom(A= 0,B= 2,C= 2,D= 0) combi
        ...
        call SphericalContractOBS1_GPU_maxAngP2_maxAngA0(10,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q2C2D0CtoD(nContQ,nContP,nPasses,5,Qdistance12,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ2_maxAngC2(5,nContQ*nContP*nPasses,TMParray1(1),&
            & LOCALINTS(1),iASync)
    CASE( 221)  !Angmom(A= 0,B= 2,C= 2,D= 1) combi
        ...
        call SphericalContractOBS1_GPU_maxAngP2_maxAngA0(20,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q3C2D1CtoD(nContQ,nContP,nPasses,5,Qdistance12,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ3_maxAngC2(5,nContQ*nContP*nPasses,TMParray1(1),&
            & LOCALINTS(1),iASync)
    CASE( 222)  !Angmom(A= 0,B= 2,C= 2,D= 2) combi
        ...
        call TransferRecurrenceGPUP2Q4CtoBGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,10,35,iASync)
        call HorizontalRR_GPU_LHS_P2A0B2BtoA(nContQ,nContP,nPasses,35,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP2_maxAngA0(35,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q4C2D2CtoD(nContQ,nContP,nPasses,5,Qdistance12,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ4_maxAngC2(5,nContQ*nContP*nPasses,TMParray1(1),&
            & LOCALINTS(1),iASync)
    CASE(1001)  !Angmom(A= 1,B= 0,C= 0,D= 1) combi
        ...
        call TransferRecurrenceGPUP1Q1AtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,4,4,iASync)
        call HorizontalRR_GPU_LHS_P1A1B0AtoB(nContQ,nContP,nPasses,4,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q1C0D1DtoC(nContQ,nContP,nPasses,3,Qdistance12,TMParray1(1),&
    ...
    CASE(1002)  !Angmom(A= 1,B= 0,C= 0,D= 2) combi
        ...
        call TransferRecurrenceGPUP1Q2DtoAGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,4,10,iASync)
        call HorizontalRR_GPU_LHS_P1A1B0AtoB(nContQ,nContP,nPasses,10,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q2C0D2DtoC(nContQ,nContP,nPasses,3,Qdistance12,TMParray1(1),&
    ...
    CASE(1012)  !Angmom(A= 1,B= 0,C= 1,D= 2) combi
        ...
        call TransferRecurrenceGPUP1Q3DtoAGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,4,20,iASync)
        call HorizontalRR_GPU_LHS_P1A1B0AtoB(nContQ,nContP,nPasses,20,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q3C1D2DtoC(nContQ,nContP,nPasses,3,Qdistance12,TMParray1(1),&
    ...
    CASE(1022)  !Angmom(A= 1,B= 0,C= 2,D= 2) combi
        ...
        call TransferRecurrenceGPUP1Q4CtoAGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,4,35,iASync)
        call HorizontalRR_GPU_LHS_P1A1B0AtoB(nContQ,nContP,nPasses,35,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q4C2D2CtoD(nContQ,nContP,nPasses,3,Qdistance12,TMParray1(1),&
    ...
    CASE(1101)  !Angmom(A= 1,B= 1,C= 0,D= 1) combi
        ...
        call TransferRecurrenceGPUP2Q1AtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,10,4,iASync)
        call HorizontalRR_GPU_LHS_P2A1B1AtoB(nContQ,nContP,nPasses,4,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q1C0D1DtoC(nContQ,nContP,nPasses,9,Qdistance12,TMParray1(1),&
            & LOCALINTS(1),lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(1102)  !Angmom(A= 1,B= 1,C= 0,D= 2) combi
        ...
        call TransferRecurrenceGPUP2Q2AtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,10,10,iASync)
        call HorizontalRR_GPU_LHS_P2A1B1AtoB(nContQ,nContP,nPasses,10,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q2C0D2DtoC(nContQ,nContP,nPasses,9,Qdistance12,TMParray1(1),&
            & TMParray2(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ2_maxAngC0(9,nContQ*nContP*nPasses,TMParray2(1),&
            & LOCALINTS(1),iASync)
    CASE(1112)  !Angmom(A= 1,B= 1,C= 1,D= 2) combi
        ...
        call TransferRecurrenceGPUP2Q3DtoAGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,10,20,iASync)
        call HorizontalRR_GPU_LHS_P2A1B1AtoB(nContQ,nContP,nPasses,20,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q3C1D2DtoC(nContQ,nContP,nPasses,9,Qdistance12,TMParray1(1),&
            & TMParray2(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ3_maxAngC1(9,nContQ*nContP*nPasses,TMParray2(1),&
            & LOCALINTS(1),iASync)
    CASE(1120)  !Angmom(A= 1,B= 1,C= 2,D= 0) combi
        ...
        call HorizontalRR_GPU_LHS_P2A1B1AtoB(nContQ,nContP,nPasses,10,&
            ...
            & TMParray1(1),lupri,iASync)
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q2C2D0CtoD(nContQ,nContP,nPasses,9,Qdistance12,TMParray1(1),&
            & TMParray2(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ2_maxAngC2(9,nContQ*nContP*nPasses,TMParray2(1),&
            & LOCALINTS(1),iASync)
    CASE(1121)  !Angmom(A= 1,B= 1,C= 2,D= 1) combi
        ...
        call HorizontalRR_GPU_LHS_P2A1B1AtoB(nContQ,nContP,nPasses,20,&
            ...
            & TMParray1(1),lupri,iASync)
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q3C2D1CtoD(nContQ,nContP,nPasses,9,Qdistance12,TMParray1(1),&
            & TMParray2(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ3_maxAngC2(9,nContQ*nContP*nPasses,TMParray2(1),&
            & LOCALINTS(1),iASync)
    CASE(1122)  !Angmom(A= 1,B= 1,C= 2,D= 2) combi
        ...
        call TransferRecurrenceGPUP2Q4CtoAGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,10,35,iASync)
        call HorizontalRR_GPU_LHS_P2A1B1AtoB(nContQ,nContP,nPasses,35,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q4C2D2CtoD(nContQ,nContP,nPasses,9,Qdistance12,TMParray1(1),&
            & TMParray2(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ4_maxAngC2(9,nContQ*nContP*nPasses,TMParray2(1),&
            & LOCALINTS(1),iASync)
    CASE(1200)  !Angmom(A= 1,B= 2,C= 0,D= 0) combi
        ...
        !No reason for the Electron Transfer Recurrence Relation 
         ...
         call PrimitiveContractionBGPUGen(TMParray2,TMParray1,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,20,1,iASync)
        call HorizontalRR_GPU_LHS_P3A1B2BtoA(nContQ,nContP,nPasses,1,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray1(1),&
            & TMParray2(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP3_maxAngA1(1,nContQ*nContP*nPasses,TMParray2(1),&
            & LOCALINTS(1),iASync)
        !no need for RHS Horizontal recurrence relations 
        !no Spherical Transformation RHS needed
    CASE(1201)  !Angmom(A= 1,B= 2,C= 0,D= 1) combi
        ...
        call TransferRecurrenceGPUP3Q1BtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,20,4,iASync)
        call HorizontalRR_GPU_LHS_P3A1B2BtoA(nContQ,nContP,nPasses,4,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP3_maxAngA1(4,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q1C0D1DtoC(nContQ,nContP,nPasses,15,Qdistance12,TMParray2(1),&
            & LOCALINTS(1),lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(1202)  !Angmom(A= 1,B= 2,C= 0,D= 2) combi
        ...
        call TransferRecurrenceGPUP3Q2BtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,20,10,iASync)
        call HorizontalRR_GPU_LHS_P3A1B2BtoA(nContQ,nContP,nPasses,10,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP3_maxAngA1(10,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q2C0D2DtoC(nContQ,nContP,nPasses,15,Qdistance12,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ2_maxAngC0(15,nContQ*nContP*nPasses,TMParray1(1),&
            & LOCALINTS(1),iASync)
    CASE(1210)  !Angmom(A= 1,B= 2,C= 1,D= 0) combi
        ...
        call SphericalContractOBS1_GPU_maxAngP3_maxAngA1(4,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q1C1D0CtoD(nContQ,nContP,nPasses,15,Qdistance12,TMParray2(1),&
            & LOCALINTS(1),lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(1211)  !Angmom(A= 1,B= 2,C= 1,D= 1) combi
        ...
        call SphericalContractOBS1_GPU_maxAngP3_maxAngA1(10,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q2C1D1CtoD(nContQ,nContP,nPasses,15,Qdistance12,TMParray2(1),&
            & LOCALINTS(1),lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(1212)  !Angmom(A= 1,B= 2,C= 1,D= 2) combi
        ...
        call TransferRecurrenceGPUP3Q3BtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,20,20,iASync)
        call HorizontalRR_GPU_LHS_P3A1B2BtoA(nContQ,nContP,nPasses,20,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP3_maxAngA1(20,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q3C1D2DtoC(nContQ,nContP,nPasses,15,Qdistance12,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ3_maxAngC1(15,nContQ*nContP*nPasses,TMParray1(1),&
            & LOCALINTS(1),iASync)
    CASE(1220)  !Angmom(A= 1,B= 2,C= 2,D= 0) combi
        ...
        call SphericalContractOBS1_GPU_maxAngP3_maxAngA1(10,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q2C2D0CtoD(nContQ,nContP,nPasses,15,Qdistance12,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ2_maxAngC2(15,nContQ*nContP*nPasses,TMParray1(1),&
            & LOCALINTS(1),iASync)
    CASE(1221)  !Angmom(A= 1,B= 2,C= 2,D= 1) combi
        ...
        call SphericalContractOBS1_GPU_maxAngP3_maxAngA1(20,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q3C2D1CtoD(nContQ,nContP,nPasses,15,Qdistance12,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ3_maxAngC2(15,nContQ*nContP*nPasses,TMParray1(1),&
            & LOCALINTS(1),iASync)
    CASE(1222)  !Angmom(A= 1,B= 2,C= 2,D= 2) combi
        ...
        call TransferRecurrenceGPUP3Q4CtoBGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,20,35,iASync)
        call HorizontalRR_GPU_LHS_P3A1B2BtoA(nContQ,nContP,nPasses,35,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP3_maxAngA1(35,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q4C2D2CtoD(nContQ,nContP,nPasses,15,Qdistance12,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ4_maxAngC2(15,nContQ*nContP*nPasses,TMParray1(1),&
            & LOCALINTS(1),iASync)
    CASE(2001)  !Angmom(A= 2,B= 0,C= 0,D= 1) combi
        ...
        call TransferRecurrenceGPUP2Q1AtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,10,4,iASync)
        call HorizontalRR_GPU_LHS_P2A2B0AtoB(nContQ,nContP,nPasses,4,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP2_maxAngA2(4,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q1C0D1DtoC(nContQ,nContP,nPasses,5,Qdistance12,TMParray2(1),&
            & LOCALINTS(1),lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(2002)  !Angmom(A= 2,B= 0,C= 0,D= 2) combi
        ...
        call TransferRecurrenceGPUP2Q2AtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,10,10,iASync)
        call HorizontalRR_GPU_LHS_P2A2B0AtoB(nContQ,nContP,nPasses,10,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP2_maxAngA2(10,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q2C0D2DtoC(nContQ,nContP,nPasses,5,Qdistance12,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ2_maxAngC0(5,nContQ*nContP*nPasses,TMParray1(1),&
    ...
    CASE(2012)  !Angmom(A= 2,B= 0,C= 1,D= 2) combi
        ...
        call TransferRecurrenceGPUP2Q3DtoAGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,10,20,iASync)
        call HorizontalRR_GPU_LHS_P2A2B0AtoB(nContQ,nContP,nPasses,20,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP2_maxAngA2(20,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q3C1D2DtoC(nContQ,nContP,nPasses,5,Qdistance12,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ3_maxAngC1(5,nContQ*nContP*nPasses,TMParray1(1),&
    ...
    CASE(2101)  !Angmom(A= 2,B= 1,C= 0,D= 1) combi
        ...
        call TransferRecurrenceGPUP3Q1AtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,20,4,iASync)
        call HorizontalRR_GPU_LHS_P3A2B1AtoB(nContQ,nContP,nPasses,4,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP3_maxAngA2(4,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q1C0D1DtoC(nContQ,nContP,nPasses,15,Qdistance12,TMParray2(1),&
            & LOCALINTS(1),lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(2102)  !Angmom(A= 2,B= 1,C= 0,D= 2) combi
        ...
        call TransferRecurrenceGPUP3Q2AtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,20,10,iASync)
        call HorizontalRR_GPU_LHS_P3A2B1AtoB(nContQ,nContP,nPasses,10,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP3_maxAngA2(10,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q2C0D2DtoC(nContQ,nContP,nPasses,15,Qdistance12,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ2_maxAngC0(15,nContQ*nContP*nPasses,TMParray1(1),&
    ...
    CASE(2112)  !Angmom(A= 2,B= 1,C= 1,D= 2) combi
        ...
        call TransferRecurrenceGPUP3Q3AtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,20,20,iASync)
        call HorizontalRR_GPU_LHS_P3A2B1AtoB(nContQ,nContP,nPasses,20,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP3_maxAngA2(20,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q3C1D2DtoC(nContQ,nContP,nPasses,15,Qdistance12,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ3_maxAngC1(15,nContQ*nContP*nPasses,TMParray1(1),&
    ...
    CASE(2201)  !Angmom(A= 2,B= 2,C= 0,D= 1) combi
        ...
        call TransferRecurrenceGPUP4Q1AtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,35,4,iASync)
        call HorizontalRR_GPU_LHS_P4A2B2AtoB(nContQ,nContP,nPasses,4,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP4_maxAngA2(4,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q1C0D1DtoC(nContQ,nContP,nPasses,25,Qdistance12,TMParray2(1),&
            & LOCALINTS(1),lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(2202)  !Angmom(A= 2,B= 2,C= 0,D= 2) combi
        ...
        call TransferRecurrenceGPUP4Q2AtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,35,10,iASync)
        call HorizontalRR_GPU_LHS_P4A2B2AtoB(nContQ,nContP,nPasses,10,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP4_maxAngA2(10,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q2C0D2DtoC(nContQ,nContP,nPasses,25,Qdistance12,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ2_maxAngC0(25,nContQ*nContP*nPasses,TMParray1(1),&
            & LOCALINTS(1),iASync)
    CASE(2212)  !Angmom(A= 2,B= 2,C= 1,D= 2) combi
        ...
        call TransferRecurrenceGPUP4Q3AtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         ...
         call PrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,35,20,iASync)
        call HorizontalRR_GPU_LHS_P4A2B2AtoB(nContQ,nContP,nPasses,20,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS1_GPU_maxAngP4_maxAngA2(20,nContQ*nContP*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q3C1D2DtoC(nContQ,nContP,nPasses,25,Qdistance12,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
        call SphericalContractOBS2_GPU_maxAngQ3_maxAngC1(25,nContQ*nContP*nPasses,TMParray1(1),&
            & LOCALINTS(1),iASync)
    CASE DEFAULT
#ifdef VAR_OPENACC
    ...
    END SELECT
  end subroutine ICI_GPU_OBS_Gen2
  
END MODULE IchorEriCoulombintegralGPUOBSGeneralModGen2
