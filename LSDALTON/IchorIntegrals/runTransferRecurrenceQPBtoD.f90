  ...
  subroutine PASSsub
    ...
    DO JMAX=2,MaxAngmomQP
       DO JP = 1, JMAX
          ...
          WRITE(*,'(A)')'  integer :: iPassQ,iPrimP,iPrimQ,IP,iTUVP,iPrimA,iPrimC'
...
!          WRITE(*,'(A)')'     iPrimD = (iPrimQ-1)/nPrimC+1'
          ...
          WRITE(*,'(A)')'     facX = -(expAX-Cexp(iPrimC)*Xcd)*invexpQ'
          WRITE(*,'(A)')'     facY = -(expAY-Cexp(iPrimC)*Ycd)*invexpQ'
          WRITE(*,'(A)')'     facZ = -(expAZ-Cexp(iPrimC)*Zcd)*invexpQ'
