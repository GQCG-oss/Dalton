...
!    nlmD = 2*AngmomD+1
    ...
    CASE(1010)  !Angmom(A= 1,B= 0,C= 1,D= 0) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q1C1D0CtoD(nContP,nPasses,3,Qdistance12,TMParray1(1:nContP*nPasses*12),&
    ...
    CASE(1011)  !Angmom(A= 1,B= 0,C= 1,D= 1) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q2C1D1CtoD(nContP,nPasses,3,Qdistance12,TMParray1(1:nContP*nPasses*30),&
    ...
    CASE(1110)  !Angmom(A= 1,B= 1,C= 1,D= 0) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q1C1D0CtoD(nContP,nPasses,9,Qdistance12,TMParray1(1:nContP*nPasses*36),&
            & LOCALINTS(1:nContP*nPasses*27),lupri)
        !no Spherical Transformation RHS needed
    CASE(1111)  !Angmom(A= 1,B= 1,C= 1,D= 1) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q2C1D1CtoD(nContP,nPasses,9,Qdistance12,TMParray1(1:nContP*nPasses*90),&
    ...
    CASE(2000)  !Angmom(A= 2,B= 0,C= 0,D= 0) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP2_maxAngA2(1,nContP*nPasses,TMParray2(1:nContP*nPasses*6),&
    ...
    CASE(2010)  !Angmom(A= 2,B= 0,C= 1,D= 0) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP2_maxAngA2(4,nContP*nPasses,TMParray1(1:nContP*nPasses*24),&
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q1C1D0CtoD(nContP,nPasses,5,Qdistance12,TMParray2(1:nContP*nPasses*20),&
    ...
    CASE(2011)  !Angmom(A= 2,B= 0,C= 1,D= 1) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP2_maxAngA2(10,nContP*nPasses,TMParray1(1:nContP*nPasses*60),&
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q2C1D1CtoD(nContP,nPasses,5,Qdistance12,TMParray2(1:nContP*nPasses*50),&
    ...
    CASE(2020)  !Angmom(A= 2,B= 0,C= 2,D= 0) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q2C2D0CtoD(nContP,nPasses,5,Qdistance12,TMParray2(1:nContP*nPasses*50),&
        ...
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ2_maxAngC2(5,nContP*nPasses,TMParray1(1:nContP*nPasses*30),&
    ...
    CASE(2021)  !Angmom(A= 2,B= 0,C= 2,D= 1) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP2_maxAngA2(20,nContP*nPasses,TMParray1(1:nContP*nPasses*120),&
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q3C2D1CtoD(nContP,nPasses,5,Qdistance12,TMParray2(1:nContP*nPasses*100),&
        ...
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ3_maxAngC2(5,nContP*nPasses,TMParray1(1:nContP*nPasses*90),&
    ...
    CASE(2022)  !Angmom(A= 2,B= 0,C= 2,D= 2) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP2_maxAngA2(35,nContP*nPasses,TMParray1(1:nContP*nPasses*210),&
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q4C2D2CtoD(nContP,nPasses,5,Qdistance12,TMParray2(1:nContP*nPasses*175),&
        ...
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ4_maxAngC2(5,nContP*nPasses,TMParray1(1:nContP*nPasses*180),&
    ...
    CASE(2100)  !Angmom(A= 2,B= 1,C= 0,D= 0) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP3_maxAngA2(1,nContP*nPasses,TMParray2(1:nContP*nPasses*18),&
    ...
    CASE(2110)  !Angmom(A= 2,B= 1,C= 1,D= 0) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP3_maxAngA2(4,nContP*nPasses,TMParray1(1:nContP*nPasses*72),&
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q1C1D0CtoD(nContP,nPasses,15,Qdistance12,TMParray2(1:nContP*nPasses*60),&
            & LOCALINTS(1:nContP*nPasses*45),lupri)
        !no Spherical Transformation RHS needed
    CASE(2111)  !Angmom(A= 2,B= 1,C= 1,D= 1) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP3_maxAngA2(10,nContP*nPasses,TMParray1(1:nContP*nPasses*180),&
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q2C1D1CtoD(nContP,nPasses,15,Qdistance12,TMParray2(1:nContP*nPasses*150),&
    ...
    CASE(2120)  !Angmom(A= 2,B= 1,C= 2,D= 0) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q2C2D0CtoD(nContP,nPasses,15,Qdistance12,TMParray2(1:nContP*nPasses*150),&
            & TMParray1(1:nContP*nPasses*90),lupri)
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*75.GT.LOCALINTSmaxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ2_maxAngC2(15,nContP*nPasses,TMParray1(1:nContP*nPasses*90),&
            & LOCALINTS(1:nContP*nPasses*75))
    CASE(2121)  !Angmom(A= 2,B= 1,C= 2,D= 1) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP3_maxAngA2(20,nContP*nPasses,TMParray1(1:nContP*nPasses*360),&
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q3C2D1CtoD(nContP,nPasses,15,Qdistance12,TMParray2(1:nContP*nPasses*300),&
        ...
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ3_maxAngC2(15,nContP*nPasses,TMParray1(1:nContP*nPasses*270),&
    ...
    CASE(2122)  !Angmom(A= 2,B= 1,C= 2,D= 2) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP3_maxAngA2(35,nContP*nPasses,TMParray1(1:nContP*nPasses*630),&
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q4C2D2CtoD(nContP,nPasses,15,Qdistance12,TMParray2(1:nContP*nPasses*525),&
        ...
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ4_maxAngC2(15,nContP*nPasses,TMParray1(1:nContP*nPasses*540),&
    ...
    CASE(2200)  !Angmom(A= 2,B= 2,C= 0,D= 0) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP4_maxAngA2(1,nContP*nPasses,TMParray2(1:nContP*nPasses*36),&
            & LOCALINTS(1:nContP*nPasses*25))
        !no need for RHS Horizontal recurrence relations 
        !no Spherical Transformation RHS needed
    CASE(2210)  !Angmom(A= 2,B= 2,C= 1,D= 0) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP4_maxAngA2(4,nContP*nPasses,TMParray1(1:nContP*nPasses*144),&
            & TMParray2(1:nContP*nPasses*100))
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*75.GT.LOCALINTSmaxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q1C1D0CtoD(nContP,nPasses,25,Qdistance12,TMParray2(1:nContP*nPasses*100),&
    ...
    CASE(2211)  !Angmom(A= 2,B= 2,C= 1,D= 1) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP4_maxAngA2(10,nContP*nPasses,TMParray1(1:nContP*nPasses*360),&
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q2C1D1CtoD(nContP,nPasses,25,Qdistance12,TMParray2(1:nContP*nPasses*250),&
    ...
    CASE(2220)  !Angmom(A= 2,B= 2,C= 2,D= 0) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q2C2D0CtoD(nContP,nPasses,25,Qdistance12,TMParray2(1:nContP*nPasses*250),&
        ...
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ2_maxAngC2(25,nContP*nPasses,TMParray1(1:nContP*nPasses*150),&
            & LOCALINTS(1:nContP*nPasses*125))
    CASE(2221)  !Angmom(A= 2,B= 2,C= 2,D= 1) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP4_maxAngA2(20,nContP*nPasses,TMParray1(1:nContP*nPasses*720),&
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q3C2D1CtoD(nContP,nPasses,25,Qdistance12,TMParray2(1:nContP*nPasses*500),&
        ...
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ3_maxAngC2(25,nContP*nPasses,TMParray1(1:nContP*nPasses*450),&
            & LOCALINTS(1:nContP*nPasses*375))
    CASE(2222)  !Angmom(A= 2,B= 2,C= 2,D= 2) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP4_maxAngA2(35,nContP*nPasses,TMParray1(1:nContP*nPasses*1260),&
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q4C2D2CtoD(nContP,nPasses,25,Qdistance12,TMParray2(1:nContP*nPasses*875),&
        ...
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ4_maxAngC2(25,nContP*nPasses,TMParray1(1:nContP*nPasses*900),&
    ...
    CASE(   1)  !Angmom(A= 0,B= 0,C= 0,D= 1) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q1C0D1DtoC(nContP,nPasses,1,Qdistance12,TMParray2(1:nContP*nPasses*4),&
    ...
    CASE(   2)  !Angmom(A= 0,B= 0,C= 0,D= 2) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q2C0D2DtoC(nContP,nPasses,1,Qdistance12,TMParray1(1:nContP*nPasses*10),&
        ...
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ2_maxAngC0(1,nContP*nPasses,TMParray2(1:nContP*nPasses*6),&
            & LOCALINTS(1:nContP*nPasses*5))
    CASE(  10)  !Angmom(A= 0,B= 0,C= 1,D= 0) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q1C1D0CtoD(nContP,nPasses,1,Qdistance12,TMParray2(1:nContP*nPasses*4),&
            & LOCALINTS(1:nContP*nPasses*3),lupri)
        !no Spherical Transformation RHS needed
    CASE(  11)  !Angmom(A= 0,B= 0,C= 1,D= 1) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q2C1D1CtoD(nContP,nPasses,1,Qdistance12,TMParray1(1:nContP*nPasses*10),&
            & LOCALINTS(1:nContP*nPasses*9),lupri)
        !no Spherical Transformation RHS needed
    CASE(  12)  !Angmom(A= 0,B= 0,C= 1,D= 2) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q3C1D2DtoC(nContP,nPasses,1,Qdistance12,TMParray1(1:nContP*nPasses*20),&
        ...
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ3_maxAngC1(1,nContP*nPasses,TMParray2(1:nContP*nPasses*18),&
            & LOCALINTS(1:nContP*nPasses*15))
    CASE(  20)  !Angmom(A= 0,B= 0,C= 2,D= 0) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q2C2D0CtoD(nContP,nPasses,1,Qdistance12,TMParray1(1:nContP*nPasses*10),&
            & TMParray2(1:nContP*nPasses*6),lupri)
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*5.GT.LOCALINTSmaxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ2_maxAngC2(1,nContP*nPasses,TMParray2(1:nContP*nPasses*6),&
            & LOCALINTS(1:nContP*nPasses*5))
    CASE(  21)  !Angmom(A= 0,B= 0,C= 2,D= 1) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q3C2D1CtoD(nContP,nPasses,1,Qdistance12,TMParray1(1:nContP*nPasses*20),&
            & TMParray2(1:nContP*nPasses*18),lupri)
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*15.GT.LOCALINTSmaxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ3_maxAngC2(1,nContP*nPasses,TMParray2(1:nContP*nPasses*18),&
            & LOCALINTS(1:nContP*nPasses*15))
    CASE(  22)  !Angmom(A= 0,B= 0,C= 2,D= 2) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q4C2D2CtoD(nContP,nPasses,1,Qdistance12,TMParray1(1:nContP*nPasses*35),&
        ...
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ4_maxAngC2(1,nContP*nPasses,TMParray2(1:nContP*nPasses*36),&
            & LOCALINTS(1:nContP*nPasses*25))
    ...
    CASE( 101)  !Angmom(A= 0,B= 1,C= 0,D= 1) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q1C0D1DtoC(nContP,nPasses,3,Qdistance12,TMParray1(1:nContP*nPasses*12),&
            & LOCALINTS(1:nContP*nPasses*9),lupri)
        !no Spherical Transformation RHS needed
    CASE( 102)  !Angmom(A= 0,B= 1,C= 0,D= 2) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q2C0D2DtoC(nContP,nPasses,3,Qdistance12,TMParray1(1:nContP*nPasses*30),&
            & TMParray2(1:nContP*nPasses*18),lupri)
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*15.GT.LOCALINTSmaxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ2_maxAngC0(3,nContP*nPasses,TMParray2(1:nContP*nPasses*18),&
            & LOCALINTS(1:nContP*nPasses*15))
    ...
    CASE( 112)  !Angmom(A= 0,B= 1,C= 1,D= 2) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q3C1D2DtoC(nContP,nPasses,3,Qdistance12,TMParray1(1:nContP*nPasses*60),&
        ...
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ3_maxAngC1(3,nContP*nPasses,TMParray2(1:nContP*nPasses*54),&
    ...
    CASE( 120)  !Angmom(A= 0,B= 1,C= 2,D= 0) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q2C2D0CtoD(nContP,nPasses,3,Qdistance12,TMParray1(1:nContP*nPasses*30),&
            & TMParray2(1:nContP*nPasses*18),lupri)
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*15.GT.LOCALINTSmaxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ2_maxAngC2(3,nContP*nPasses,TMParray2(1:nContP*nPasses*18),&
            & LOCALINTS(1:nContP*nPasses*15))
    CASE( 121)  !Angmom(A= 0,B= 1,C= 2,D= 1) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q3C2D1CtoD(nContP,nPasses,3,Qdistance12,TMParray1(1:nContP*nPasses*60),&
            & TMParray2(1:nContP*nPasses*54),lupri)
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*45.GT.LOCALINTSmaxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ3_maxAngC2(3,nContP*nPasses,TMParray2(1:nContP*nPasses*54),&
            & LOCALINTS(1:nContP*nPasses*45))
    CASE( 122)  !Angmom(A= 0,B= 1,C= 2,D= 2) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q4C2D2CtoD(nContP,nPasses,3,Qdistance12,TMParray1(1:nContP*nPasses*105),&
        ...
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ4_maxAngC2(3,nContP*nPasses,TMParray2(1:nContP*nPasses*108),&
            & LOCALINTS(1:nContP*nPasses*75))
    CASE( 200)  !Angmom(A= 0,B= 2,C= 0,D= 0) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP2_maxAngA0(1,nContP*nPasses,TMParray2(1:nContP*nPasses*6),&
            & LOCALINTS(1:nContP*nPasses*5))
        !no need for RHS Horizontal recurrence relations 
        !no Spherical Transformation RHS needed
    CASE( 201)  !Angmom(A= 0,B= 2,C= 0,D= 1) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP2_maxAngA0(4,nContP*nPasses,TMParray1(1:nContP*nPasses*24),&
            & TMParray2(1:nContP*nPasses*20))
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*15.GT.LOCALINTSmaxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q1C0D1DtoC(nContP,nPasses,5,Qdistance12,TMParray2(1:nContP*nPasses*20),&
            & LOCALINTS(1:nContP*nPasses*15),lupri)
        !no Spherical Transformation RHS needed
    CASE( 202)  !Angmom(A= 0,B= 2,C= 0,D= 2) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP2_maxAngA0(10,nContP*nPasses,TMParray1(1:nContP*nPasses*60),&
            & TMParray2(1:nContP*nPasses*50))
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*30.GT.TMParray1maxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q2C0D2DtoC(nContP,nPasses,5,Qdistance12,TMParray2(1:nContP*nPasses*50),&
            & TMParray1(1:nContP*nPasses*30),lupri)
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*25.GT.LOCALINTSmaxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ2_maxAngC0(5,nContP*nPasses,TMParray1(1:nContP*nPasses*30),&
            & LOCALINTS(1:nContP*nPasses*25))
    ...
    CASE( 212)  !Angmom(A= 0,B= 2,C= 1,D= 2) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP2_maxAngA0(20,nContP*nPasses,TMParray1(1:nContP*nPasses*120),&
            & TMParray2(1:nContP*nPasses*100))
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*90.GT.TMParray1maxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q3C1D2DtoC(nContP,nPasses,5,Qdistance12,TMParray2(1:nContP*nPasses*100),&
            & TMParray1(1:nContP*nPasses*90),lupri)
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*75.GT.LOCALINTSmaxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ3_maxAngC1(5,nContP*nPasses,TMParray1(1:nContP*nPasses*90),&
            & LOCALINTS(1:nContP*nPasses*75))
    ...
    CASE( 222)  !Angmom(A= 0,B= 2,C= 2,D= 2) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP2_maxAngA0(35,nContP*nPasses,TMParray1(1:nContP*nPasses*210),&
            & TMParray2(1:nContP*nPasses*175))
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*180.GT.TMParray1maxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
    ...
    CASE(1101)  !Angmom(A= 1,B= 1,C= 0,D= 1) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q1C0D1DtoC(nContP,nPasses,9,Qdistance12,TMParray1(1:nContP*nPasses*36),&
            & LOCALINTS(1:nContP*nPasses*27),lupri)
        !no Spherical Transformation RHS needed
    CASE(1102)  !Angmom(A= 1,B= 1,C= 0,D= 2) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q2C0D2DtoC(nContP,nPasses,9,Qdistance12,TMParray1(1:nContP*nPasses*90),&
            & TMParray2(1:nContP*nPasses*54),lupri)
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*45.GT.LOCALINTSmaxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ2_maxAngC0(9,nContP*nPasses,TMParray2(1:nContP*nPasses*54),&
            & LOCALINTS(1:nContP*nPasses*45))
    CASE(1112)  !Angmom(A= 1,B= 1,C= 1,D= 2) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q3C1D2DtoC(nContP,nPasses,9,Qdistance12,TMParray1(1:nContP*nPasses*180),&
        ...
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ3_maxAngC1(9,nContP*nPasses,TMParray2(1:nContP*nPasses*162),&
    ...
    CASE(1120)  !Angmom(A= 1,B= 1,C= 2,D= 0) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q2C2D0CtoD(nContP,nPasses,9,Qdistance12,TMParray1(1:nContP*nPasses*90),&
            & TMParray2(1:nContP*nPasses*54),lupri)
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*45.GT.LOCALINTSmaxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ2_maxAngC2(9,nContP*nPasses,TMParray2(1:nContP*nPasses*54),&
            & LOCALINTS(1:nContP*nPasses*45))
    CASE(1121)  !Angmom(A= 1,B= 1,C= 2,D= 1) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q3C2D1CtoD(nContP,nPasses,9,Qdistance12,TMParray1(1:nContP*nPasses*180),&
            & TMParray2(1:nContP*nPasses*162),lupri)
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*135.GT.LOCALINTSmaxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ3_maxAngC2(9,nContP*nPasses,TMParray2(1:nContP*nPasses*162),&
            & LOCALINTS(1:nContP*nPasses*135))
    CASE(1122)  !Angmom(A= 1,B= 1,C= 2,D= 2) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q4C2D2CtoD(nContP,nPasses,9,Qdistance12,TMParray1(1:nContP*nPasses*315),&
        ...
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ4_maxAngC2(9,nContP*nPasses,TMParray2(1:nContP*nPasses*324),&
            & LOCALINTS(1:nContP*nPasses*225))
    CASE(1200)  !Angmom(A= 1,B= 2,C= 0,D= 0) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP3_maxAngA1(1,nContP*nPasses,TMParray2(1:nContP*nPasses*18),&
            & LOCALINTS(1:nContP*nPasses*15))
        !no need for RHS Horizontal recurrence relations 
        !no Spherical Transformation RHS needed
    CASE(1201)  !Angmom(A= 1,B= 2,C= 0,D= 1) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP3_maxAngA1(4,nContP*nPasses,TMParray1(1:nContP*nPasses*72),&
            & TMParray2(1:nContP*nPasses*60))
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*45.GT.LOCALINTSmaxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q1C0D1DtoC(nContP,nPasses,15,Qdistance12,TMParray2(1:nContP*nPasses*60),&
            & LOCALINTS(1:nContP*nPasses*45),lupri)
        !no Spherical Transformation RHS needed
    CASE(1202)  !Angmom(A= 1,B= 2,C= 0,D= 2) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP3_maxAngA1(10,nContP*nPasses,TMParray1(1:nContP*nPasses*180),&
            & TMParray2(1:nContP*nPasses*150))
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*90.GT.TMParray1maxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q2C0D2DtoC(nContP,nPasses,15,Qdistance12,TMParray2(1:nContP*nPasses*150),&
            & TMParray1(1:nContP*nPasses*90),lupri)
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*75.GT.LOCALINTSmaxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ2_maxAngC0(15,nContP*nPasses,TMParray1(1:nContP*nPasses*90),&
            & LOCALINTS(1:nContP*nPasses*75))
    ...
    CASE(1212)  !Angmom(A= 1,B= 2,C= 1,D= 2) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP3_maxAngA1(20,nContP*nPasses,TMParray1(1:nContP*nPasses*360),&
            & TMParray2(1:nContP*nPasses*300))
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*270.GT.TMParray1maxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q3C1D2DtoC(nContP,nPasses,15,Qdistance12,TMParray2(1:nContP*nPasses*300),&
            & TMParray1(1:nContP*nPasses*270),lupri)
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*225.GT.LOCALINTSmaxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ3_maxAngC1(15,nContP*nPasses,TMParray1(1:nContP*nPasses*270),&
            & LOCALINTS(1:nContP*nPasses*225))
    ...
    CASE(1222)  !Angmom(A= 1,B= 2,C= 2,D= 2) combi
        ...
        ENDIF
#endif
        call SphericalContractOBS1_CPU_maxAngP3_maxAngA1(35,nContP*nPasses,TMParray1(1:nContP*nPasses*630),&
            & TMParray2(1:nContP*nPasses*525))
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*540.GT.TMParray1maxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
    ...
    CASE(2201)  !Angmom(A= 2,B= 2,C= 0,D= 1) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q1C0D1DtoC(nContP,nPasses,25,Qdistance12,TMParray2(1:nContP*nPasses*100),&
            & LOCALINTS(1:nContP*nPasses*75),lupri)
        !no Spherical Transformation RHS needed
    CASE(2202)  !Angmom(A= 2,B= 2,C= 0,D= 2) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q2C0D2DtoC(nContP,nPasses,25,Qdistance12,TMParray2(1:nContP*nPasses*250),&
            & TMParray1(1:nContP*nPasses*150),lupri)
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*125.GT.LOCALINTSmaxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ2_maxAngC0(25,nContP*nPasses,TMParray1(1:nContP*nPasses*150),&
            & LOCALINTS(1:nContP*nPasses*125))
    CASE(2212)  !Angmom(A= 2,B= 2,C= 1,D= 2) combi
        ...
        ENDIF
#endif
        call HorizontalRR_CPU_RHS_Q3C1D2DtoC(nContP,nPasses,25,Qdistance12,TMParray2(1:nContP*nPasses*500),&
            & TMParray1(1:nContP*nPasses*450),lupri)
#ifdef VAR_DEBUGICHOR
        IF(nContP*nPasses*375.GT.LOCALINTSmaxsize)THEN
          call ichorquit('nContP*nPasses too small',-1)
        ENDIF
#endif
        call SphericalContractOBS2_CPU_maxAngQ3_maxAngC1(25,nContP*nPasses,TMParray1(1:nContP*nPasses*450),&
            & LOCALINTS(1:nContP*nPasses*375))
    CASE DEFAULT
