...
!    logical :: CREATED(-2:8,-2:8,-2:8)
    ...
    WRITE(*,'(A)')''
    WRITE(*,'(A)')'subroutine VerticalRecurrence0(nPasses,nPrimP,nPrimQ,&'
    WRITE(*,'(A)')'         & reducedExponents,TABFJW,&'
    WRITE(*,'(A)')'         & Pcent,Qcent,integralPrefactor,PpreExpFac,QpreExpFac,&'
    WRITE(*,'(A)')'         & AUXarray)'
    WRITE(*,'(A)')'  implicit none'
    WRITE(*,'(A)')'  integer,intent(in) :: nPasses,nPrimP,nPrimQ'
    WRITE(*,'(A)')'  REAL(REALK),intent(in) :: reducedExponents(nPrimQ,nPrimP)'
    WRITE(*,'(A)')'  REAL(REALK),intent(in) :: integralPrefactor(nprimQ,nPrimP)'
    WRITE(*,'(A)')'  REAL(REALK),intent(in) :: Pcent(3,nPrimP),Qcent(3,nPrimQ,nPasses)'
    WRITE(*,'(A)')'  REAL(REALK),intent(in) :: TABFJW(0:3,0:1200)'
    WRITE(*,'(A)')'  REAL(REALK),intent(in) :: QpreExpFac(nPrimQ,nPasses),PpreExpFac(nPrimP)'
    WRITE(*,'(A)')'  real(realk),intent(inout) :: AUXarray(nPrimQ,nPrimP,nPasses)'
    WRITE(*,'(A)')'  !local variables'
    WRITE(*,'(A,ES24.16,A)')'  REAL(REALK),PARAMETER :: D2JP36=',36.0d0,'_realk'
    WRITE(*,'(A)')'  real(realk),parameter :: D2=2.0E0_realk'
    WRITE(*,'(A)')'  REAL(REALK),PARAMETER :: D05 =0.5E0_realk,D1=1E0_realk'
    WRITE(*,'(A)')'  REAL(REALK),PARAMETER :: D4 = 4E0_realk, D100=100E0_realk'
    WRITE(*,'(A)')'  Real(realk),parameter :: D12 = 12E0_realk, TENTH = 0.01E0_realk'
    WRITE(*,'(A)')'  REAL(REALK),PARAMETER :: COEF3 = - D1/6E0_realk, COEF4 = D1/24E0_realk'
    WRITE(*,'(A)')'  REAL(REALK),PARAMETER :: COEF5 = - D1/120E0_realk, COEF6 = D1/720E0_realk'
    ...
    WRITE(*,'(A)')'    px = Pcent(1,iPrimP)'
    WRITE(*,'(A)')'    py = Pcent(2,iPrimP)'
    WRITE(*,'(A)')'    pz = Pcent(3,iPrimP)'
    WRITE(*,'(A)')'    DO iPrimQ=1, nPrimQ'
    WRITE(*,'(A)')'     pqx = px - Qcent(1,iPrimQ,iPassQ)'
    WRITE(*,'(A)')'     pqy = py - Qcent(2,iPrimQ,iPassQ)'
    WRITE(*,'(A)')'     pqz = pz - Qcent(3,iPrimQ,iPassQ)'
    ...
    WRITE(*,'(A)')'      W2    = W2*D05'
    WRITE(*,'(A)')'      W3    = W3*COEF3'
    WRITE(*,'(A)')'      RJ000 = TABFJW(0,IPNT)-TABFJW(1,IPNT)*WDIFF+TABFJW(2,IPNT)*W2+TABFJW(3,IPNT)*W3'
    ...
    WRITE(*,'(A)')'      RJ000 = SQRPIH*SQRT(RWVAL) - REXPW*GVAL*RWVAL'
    WRITE(*,'(A)')'     !  (2J+36) < WVAL '
    WRITE(*,'(A)')'     ELSE'
    WRITE(*,'(A)')'      RJ000 = SQRT(PID4/WVAL)'
    WRITE(*,'(A)')'     ENDIF'
    WRITE(*,'(A)')'     AUXarray(iPrimQ,iPrimP,iPassQ)=integralPrefactor(iPrimQ,iPrimP)*&'
    WRITE(*,'(A)')'          & QpreExpFac(iPrimQ,iPassQ)*Pexpfac*RJ000'
    WRITE(*,'(A)')'    enddo'
    WRITE(*,'(A)')'   enddo'
    WRITE(*,'(A)')'  enddo'
...
!    WRITE(*,'(A)')'!  REAL(REALK),intent(in) :: RJ000(0:1,nPrimQ,nPrimP,nPasses)'
    WRITE(*,'(A)')'  REAL(REALK),intent(in) :: integralPrefactor(nprimQ,nPrimP)'
    WRITE(*,'(A)')'  REAL(REALK),intent(in) :: QpreExpFac(nPrimQ,nPasses),PpreExpFac(nPrimP)'
    WRITE(*,'(A)')'  real(realk),intent(in) :: Pcent(3,nPrimP),Qcent(3,nPrimQ,nPasses),Acenter(3)'
    WRITE(*,'(A)')'  real(realk),intent(inout) :: AUXarray(4,nPrimQ,nPrimP,nPasses)'
    WRITE(*,'(A)')'  !local variables'
    WRITE(*,'(A)')'  integer :: iPassQ,iPrimP,iPrimQ,ipnt'
    WRITE(*,'(A)')'  real(realk) :: Ax,Ay,Az,Pexpfac,invexpP,mPX,mPY,mPZ,Xpa,Ypa,Zpa,RJ000(0:1)'
    ...
    WRITE(*,'(A)')'  REAL(REALK), PARAMETER :: SQRPIH = SQRTPI/D2'
    WRITE(*,'(A)')'  REAL(REALK), PARAMETER :: PID4 = PI/D4, PID4I = D4/PI'
    WRITE(*,'(A)')'  !ThetaAux(n,1,0,0) = Xpa*ThetaAux(n,0,0,0) + (-alpha/p*Xpq)*ThetaAux(n+1,0,0,0)'
    WRITE(*,'(A)')'  !i = 0 last 2 term vanish'
    WRITE(*,'(A)')'  !We include scaling of RJ000 '
    WRITE(*,'(A)')'  Ax = -Acenter(1)'
    WRITE(*,'(A)')'  Ay = -Acenter(2)'
    WRITE(*,'(A)')'  Az = -Acenter(3)'
    WRITE(*,'(A)')'  DO iPassQ = 1,nPasses'
    WRITE(*,'(A)')'   DO iPrimP=1, nPrimP'
    WRITE(*,'(A)')'    Pexpfac = PpreExpFac(iPrimP)'
    ...
    WRITE(*,'(A)')'    Xpa = Pcent(1,iPrimP) + Ax'
    WRITE(*,'(A)')'    Ypa = Pcent(2,iPrimP) + Ay'
    WRITE(*,'(A)')'    Zpa = Pcent(3,iPrimP) + Az'
    WRITE(*,'(A)')'    DO iPrimQ=1, nPrimQ'
    ...
    WRITE(*,'(A)')'     AUXarray(2,iPrimQ,iPrimP,iPassQ) = Xpa*TMP1 + alphaXpq*TMP2'
    WRITE(*,'(A)')'     AUXarray(3,iPrimQ,iPrimP,iPassQ) = Ypa*TMP1 + alphaYpq*TMP2'
    WRITE(*,'(A)')'     AUXarray(4,iPrimQ,iPrimP,iPassQ) = Zpa*TMP1 + alphaZpq*TMP2'
    WRITE(*,'(A)')'    enddo'
    WRITE(*,'(A)')'   enddo'
    WRITE(*,'(A)')'  enddo'
    ...
    DO JMAX=2,MaxAngmomQP
       ...
       WRITE(*,'(A)')'  real(realk),intent(in) :: Pcent(3,nPrimP),Acenter(3),Qcent(3,nPrimQ,nPasses)'
       WRITE(*,'(A,I2,A)')'  REAL(REALK),intent(in) :: TABFJW(0:',JMAX+3,',0:1200)'
       WRITE(*,'(A)')'  !Local variables'
       WRITE(*,'(A)')'  integer :: iPassQ,iPrimP,iPrimQ,IPNT,IP'
       WRITE(*,'(A)')'  real(realk) :: Ax,Ay,Az,Pexpfac,invexpP,inv2expP,mPX,mPY,mPZ,Xpa,Ypa,Zpa,WVAL'
       ...
       WRITE(*,'(A)')'  REAL(REALK),PARAMETER :: SQRPIH = SQRTPI/D2'
       WRITE(*,'(A)')'  REAL(REALK),PARAMETER :: PID4 = PI/D4, PID4I = D4/PI'
       WRITE(*,'(A)')'  !TUV(T,0,0,N) = Xpa*TUV(T-1,0,0,N)-(alpha/p)*Xpq*TUV(T-1,0,0,N+1)'
      ...
      IF(TM2.GE.0)THEN
         ...
         IF(TM1.EQ.1)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Xpa*AuxArray(',ituvP1,',IP) + alphaXpq*TmpArray',JTMP,'(',ituvP1,',2) + TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.2)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Xpa*AuxArray(',ituvP1,',IP) + alphaXpq*TmpArray',JTMP,'(',ituvP1,',2) + 2.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.3)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Xpa*AuxArray(',ituvP1,',IP) + alphaXpq*TmpArray',JTMP,'(',ituvP1,',2) + 3.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.4)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Xpa*AuxArray(',ituvP1,',IP) + alphaXpq*TmpArray',JTMP,'(',ituvP1,',2) + 4.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.5)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Xpa*AuxArray(',ituvP1,',IP) + alphaXpq*TmpArray',JTMP,'(',ituvP1,',2) + 5.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.6)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Xpa*AuxArray(',ituvP1,',IP) + alphaXpq*TmpArray',JTMP,'(',ituvP1,',2) + 6.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.7)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Xpa*AuxArray(',ituvP1,',IP) + alphaXpq*TmpArray',JTMP,'(',ituvP1,',2) + 7.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.8)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Xpa*AuxArray(',ituvP1,',IP) + alphaXpq*TmpArray',JTMP,'(',ituvP1,',2) + 8.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.9)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Xpa*AuxArray(',ituvP1,',IP) + alphaXpq*TmpArray',JTMP,'(',ituvP1,',2) + 9.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.10)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Xpa*AuxArray(',ituvP1,',IP) + alphaXpq*TmpArray',JTMP,'(',ituvP1,',2) + 10.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSE
            STOP 'TREC D4'
         ENDIF
      ELSE
         ...
         WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A)')&
              &'     AuxArray(',ituvP0,',IP) = Xpa*AuxArray(',ituvP1,',IP) + alphaXpq*TmpArray',JTMP,'(',ituvP1,',2)'
      ENDIF
   ELSE
      IF(TM2.GE.0)THEN
         !four term relation
         IF(TM1.EQ.1)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Xpa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaXpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.2)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Xpa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaXpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 2.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.3)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Xpa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaXpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 3.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.4)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Xpa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaXpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 4.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.5)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Xpa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaXpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 5.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.6)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Xpa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaXpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 6.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.7)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Xpa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaXpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 7.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.8)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Xpa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaXpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 8.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.9)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Xpa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaXpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 9.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.10)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Xpa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaXpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 10.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSE
            stop 'Trec B D4'
         ENDIF
      ELSE
         ...
         WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A)')&
              &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Xpa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaXpq*TmpArray',JTMP,'(',ituvP1,',',J+1,')'
      ENDIF      
   ENDIF
ELSE
   IF(J.EQ.1)THEN
...
IF(J.EQ.JMAX)THEN
   IF(J.EQ.1)THEN
      IF(TM2.GE.0)THEN
         ...
         IF(TM1.EQ.1)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Ypa*AuxArray(',ituvP1,',IP) + alphaYpq*TmpArray',JTMP,'(',ituvP1,',2) + TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.2)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Ypa*AuxArray(',ituvP1,',IP) + alphaYpq*TmpArray',JTMP,'(',ituvP1,',2) + 2.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.3)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Ypa*AuxArray(',ituvP1,',IP) + alphaYpq*TmpArray',JTMP,'(',ituvP1,',2) + 3.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.4)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Ypa*AuxArray(',ituvP1,',IP) + alphaYpq*TmpArray',JTMP,'(',ituvP1,',2) + 4.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.5)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Ypa*AuxArray(',ituvP1,',IP) + alphaYpq*TmpArray',JTMP,'(',ituvP1,',2) + 5.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.6)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Ypa*AuxArray(',ituvP1,',IP) + alphaYpq*TmpArray',JTMP,'(',ituvP1,',2) + 6.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.7)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Ypa*AuxArray(',ituvP1,',IP) + alphaYpq*TmpArray',JTMP,'(',ituvP1,',2) + 7.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.8)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Ypa*AuxArray(',ituvP1,',IP) + alphaYpq*TmpArray',JTMP,'(',ituvP1,',2) + 8.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.9)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Ypa*AuxArray(',ituvP1,',IP) + alphaYpq*TmpArray',JTMP,'(',ituvP1,',2) + 9.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.10)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Ypa*AuxArray(',ituvP1,',IP) + alphaYpq*TmpArray',JTMP,'(',ituvP1,',2) + 10.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSE
            STOP 'TREC D4'
         ENDIF
      ELSE
         !two term relation
         WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A)')&
              &'     AuxArray(',ituvP0,',IP) = Ypa*AuxArray(',ituvP1,',IP) + alphaYpq*TmpArray',JTMP,'(',ituvP1,',2)'
      ENDIF
   ELSE
      IF(TM2.GE.0)THEN
         !four term relation
         IF(TM1.EQ.1)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Ypa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaYpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.2)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Ypa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaYpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 2.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.3)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Ypa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaYpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 3.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.4)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Ypa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaYpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 4.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.5)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Ypa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaYpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 5.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.6)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Ypa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaYpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 6.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.7)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Ypa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaYpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 7.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.8)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Ypa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaYpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 8.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.9)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Ypa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaYpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 9.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.10)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Ypa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaYpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 10.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSE
            stop 'Trec B D4'
         ENDIF
      ELSE
         !two term relation
         WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A)')&
              &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Ypa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaYpq*TmpArray',JTMP,'(',ituvP1,',',J+1,')'
      ENDIF      
   ENDIF
ELSE
   IF(J.EQ.1)THEN
...
IF(J.EQ.JMAX)THEN
   IF(J.EQ.1)THEN
      IF(TM2.GE.0)THEN
         ...
         IF(TM1.EQ.1)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Zpa*AuxArray(',ituvP1,',IP) + alphaZpq*TmpArray',JTMP,'(',ituvP1,',2) + TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.2)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Zpa*AuxArray(',ituvP1,',IP) + alphaZpq*TmpArray',JTMP,'(',ituvP1,',2) + 2.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.3)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Zpa*AuxArray(',ituvP1,',IP) + alphaZpq*TmpArray',JTMP,'(',ituvP1,',2) + 3.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.4)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Zpa*AuxArray(',ituvP1,',IP) + alphaZpq*TmpArray',JTMP,'(',ituvP1,',2) + 4.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.5)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Zpa*AuxArray(',ituvP1,',IP) + alphaZpq*TmpArray',JTMP,'(',ituvP1,',2) + 5.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.6)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Zpa*AuxArray(',ituvP1,',IP) + alphaZpq*TmpArray',JTMP,'(',ituvP1,',2) + 6.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.7)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Zpa*AuxArray(',ituvP1,',IP) + alphaZpq*TmpArray',JTMP,'(',ituvP1,',2) + 7.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.8)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Zpa*AuxArray(',ituvP1,',IP) + alphaZpq*TmpArray',JTMP,'(',ituvP1,',2) + 8.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.9)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Zpa*AuxArray(',ituvP1,',IP) + alphaZpq*TmpArray',JTMP,'(',ituvP1,',2) + 9.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.10)THEN
            WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A,I3,A)')&
                 &'     AuxArray(',ituvP0,',IP) = Zpa*AuxArray(',ituvP1,',IP) + alphaZpq*TmpArray',JTMP,'(',ituvP1,',2) + 10.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSE
            STOP 'TREC D4'
         ENDIF
      ELSE
         !two term relation
         WRITE(*,'(A,I4,A,I4,A,I1,A,I4,A)')&
              &'     AuxArray(',ituvP0,',IP) = Zpa*AuxArray(',ituvP1,',IP) + alphaZpq*TmpArray',JTMP,'(',ituvP1,',2)'
      ENDIF
   ELSE
      IF(TM2.GE.0)THEN
         !four term relation
         IF(TM1.EQ.1)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Zpa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaZpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.2)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Zpa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaZpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 2.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.3)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Zpa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaZpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 3.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.4)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Zpa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaZpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 4.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.5)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Zpa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaZpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 5.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.6)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Zpa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaZpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 6.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.7)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Zpa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaZpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 7.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.8)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Zpa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaZpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 8.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.9)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Zpa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaZpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 9.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSEIF(TM1.EQ.10)THEN
            WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I3,A)')&
                 &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Zpa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaZpq*TmpArray',JTMP,'(',ituvP1,',',J+1,') + 10.0E0_realk*TwoTerms(',iTwoTerms,')'
         ELSE
            stop 'Trec B D4'
         ENDIF
      ELSE
         !two term relation
         WRITE(*,'(A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A,I1,A,I4,A,I2,A)')&
              &'     tmpArray',JTMP+1,'(',ituvP0,',',J,') = Zpa*tmpArray',JTMP,'(',ituvP1,',',J,') + alphaZpq*TmpArray',JTMP,'(',ituvP1,',',J+1,')'
      ENDIF      
   ENDIF
ELSE
   IF(J.EQ.1)THEN
