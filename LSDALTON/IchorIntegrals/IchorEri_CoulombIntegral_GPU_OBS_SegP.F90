...
!    nlmD = 2*AngmomD+1
    ...
    CASE(1110)  !Angmom(A= 1,B= 1,C= 1,D= 0) combi
        ...
        call HorizontalRR_GPU_LHS_P2A1B1AtoB(nContQ,nPasses,4,&
            ...
            & TMParray1(1),lupri,iASync)
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q1C1D0CtoD(nContQ,nPasses,9,Qdistance12,TMParray1(1),&
            & LOCALINTS(1),lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(1111)  !Angmom(A= 1,B= 1,C= 1,D= 1) combi
        ...
        call HorizontalRR_GPU_LHS_P2A1B1AtoB(nContQ,nPasses,10,&
            ...
            & TMParray1(1),lupri,iASync)
        !no Spherical Transformation LHS needed
        call HorizontalRR_GPU_RHS_Q2C1D1CtoD(nContQ,nPasses,9,Qdistance12,TMParray1(1),&
            & LOCALINTS(1),lupri,iASync)
        !no Spherical Transformation RHS needed
    ...
    CASE(2210)  !Angmom(A= 2,B= 2,C= 1,D= 0) combi
        ...
        call SphericalContractOBS1_GPU_maxAngP4_maxAngA2(4,nContQ*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q1C1D0CtoD(nContQ,nPasses,25,Qdistance12,TMParray2(1),&
            & LOCALINTS(1),lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(2211)  !Angmom(A= 2,B= 2,C= 1,D= 1) combi
        ...
        call SphericalContractOBS1_GPU_maxAngP4_maxAngA2(10,nContQ*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q2C1D1CtoD(nContQ,nPasses,25,Qdistance12,TMParray2(1),&
            & LOCALINTS(1),lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(2220)  !Angmom(A= 2,B= 2,C= 2,D= 0) combi
        ...
        call SphericalContractOBS1_GPU_maxAngP4_maxAngA2(10,nContQ*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q2C2D0CtoD(nContQ,nPasses,25,Qdistance12,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
    ...
    CASE(2221)  !Angmom(A= 2,B= 2,C= 2,D= 1) combi
        ...
        call SphericalContractOBS1_GPU_maxAngP4_maxAngA2(20,nContQ*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q3C2D1CtoD(nContQ,nPasses,25,Qdistance12,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
    ...
    CASE(2222)  !Angmom(A= 2,B= 2,C= 2,D= 2) combi
        ...
        call SphericalContractOBS1_GPU_maxAngP4_maxAngA2(35,nContQ*nPasses,TMParray1(1),&
            & TMParray2(1),iASync)
        call HorizontalRR_GPU_RHS_Q4C2D2CtoD(nContQ,nPasses,25,Qdistance12,TMParray2(1),&
            & TMParray1(1),lupri,iASync)
