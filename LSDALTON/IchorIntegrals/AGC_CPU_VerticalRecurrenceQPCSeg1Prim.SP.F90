module SPAGC_CPU_OBS_VERTICALRECURRENCEMODCSeg1Prim
 use IchorPrecisionMod
  
 CONTAINS


subroutine SPVerticalRecurrenceCPUSeg1Prim1C(nPassP,nPrimP,nPrimQ,&
  ...
  real(reals),intent(in) :: Ccenter(3)
  real(reals),intent(inout) :: AUXarray(4,nPassP)
  !local variables
  Integer :: iP,iPassP,ipnt,iAtomA,iAtomB
  real(reals) :: Xqc,Yqc,Zqc
...
!$OMP         iP,iPassP)
  ...
  ENDDO !iP = 1,nPassP
!$OMP END DO
end subroutine SPVerticalRecurrenceCPUSeg1Prim1C

subroutine SPVerticalRecurrenceCPUSeg1Prim2C(nPassP,nPrimP,nPrimQ,&
  ...
  integer,intent(in) :: MaxPasses,nAtomsA,nAtomsB
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(in) :: RJ000Array(0: 2,nPassP)
  real(reals),intent(in) :: reducedExponents(1),Qexp(1)
  real(reals),intent(in) :: Pcent(3,nAtomsA,nAtomsB),Qcent(3),integralPrefactor(1),QpreExpFac(1),PpreExpFac(nAtomsA,nAtomsB)
  real(reals),intent(in) :: Ccenter(3)
  real(reals),intent(inout) :: AUXarray(   10,nPassP)
  !local variables
...
subroutine SPVerticalRecurrenceCPUSeg1Prim3C(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Ccenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
  integer,intent(in) :: MaxPasses,nAtomsA,nAtomsB
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(in) :: RJ000Array(0: 3,nPassP)
  real(reals),intent(in) :: reducedExponents(1),Qexp(1)
  real(reals),intent(in) :: Pcent(3,nAtomsA,nAtomsB),Qcent(3),integralPrefactor(1),QpreExpFac(1),PpreExpFac(nAtomsA,nAtomsB)
  real(reals),intent(in) :: Ccenter(3)
  real(reals),intent(inout) :: AUXarray(   20,nPassP)
  !local variables
  integer :: iPassP,ipnt,IP,iTUV,iAtomA,iAtomB
...
subroutine SPVerticalRecurrenceCPUSeg1Prim4C(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Ccenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
  integer,intent(in) :: MaxPasses,nAtomsA,nAtomsB
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(in) :: RJ000Array(0: 4,nPassP)
  real(reals),intent(in) :: reducedExponents(1),Qexp(1)
  real(reals),intent(in) :: Pcent(3,nAtomsA,nAtomsB),Qcent(3),integralPrefactor(1),QpreExpFac(1),PpreExpFac(nAtomsA,nAtomsB)
  real(reals),intent(in) :: Ccenter(3)
  real(reals),intent(inout) :: AUXarray(   35,nPassP)
  !local variables
  integer :: iPassP,ipnt,IP,iTUV,iAtomA,iAtomB
...
subroutine SPVerticalRecurrenceCPUSeg1Prim5C(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Ccenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
  integer,intent(in) :: MaxPasses,nAtomsA,nAtomsB
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(in) :: RJ000Array(0: 5,nPassP)
  real(reals),intent(in) :: reducedExponents(1),Qexp(1)
  real(reals),intent(in) :: Pcent(3,nAtomsA,nAtomsB),Qcent(3),integralPrefactor(1),QpreExpFac(1),PpreExpFac(nAtomsA,nAtomsB)
  real(reals),intent(in) :: Ccenter(3)
  real(reals),intent(inout) :: AUXarray(   56,nPassP)
  !local variables
  integer :: iPassP,ipnt,IP,iTUV,iAtomA,iAtomB
...
subroutine SPVerticalRecurrenceCPUSeg1Prim6C(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Ccenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
  integer,intent(in) :: MaxPasses,nAtomsA,nAtomsB
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(in) :: RJ000Array(0: 6,nPassP)
  real(reals),intent(in) :: reducedExponents(1),Qexp(1)
  real(reals),intent(in) :: Pcent(3,nAtomsA,nAtomsB),Qcent(3),integralPrefactor(1),QpreExpFac(1),PpreExpFac(nAtomsA,nAtomsB)
  real(reals),intent(in) :: Ccenter(3)
  real(reals),intent(inout) :: AUXarray(   84,nPassP)
  !local variables
  integer :: iPassP,ipnt,IP,iTUV,iAtomA,iAtomB
...
subroutine SPVerticalRecurrenceCPUSeg1Prim7C(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Ccenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
  integer,intent(in) :: MaxPasses,nAtomsA,nAtomsB
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(in) :: RJ000Array(0: 7,nPassP)
  real(reals),intent(in) :: reducedExponents(1),Qexp(1)
  real(reals),intent(in) :: Pcent(3,nAtomsA,nAtomsB),Qcent(3),integralPrefactor(1),QpreExpFac(1),PpreExpFac(nAtomsA,nAtomsB)
  real(reals),intent(in) :: Ccenter(3)
  real(reals),intent(inout) :: AUXarray(  120,nPassP)
  !local variables
  integer :: iPassP,ipnt,IP,iTUV,iAtomA,iAtomB
