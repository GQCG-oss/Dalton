module SPIchorEriCoulombintegralGPUOBSGeneralModGen2
...
private   
public :: SPICI_GPU_OBS_Gen2
  
CONTAINS
  
  
  subroutine SPICI_GPU_OBS_Gen2(nPrimA,nPrimB,nPrimC,nPrimD,&
...
!    nlmD = 2*AngmomD+1
    ...
    CASE(   1)  !Angmom(A= 0,B= 0,C= 0,D= 1) combi
        call SPVerticalRecurrenceGPUGen1D(nPasses,nPrimP,nPrimQ,reducedExponents,&
        ...
        call SPHorizontalRR_GPU_RHS_Q1C0D1DtoC(nContQP,nPasses,1,Qdistance12,TMParray2,&
    ...
    CASE(   2)  !Angmom(A= 0,B= 0,C= 0,D= 2) combi
        ...
        call SPVerticalRecurrenceGPUGen2D(nPasses,nPrimP,nPrimQ,reducedExponents,&
        ...
        !no need for LHS Horizontal recurrence relations, it would be a simply copy
        !no Spherical Transformation LHS needed
        call SPHorizontalRR_GPU_RHS_Q2C0D2DtoC(nContQP,nPasses,1,Qdistance12,TMParray1,&
            & TMParray2,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ2_maxAngC0(1,nContQP*nPasses,TMParray2,&
            & LOCALINTS,iASync)
    CASE(  10)  !Angmom(A= 0,B= 0,C= 1,D= 0) combi
        call SPVerticalRecurrenceGPUGen1C(nPasses,nPrimP,nPrimQ,reducedExponents,&
        ...
        !no need for LHS Horizontal recurrence relations, it would be a simply copy
        !no Spherical Transformation LHS needed
        call SPHorizontalRR_GPU_RHS_Q1C1D0CtoD(nContQP,nPasses,1,Qdistance12,TMParray2,&
            & LOCALINTS,lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(  11)  !Angmom(A= 0,B= 0,C= 1,D= 1) combi
        call SPBuildRJ000GPUGen2(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & TABFJW,Pcent,Qcent,IatomApass,IatomBpass,&
               & MaxPasses,nAtomsA,nAtomsB,TMParray2,iASync)
        call SPVerticalRecurrenceGPUGen2C(nPasses,nPrimP,nPrimQ,reducedExponents,&
        ...
        !no need for LHS Horizontal recurrence relations, it would be a simply copy
        !no Spherical Transformation LHS needed
        call SPHorizontalRR_GPU_RHS_Q2C1D1CtoD(nContQP,nPasses,1,Qdistance12,TMParray1,&
            & LOCALINTS,lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(  12)  !Angmom(A= 0,B= 0,C= 1,D= 2) combi
        ...
        !no need for LHS Horizontal recurrence relations, it would be a simply copy
        !no Spherical Transformation LHS needed
        call SPHorizontalRR_GPU_RHS_Q3C1D2DtoC(nContQP,nPasses,1,Qdistance12,TMParray1,&
            & TMParray2,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ3_maxAngC1(1,nContQP*nPasses,TMParray2,&
            & LOCALINTS,iASync)
    CASE(  20)  !Angmom(A= 0,B= 0,C= 2,D= 0) combi
        ...
        !no need for LHS Horizontal recurrence relations, it would be a simply copy
        !no Spherical Transformation LHS needed
        call SPHorizontalRR_GPU_RHS_Q2C2D0CtoD(nContQP,nPasses,1,Qdistance12,TMParray1,&
            & TMParray2,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ2_maxAngC2(1,nContQP*nPasses,TMParray2,&
            & LOCALINTS,iASync)
    CASE(  21)  !Angmom(A= 0,B= 0,C= 2,D= 1) combi
        ...
        !no need for LHS Horizontal recurrence relations, it would be a simply copy
        !no Spherical Transformation LHS needed
        call SPHorizontalRR_GPU_RHS_Q3C2D1CtoD(nContQP,nPasses,1,Qdistance12,TMParray1,&
            & TMParray2,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ3_maxAngC2(1,nContQP*nPasses,TMParray2,&
            & LOCALINTS,iASync)
    CASE(  22)  !Angmom(A= 0,B= 0,C= 2,D= 2) combi
        ...
        !no need for LHS Horizontal recurrence relations, it would be a simply copy
        !no Spherical Transformation LHS needed
        call SPHorizontalRR_GPU_RHS_Q4C2D2CtoD(nContQP,nPasses,1,Qdistance12,TMParray1,&
            & TMParray2,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ4_maxAngC2(1,nContQP*nPasses,TMParray2,&
            & LOCALINTS,iASync)
    CASE( 100)  !Angmom(A= 0,B= 1,C= 0,D= 0) combi
        call SPVerticalRecurrenceGPUGen1B(nPasses,nPrimP,nPrimQ,reducedExponents,&
        ...
        nContQP = nContQ*nContP
         ...
         call SPPrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,4,1,iASync)
        call SPHorizontalRR_GPU_LHS_P1A0B1BtoA(nContQP,nPasses,1,&
    ...
    CASE( 101)  !Angmom(A= 0,B= 1,C= 0,D= 1) combi
        ...
        call SPVerticalRecurrenceGPUGen2B(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP1Q1BtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
        ...
        nContQP = nContQ*nContP
         ...
         call SPPrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,4,4,iASync)
        call SPHorizontalRR_GPU_LHS_P1A0B1BtoA(nContQP,nPasses,4,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2,&
            & TMParray1,lupri,iASync)
        !no Spherical Transformation LHS needed
        call SPHorizontalRR_GPU_RHS_Q1C0D1DtoC(nContQP,nPasses,3,Qdistance12,TMParray1,&
            & LOCALINTS,lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE( 102)  !Angmom(A= 0,B= 1,C= 0,D= 2) combi
        ...
        call SPVerticalRecurrenceGPUGen3D(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP1Q2DtoBGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
        ...
        nContQP = nContQ*nContP
         ...
         call SPPrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,4,10,iASync)
        call SPHorizontalRR_GPU_LHS_P1A0B1BtoA(nContQP,nPasses,10,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2,&
            & TMParray1,lupri,iASync)
        !no Spherical Transformation LHS needed
        call SPHorizontalRR_GPU_RHS_Q2C0D2DtoC(nContQP,nPasses,3,Qdistance12,TMParray1,&
            & TMParray2,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ2_maxAngC0(3,nContQP*nPasses,TMParray2,&
            & LOCALINTS,iASync)
    CASE( 110)  !Angmom(A= 0,B= 1,C= 1,D= 0) combi
        ...
        call SPVerticalRecurrenceGPUGen2B(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP1Q1BtoCGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
    ...
    CASE( 111)  !Angmom(A= 0,B= 1,C= 1,D= 1) combi
        ...
        call SPVerticalRecurrenceGPUGen3C(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP1Q2CtoBGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
    ...
    CASE( 112)  !Angmom(A= 0,B= 1,C= 1,D= 2) combi
        ...
        call SPVerticalRecurrenceGPUGen4D(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP1Q3DtoBGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Cexp,Aexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
         ...
         call SPPrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,4,20,iASync)
        call SPHorizontalRR_GPU_LHS_P1A0B1BtoA(nContQP,nPasses,20,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2,&
            & TMParray1,lupri,iASync)
        !no Spherical Transformation LHS needed
        call SPHorizontalRR_GPU_RHS_Q3C1D2DtoC(nContQP,nPasses,3,Qdistance12,TMParray1,&
            & TMParray2,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ3_maxAngC1(3,nContQP*nPasses,TMParray2,&
            & LOCALINTS,iASync)
    CASE( 120)  !Angmom(A= 0,B= 1,C= 2,D= 0) combi
        ...
        call SPHorizontalRR_GPU_LHS_P1A0B1BtoA(nContQP,nPasses,10,&
            ...
            & TMParray1,lupri,iASync)
        !no Spherical Transformation LHS needed
        call SPHorizontalRR_GPU_RHS_Q2C2D0CtoD(nContQP,nPasses,3,Qdistance12,TMParray1,&
            & TMParray2,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ2_maxAngC2(3,nContQP*nPasses,TMParray2,&
            & LOCALINTS,iASync)
    CASE( 121)  !Angmom(A= 0,B= 1,C= 2,D= 1) combi
        ...
        call SPVerticalRecurrenceGPUGen4C(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP1Q3CtoBGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Dexp,Aexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
        ...
        call SPHorizontalRR_GPU_LHS_P1A0B1BtoA(nContQP,nPasses,20,&
            ...
            & TMParray1,lupri,iASync)
        !no Spherical Transformation LHS needed
        call SPHorizontalRR_GPU_RHS_Q3C2D1CtoD(nContQP,nPasses,3,Qdistance12,TMParray1,&
            & TMParray2,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ3_maxAngC2(3,nContQP*nPasses,TMParray2,&
            & LOCALINTS,iASync)
    CASE( 122)  !Angmom(A= 0,B= 1,C= 2,D= 2) combi
        ...
        call SPVerticalRecurrenceGPUGen5C(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP1Q4CtoBGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Dexp,Aexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
         ...
         call SPPrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,4,35,iASync)
        call SPHorizontalRR_GPU_LHS_P1A0B1BtoA(nContQP,nPasses,35,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2,&
            & TMParray1,lupri,iASync)
        !no Spherical Transformation LHS needed
        call SPHorizontalRR_GPU_RHS_Q4C2D2CtoD(nContQP,nPasses,3,Qdistance12,TMParray1,&
            & TMParray2,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ4_maxAngC2(3,nContQP*nPasses,TMParray2,&
            & LOCALINTS,iASync)
    CASE( 200)  !Angmom(A= 0,B= 2,C= 0,D= 0) combi
        ...
        nContQP = nContQ*nContP
         ...
         call SPPrimitiveContractionBGPUGen(TMParray2,TMParray1,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,10,1,iASync)
        call SPHorizontalRR_GPU_LHS_P2A0B2BtoA(nContQP,nPasses,1,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray1,&
            & TMParray2,lupri,iASync)
        call SPSphericalContractOBS1_GPU_maxAngP2_maxAngA0(1,nContQP*nPasses,TMParray2,&
            & LOCALINTS,iASync)
        !no need for RHS Horizontal recurrence relations 
        !no Spherical Transformation RHS needed
    CASE( 201)  !Angmom(A= 0,B= 2,C= 0,D= 1) combi
        ...
        call SPVerticalRecurrenceGPUGen3B(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP2Q1BtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Aexp,Cexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
         ...
         call SPPrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,10,4,iASync)
        call SPHorizontalRR_GPU_LHS_P2A0B2BtoA(nContQP,nPasses,4,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2,&
            & TMParray1,lupri,iASync)
        call SPSphericalContractOBS1_GPU_maxAngP2_maxAngA0(4,nContQP*nPasses,TMParray1,&
            & TMParray2,iASync)
        call SPHorizontalRR_GPU_RHS_Q1C0D1DtoC(nContQP,nPasses,5,Qdistance12,TMParray2,&
            & LOCALINTS,lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE( 202)  !Angmom(A= 0,B= 2,C= 0,D= 2) combi
        ...
        call SPVerticalRecurrenceGPUGen4B(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP2Q2BtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Aexp,Cexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
         ...
         call SPPrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,10,10,iASync)
        call SPHorizontalRR_GPU_LHS_P2A0B2BtoA(nContQP,nPasses,10,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2,&
            & TMParray1,lupri,iASync)
        call SPSphericalContractOBS1_GPU_maxAngP2_maxAngA0(10,nContQP*nPasses,TMParray1,&
            & TMParray2,iASync)
        call SPHorizontalRR_GPU_RHS_Q2C0D2DtoC(nContQP,nPasses,5,Qdistance12,TMParray2,&
            & TMParray1,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ2_maxAngC0(5,nContQP*nPasses,TMParray1,&
            & LOCALINTS,iASync)
    CASE( 210)  !Angmom(A= 0,B= 2,C= 1,D= 0) combi
        ...
        call SPVerticalRecurrenceGPUGen3B(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP2Q1BtoCGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Aexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
    ...
    CASE( 211)  !Angmom(A= 0,B= 2,C= 1,D= 1) combi
        ...
        call SPVerticalRecurrenceGPUGen4B(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP2Q2BtoCGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Aexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
    ...
    CASE( 212)  !Angmom(A= 0,B= 2,C= 1,D= 2) combi
        ...
        call SPVerticalRecurrenceGPUGen5D(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP2Q3DtoBGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Cexp,Aexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
         ...
         call SPPrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,10,20,iASync)
        call SPHorizontalRR_GPU_LHS_P2A0B2BtoA(nContQP,nPasses,20,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2,&
            & TMParray1,lupri,iASync)
        call SPSphericalContractOBS1_GPU_maxAngP2_maxAngA0(20,nContQP*nPasses,TMParray1,&
            & TMParray2,iASync)
        call SPHorizontalRR_GPU_RHS_Q3C1D2DtoC(nContQP,nPasses,5,Qdistance12,TMParray2,&
            & TMParray1,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ3_maxAngC1(5,nContQP*nPasses,TMParray1,&
            & LOCALINTS,iASync)
    ...
    CASE( 221)  !Angmom(A= 0,B= 2,C= 2,D= 1) combi
        ...
        call SPVerticalRecurrenceGPUGen5C(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP2Q3CtoBGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Dexp,Aexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
    ...
    CASE( 222)  !Angmom(A= 0,B= 2,C= 2,D= 2) combi
        ...
        call SPVerticalRecurrenceGPUGen6C(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP2Q4CtoBGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Dexp,Aexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
         ...
         call SPPrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,10,35,iASync)
        call SPHorizontalRR_GPU_LHS_P2A0B2BtoA(nContQP,nPasses,35,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2,&
            & TMParray1,lupri,iASync)
        call SPSphericalContractOBS1_GPU_maxAngP2_maxAngA0(35,nContQP*nPasses,TMParray1,&
            & TMParray2,iASync)
    ...
    CASE(1001)  !Angmom(A= 1,B= 0,C= 0,D= 1) combi
        ...
        call SPVerticalRecurrenceGPUGen2A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP1Q1AtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
    ...
    CASE(1002)  !Angmom(A= 1,B= 0,C= 0,D= 2) combi
        ...
        call SPVerticalRecurrenceGPUGen3D(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP1Q2DtoAGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
    ...
    CASE(1012)  !Angmom(A= 1,B= 0,C= 1,D= 2) combi
        ...
        call SPVerticalRecurrenceGPUGen4D(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP1Q3DtoAGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Cexp,Bexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
         ...
         call SPPrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,4,20,iASync)
        call SPHorizontalRR_GPU_LHS_P1A1B0AtoB(nContQP,nPasses,20,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2,&
            & TMParray1,lupri,iASync)
        !no Spherical Transformation LHS needed
        call SPHorizontalRR_GPU_RHS_Q3C1D2DtoC(nContQP,nPasses,3,Qdistance12,TMParray1,&
    ...
    CASE(1021)  !Angmom(A= 1,B= 0,C= 2,D= 1) combi
        ...
        call SPVerticalRecurrenceGPUGen4C(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP1Q3CtoAGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Dexp,Bexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
    ...
    CASE(1022)  !Angmom(A= 1,B= 0,C= 2,D= 2) combi
        ...
        call SPVerticalRecurrenceGPUGen5C(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP1Q4CtoAGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Dexp,Bexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
         ...
         call SPPrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,4,35,iASync)
        call SPHorizontalRR_GPU_LHS_P1A1B0AtoB(nContQP,nPasses,35,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2,&
            & TMParray1,lupri,iASync)
        !no Spherical Transformation LHS needed
        call SPHorizontalRR_GPU_RHS_Q4C2D2CtoD(nContQP,nPasses,3,Qdistance12,TMParray1,&
    ...
    CASE(1101)  !Angmom(A= 1,B= 1,C= 0,D= 1) combi
        ...
        call SPVerticalRecurrenceGPUGen3A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP2Q1AtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Cexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
        ...
        call SPHorizontalRR_GPU_LHS_P2A1B1AtoB(nContQP,nPasses,4,&
            ...
            & TMParray1,lupri,iASync)
        !no Spherical Transformation LHS needed
        call SPHorizontalRR_GPU_RHS_Q1C0D1DtoC(nContQP,nPasses,9,Qdistance12,TMParray1,&
            & LOCALINTS,lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(1102)  !Angmom(A= 1,B= 1,C= 0,D= 2) combi
        ...
        call SPVerticalRecurrenceGPUGen4A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP2Q2AtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Cexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
        ...
        call SPHorizontalRR_GPU_LHS_P2A1B1AtoB(nContQP,nPasses,10,&
            ...
            & TMParray1,lupri,iASync)
        !no Spherical Transformation LHS needed
        call SPHorizontalRR_GPU_RHS_Q2C0D2DtoC(nContQP,nPasses,9,Qdistance12,TMParray1,&
            & TMParray2,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ2_maxAngC0(9,nContQP*nPasses,TMParray2,&
            & LOCALINTS,iASync)
    CASE(1112)  !Angmom(A= 1,B= 1,C= 1,D= 2) combi
        ...
        call SPVerticalRecurrenceGPUGen5D(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP2Q3DtoAGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Cexp,Bexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
         ...
         call SPPrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,10,20,iASync)
        call SPHorizontalRR_GPU_LHS_P2A1B1AtoB(nContQP,nPasses,20,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2,&
            & TMParray1,lupri,iASync)
        !no Spherical Transformation LHS needed
        call SPHorizontalRR_GPU_RHS_Q3C1D2DtoC(nContQP,nPasses,9,Qdistance12,TMParray1,&
            & TMParray2,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ3_maxAngC1(9,nContQP*nPasses,TMParray2,&
            & LOCALINTS,iASync)
    CASE(1120)  !Angmom(A= 1,B= 1,C= 2,D= 0) combi
        ...
        call SPHorizontalRR_GPU_LHS_P2A1B1AtoB(nContQP,nPasses,10,&
            ...
            & TMParray1,lupri,iASync)
        !no Spherical Transformation LHS needed
        call SPHorizontalRR_GPU_RHS_Q2C2D0CtoD(nContQP,nPasses,9,Qdistance12,TMParray1,&
            & TMParray2,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ2_maxAngC2(9,nContQP*nPasses,TMParray2,&
            & LOCALINTS,iASync)
    CASE(1121)  !Angmom(A= 1,B= 1,C= 2,D= 1) combi
        ...
        call SPHorizontalRR_GPU_LHS_P2A1B1AtoB(nContQP,nPasses,20,&
            ...
            & TMParray1,lupri,iASync)
        !no Spherical Transformation LHS needed
        call SPHorizontalRR_GPU_RHS_Q3C2D1CtoD(nContQP,nPasses,9,Qdistance12,TMParray1,&
            & TMParray2,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ3_maxAngC2(9,nContQP*nPasses,TMParray2,&
            & LOCALINTS,iASync)
    CASE(1122)  !Angmom(A= 1,B= 1,C= 2,D= 2) combi
        ...
        nContQP = nContQ*nContP
         ...
         call SPPrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,10,35,iASync)
        call SPHorizontalRR_GPU_LHS_P2A1B1AtoB(nContQP,nPasses,35,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2,&
            & TMParray1,lupri,iASync)
        !no Spherical Transformation LHS needed
        call SPHorizontalRR_GPU_RHS_Q4C2D2CtoD(nContQP,nPasses,9,Qdistance12,TMParray1,&
            & TMParray2,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ4_maxAngC2(9,nContQP*nPasses,TMParray2,&
            & LOCALINTS,iASync)
    CASE(1200)  !Angmom(A= 1,B= 2,C= 0,D= 0) combi
        ...
        nContQP = nContQ*nContP
         ...
         call SPPrimitiveContractionBGPUGen(TMParray2,TMParray1,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,20,1,iASync)
        call SPHorizontalRR_GPU_LHS_P3A1B2BtoA(nContQP,nPasses,1,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray1,&
            & TMParray2,lupri,iASync)
        call SPSphericalContractOBS1_GPU_maxAngP3_maxAngA1(1,nContQP*nPasses,TMParray2,&
            & LOCALINTS,iASync)
        !no need for RHS Horizontal recurrence relations 
        !no Spherical Transformation RHS needed
    CASE(1201)  !Angmom(A= 1,B= 2,C= 0,D= 1) combi
        ...
        call SPVerticalRecurrenceGPUGen4B(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP3Q1BtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Aexp,Cexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
         ...
         call SPPrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,20,4,iASync)
        call SPHorizontalRR_GPU_LHS_P3A1B2BtoA(nContQP,nPasses,4,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2,&
            & TMParray1,lupri,iASync)
        call SPSphericalContractOBS1_GPU_maxAngP3_maxAngA1(4,nContQP*nPasses,TMParray1,&
            & TMParray2,iASync)
        call SPHorizontalRR_GPU_RHS_Q1C0D1DtoC(nContQP,nPasses,15,Qdistance12,TMParray2,&
            & LOCALINTS,lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(1202)  !Angmom(A= 1,B= 2,C= 0,D= 2) combi
        ...
        call SPVerticalRecurrenceGPUGen5B(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP3Q2BtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Aexp,Cexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
         ...
         call SPPrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,20,10,iASync)
        call SPHorizontalRR_GPU_LHS_P3A1B2BtoA(nContQP,nPasses,10,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2,&
            & TMParray1,lupri,iASync)
        call SPSphericalContractOBS1_GPU_maxAngP3_maxAngA1(10,nContQP*nPasses,TMParray1,&
            & TMParray2,iASync)
        call SPHorizontalRR_GPU_RHS_Q2C0D2DtoC(nContQP,nPasses,15,Qdistance12,TMParray2,&
            & TMParray1,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ2_maxAngC0(15,nContQP*nPasses,TMParray1,&
            & LOCALINTS,iASync)
    CASE(1210)  !Angmom(A= 1,B= 2,C= 1,D= 0) combi
        ...
        call SPVerticalRecurrenceGPUGen4B(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP3Q1BtoCGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Aexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
    ...
    CASE(1211)  !Angmom(A= 1,B= 2,C= 1,D= 1) combi
        ...
        call SPVerticalRecurrenceGPUGen5B(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP3Q2BtoCGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Aexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
    ...
    CASE(1212)  !Angmom(A= 1,B= 2,C= 1,D= 2) combi
        ...
        call SPVerticalRecurrenceGPUGen6B(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP3Q3BtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Aexp,Cexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
         ...
         call SPPrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,20,20,iASync)
        call SPHorizontalRR_GPU_LHS_P3A1B2BtoA(nContQP,nPasses,20,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2,&
            & TMParray1,lupri,iASync)
        call SPSphericalContractOBS1_GPU_maxAngP3_maxAngA1(20,nContQP*nPasses,TMParray1,&
            & TMParray2,iASync)
        call SPHorizontalRR_GPU_RHS_Q3C1D2DtoC(nContQP,nPasses,15,Qdistance12,TMParray2,&
            & TMParray1,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ3_maxAngC1(15,nContQP*nPasses,TMParray1,&
            & LOCALINTS,iASync)
    ...
    CASE(1221)  !Angmom(A= 1,B= 2,C= 2,D= 1) combi
        ...
        call SPVerticalRecurrenceGPUGen6B(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP3Q3BtoCGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Aexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
    ...
    CASE(1222)  !Angmom(A= 1,B= 2,C= 2,D= 2) combi
        ...
        call SPVerticalRecurrenceGPUGen7C(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP3Q4CtoBGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Dexp,Aexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
         ...
         call SPPrimitiveContractionBGPUGen(TMParray1,TMParray2,nPrimP,nPrimQ,nPasses,&
               & nContP,nContQ,BCC,nPrimA,nContA,nPrimB,nContB,nPrimC,&
               & nContC,nPrimD,nContD,20,35,iASync)
        call SPHorizontalRR_GPU_LHS_P3A1B2BtoA(nContQP,nPasses,35,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2,&
            & TMParray1,lupri,iASync)
        call SPSphericalContractOBS1_GPU_maxAngP3_maxAngA1(35,nContQP*nPasses,TMParray1,&
            & TMParray2,iASync)
    ...
    CASE(2101)  !Angmom(A= 2,B= 1,C= 0,D= 1) combi
        ...
        call SPVerticalRecurrenceGPUGen4A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP3Q1AtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Cexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
    ...
    CASE(2102)  !Angmom(A= 2,B= 1,C= 0,D= 2) combi
        ...
        call SPVerticalRecurrenceGPUGen5A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP3Q2AtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Cexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
    ...
    CASE(2112)  !Angmom(A= 2,B= 1,C= 1,D= 2) combi
        ...
        call SPVerticalRecurrenceGPUGen6A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP3Q3AtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Cexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
    ...
    CASE(2201)  !Angmom(A= 2,B= 2,C= 0,D= 1) combi
        ...
        call SPVerticalRecurrenceGPUGen5A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP4Q1AtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Cexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
        ...
        call SPSphericalContractOBS1_GPU_maxAngP4_maxAngA2(4,nContQP*nPasses,TMParray1,&
            & TMParray2,iASync)
        call SPHorizontalRR_GPU_RHS_Q1C0D1DtoC(nContQP,nPasses,25,Qdistance12,TMParray2,&
            & LOCALINTS,lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(2202)  !Angmom(A= 2,B= 2,C= 0,D= 2) combi
        ...
        call SPVerticalRecurrenceGPUGen6A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP4Q2AtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Cexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
        ...
        call SPSphericalContractOBS1_GPU_maxAngP4_maxAngA2(10,nContQP*nPasses,TMParray1,&
            & TMParray2,iASync)
        call SPHorizontalRR_GPU_RHS_Q2C0D2DtoC(nContQP,nPasses,25,Qdistance12,TMParray2,&
            & TMParray1,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ2_maxAngC0(25,nContQP*nPasses,TMParray1,&
            & LOCALINTS,iASync)
    CASE(2212)  !Angmom(A= 2,B= 2,C= 1,D= 2) combi
        ...
        call SPVerticalRecurrenceGPUGen7A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP4Q3AtoDGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Cexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
        nContQP = nContQ*nContP
        ...
        call SPSphericalContractOBS1_GPU_maxAngP4_maxAngA2(20,nContQP*nPasses,TMParray1,&
            & TMParray2,iASync)
        call SPHorizontalRR_GPU_RHS_Q3C1D2DtoC(nContQP,nPasses,25,Qdistance12,TMParray2,&
            & TMParray1,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ3_maxAngC1(25,nContQP*nPasses,TMParray1,&
            & LOCALINTS,iASync)
    CASE DEFAULT
        call ichorquit('Unknown Case in ICI_GPU_OBS_Gen',-1)
    END SELECT
  end subroutine SPICI_GPU_OBS_Gen2
  
END module SPIchorEriCoulombintegralGPUOBSGeneralModGen2
