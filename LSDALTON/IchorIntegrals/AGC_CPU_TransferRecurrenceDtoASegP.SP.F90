module SPAGC_CPU_OBS_TRMODDtoASegP
 use IchorPrecisionMod
  
 CONTAINS
 subroutine SPTransferRecurrenceCPUP1Q2DtoASegP(nPasses,nPrimP,nPrimQ,reducedExponents,&
...
!$OMP END DO
 end subroutine SPTransferRecurrenceCPUP1Q2DtoASegP
 subroutine SPTransferRecurrenceCPUP1Q3DtoASegP(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & Pexp,Qexp,Pdistance12,Qdistance12,Cexp,Bexp,nPrimA,nPrimB,nPrimC,nPrimD,&
         & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,Aux,Aux2)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ,nPrimA,nPrimB,nPrimC,nPrimD,nAtomsA,nAtomsB,MaxPasses
...
!    Hopefully Tmp0 is small enough that it can be in cache. 
  ...
  ENDDO !iP = 1,nPrimP*nPasses
!$OMP END DO
 end subroutine SPTransferRecurrenceCPUP1Q3DtoASegP
 subroutine SPTransferRecurrenceCPUP2Q3DtoASegP(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & Pexp,Qexp,Pdistance12,Qdistance12,Cexp,Bexp,nPrimA,nPrimB,nPrimC,nPrimD,&
         & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,Aux,Aux2)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ,nPrimA,nPrimB,nPrimC,nPrimD,nAtomsA,nAtomsB,MaxPasses
...
!    Hopefully Tmp0 is small enough that it can be in cache. 
  ...
  ENDDO !iP = 1,nPrimP*nPasses
!$OMP END DO
 end subroutine SPTransferRecurrenceCPUP2Q3DtoASegP
end module
