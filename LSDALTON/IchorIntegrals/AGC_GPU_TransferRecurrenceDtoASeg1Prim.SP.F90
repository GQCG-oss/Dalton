module SPAGC_GPU_OBS_TRMODDtoASeg1Prim
 use IchorPrecisionMod
  
 CONTAINS
 subroutine SPTransferRecurrenceGPUP1Q2DtoASeg1Prim(nPasses,nPrimP,nPrimQ,reducedExponents,&
...
!$ACC LOOP SEQ
     ...
     ENDDO
  ENDDO !iP = 1,nPasses
 end subroutine SPTransferRecurrenceGPUP1Q2DtoASeg1Prim
 subroutine SPTransferRecurrenceGPUP1Q3DtoASeg1Prim(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & Pexp,Qexp,Pdistance12,Qdistance12,Cexp,Bexp,nPrimA,nPrimB,nPrimC,nPrimD,&
         & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,Aux,Aux2,iASync)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ,nPrimA,nPrimB,nPrimC,nPrimD,nAtomsA,nAtomsB,MaxPasses
...
!$ACC LOOP SEQ
     ...
     ENDDO
  ENDDO !iP = 1,nPasses
 end subroutine SPTransferRecurrenceGPUP1Q3DtoASeg1Prim
 subroutine SPTransferRecurrenceGPUP2Q3DtoASeg1Prim(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & Pexp,Qexp,Pdistance12,Qdistance12,Cexp,Bexp,nPrimA,nPrimB,nPrimC,nPrimD,&
         & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,Aux,Aux2,iASync)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ,nPrimA,nPrimB,nPrimC,nPrimD,nAtomsA,nAtomsB,MaxPasses
...
!$ACC LOOP SEQ
     ...
     ENDDO
  ENDDO !iP = 1,nPasses
 end subroutine SPTransferRecurrenceGPUP2Q3DtoASeg1Prim
end module
