...
subroutine HorizontalRR_CPU_LHS_P2A1B1BtoA(nContQP,nPasses,nTUVQ,&
         & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,AuxCont,ThetaP,lupri)
  implicit none
  integer,intent(in) :: nContQP,nPasses,nTUVQ,lupri,MaxPasses,nAtomsA,nAtomsB
  real(realk),intent(in) :: Pdistance12(3,nAtomsA,nAtomsB)
...
!$OMP         iAtomApass,iAtomBpass,Pdistance12,AuxCont,ThetaP)
  ...
  ENDDO
!$OMP END PARALLEL DO
end subroutine HorizontalRR_CPU_LHS_P2A1B1BtoA

subroutine HorizontalRR_CPU_LHS_P3A0B3BtoA(nContQP,nPasses,nTUVQ,&
         & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,AuxCont,ThetaP,lupri)
  implicit none
  integer,intent(in) :: nContQP,nPasses,nTUVQ,lupri,MaxPasses,nAtomsA,nAtomsB
  real(realk),intent(in) :: Pdistance12(3,nAtomsA,nAtomsB)
...
!$OMP         AuxCont,ThetaP)
  ...
  ENDDO
!$OMP END PARALLEL DO
end subroutine HorizontalRR_CPU_LHS_P3A0B3BtoA
...
subroutine HorizontalRR_CPU_LHS_P4A1B3BtoA(nContQP,nPasses,nTUVQ,&
         & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,AuxCont,ThetaP,lupri)
  implicit none
  integer,intent(in) :: nContQP,nPasses,nTUVQ,lupri,MaxPasses,nAtomsA,nAtomsB
  real(realk),intent(in) :: Pdistance12(3,nAtomsA,nAtomsB)
...
!$OMP         iAtomApass,iAtomBpass,Pdistance12,AuxCont,ThetaP)
  ...
  ENDDO
!$OMP END PARALLEL DO
end subroutine HorizontalRR_CPU_LHS_P4A1B3BtoA

subroutine HorizontalRR_CPU_LHS_P4A2B2BtoA(nContQP,nPasses,nTUVQ,&
         & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,AuxCont,ThetaP,lupri)
  implicit none
  integer,intent(in) :: nContQP,nPasses,nTUVQ,lupri,MaxPasses,nAtomsA,nAtomsB
  real(realk),intent(in) :: Pdistance12(3,nAtomsA,nAtomsB)
...
!$OMP         iAtomApass,iAtomBpass,Pdistance12,AuxCont,ThetaP)
  ...
  ENDDO
!$OMP END PARALLEL DO
end subroutine HorizontalRR_CPU_LHS_P4A2B2BtoA

subroutine HorizontalRR_CPU_LHS_P5A2B3BtoA(nContQP,nPasses,nTUVQ,&
         & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,AuxCont,ThetaP,lupri)
  implicit none
  integer,intent(in) :: nContQP,nPasses,nTUVQ,lupri,MaxPasses,nAtomsA,nAtomsB
  real(realk),intent(in) :: Pdistance12(3,nAtomsA,nAtomsB)
...
!$OMP         iAtomApass,iAtomBpass,Pdistance12,AuxCont,ThetaP)
  ...
  ENDDO
!$OMP END PARALLEL DO
end subroutine HorizontalRR_CPU_LHS_P5A2B3BtoA

subroutine HorizontalRR_CPU_LHS_P6A3B3BtoA(nContQP,nPasses,nTUVQ,&
         & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,AuxCont,ThetaP,lupri)
  implicit none
  integer,intent(in) :: nContQP,nPasses,nTUVQ,lupri,MaxPasses,nAtomsA,nAtomsB
  real(realk),intent(in) :: Pdistance12(3,nAtomsA,nAtomsB)
...
!$OMP         iAtomApass,iAtomBpass,Pdistance12,AuxCont,ThetaP)
  ...
  ENDDO
!$OMP END PARALLEL DO
end subroutine HorizontalRR_CPU_LHS_P6A3B3BtoA
...
subroutine HorizontalRR_GPU_LHS_P2A1B1BtoA(nContQP,nPasses,nTUVQ,&
         & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,AuxCont,ThetaP,lupri)
  implicit none
  integer,intent(in) :: nContQP,nPasses,nTUVQ,lupri,MaxPasses,nAtomsA,nAtomsB
  real(realk),intent(in) :: Pdistance12(3,nAtomsA,nAtomsB)
...
!$ACC         iAtomApass,iAtomBpass,Pdistance12,AuxCont,ThetaP)
  DO iP = 1,nTUVQ*nContQP*nPasses
   ...
   Zab = -Pdistance12(3,iAtomA,iAtomB)
     ...
     ThetaP( 4, 4      ,iP) = AuxCont(10      ,iP)+ Zab*AuxCont( 4,      ip) 
  ENDDO
end subroutine HorizontalRR_GPU_LHS_P2A1B1BtoA

subroutine HorizontalRR_GPU_LHS_P3A0B3BtoA(nContQP,nPasses,nTUVQ,&
         & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,AuxCont,ThetaP,lupri)
  implicit none
  integer,intent(in) :: nContQP,nPasses,nTUVQ,lupri,MaxPasses,nAtomsA,nAtomsB
  real(realk),intent(in) :: Pdistance12(3,nAtomsA,nAtomsB)
...
!$ACC         AuxCont,ThetaP)
  DO iP = 1,nTUVQ*nContQP*nPasses
     ...
     ENDDO
  ENDDO
end subroutine HorizontalRR_GPU_LHS_P3A0B3BtoA
...
subroutine HorizontalRR_GPU_LHS_P4A1B3BtoA(nContQP,nPasses,nTUVQ,&
         & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,AuxCont,ThetaP,lupri)
  implicit none
  integer,intent(in) :: nContQP,nPasses,nTUVQ,lupri,MaxPasses,nAtomsA,nAtomsB
  real(realk),intent(in) :: Pdistance12(3,nAtomsA,nAtomsB)
...
!$ACC         iAtomApass,iAtomBpass,Pdistance12,AuxCont,ThetaP)
  DO iP = 1,nTUVQ*nContQP*nPasses
   ...
   Zab = -Pdistance12(3,iAtomA,iAtomB)
     ...
     ThetaP( 4,20      ,iP) = AuxCont(35      ,iP)+ Zab*AuxCont(20,      ip) 
  ENDDO
end subroutine HorizontalRR_GPU_LHS_P4A1B3BtoA

subroutine HorizontalRR_GPU_LHS_P4A2B2BtoA(nContQP,nPasses,nTUVQ,&
         & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,AuxCont,ThetaP,lupri)
  implicit none
  integer,intent(in) :: nContQP,nPasses,nTUVQ,lupri,MaxPasses,nAtomsA,nAtomsB
  real(realk),intent(in) :: Pdistance12(3,nAtomsA,nAtomsB)
...
!$ACC         iAtomApass,iAtomBpass,Pdistance12,AuxCont,ThetaP)
  DO iP = 1,nTUVQ*nContQP*nPasses
   ...
   Zab = -Pdistance12(3,iAtomA,iAtomB)
     ...
     ThetaP(10,10      ,iP) = Tmp1( 4,20)+ Zab*Tmp1( 4,10)
  ENDDO
end subroutine HorizontalRR_GPU_LHS_P4A2B2BtoA

subroutine HorizontalRR_GPU_LHS_P5A2B3BtoA(nContQP,nPasses,nTUVQ,&
         & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,AuxCont,ThetaP,lupri)
  implicit none
  integer,intent(in) :: nContQP,nPasses,nTUVQ,lupri,MaxPasses,nAtomsA,nAtomsB
  real(realk),intent(in) :: Pdistance12(3,nAtomsA,nAtomsB)
...
!$ACC         iAtomApass,iAtomBpass,Pdistance12,AuxCont,ThetaP)
  DO iP = 1,nTUVQ*nContQP*nPasses
   ...
   Zab = -Pdistance12(3,iAtomA,iAtomB)
     ...
     ThetaP(10,20      ,iP) = Tmp1( 4,35)+ Zab*Tmp1( 4,20)
  ENDDO
end subroutine HorizontalRR_GPU_LHS_P5A2B3BtoA

subroutine HorizontalRR_GPU_LHS_P6A3B3BtoA(nContQP,nPasses,nTUVQ,&
         & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,AuxCont,ThetaP,lupri)
  implicit none
  integer,intent(in) :: nContQP,nPasses,nTUVQ,lupri,MaxPasses,nAtomsA,nAtomsB
  real(realk),intent(in) :: Pdistance12(3,nAtomsA,nAtomsB)
...
!$ACC         iAtomApass,iAtomBpass,Pdistance12,AuxCont,ThetaP)
  DO iP = 1,nTUVQ*nContQP*nPasses
   ...
   Zab = -Pdistance12(3,iAtomA,iAtomB)
     ...
     ThetaP(20,20      ,iP) = Tmp2(10,35)+ Zab*Tmp2(10,20)
  ENDDO
end subroutine HorizontalRR_GPU_LHS_P6A3B3BtoA
end module
