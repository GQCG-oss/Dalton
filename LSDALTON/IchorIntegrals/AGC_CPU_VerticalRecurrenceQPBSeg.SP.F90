module SPAGC_CPU_OBS_VERTICALRECURRENCEMODBSeg
 use IchorPrecisionMod
  
 CONTAINS


subroutine SPVerticalRecurrenceCPUSeg1B(nPassP,nPrimP,nPrimQ,&
...
!$OMP         iP,iPrimQ,iPrimP,iPrimQP,iPassP)
  ...
  ENDDO !iP = 1,nPassP
!$OMP END DO
end subroutine SPVerticalRecurrenceCPUSeg1B

subroutine SPVerticalRecurrenceCPUSeg2B(nPassP,nPrimP,nPrimQ,&
...
subroutine SPVerticalRecurrenceCPUSeg3B(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Pexp,Bcenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
