module SPIchorEriCoulombintegralCPUOBSGeneralModSegQSize
...
private   
public :: SPICI_CPU_OBS_general_sizeSegQ  
  
CONTAINS
  
  subroutine SPICI_CPU_OBS_general_sizeSegQ(TMParray1maxsize,&
    ...
    CASE DEFAULT
     call SPICI_CPU_McM_general_size(TMParray1maxsize,&
         ...
         & .FALSE.,.TRUE.)
    END SELECT
  end subroutine SPICI_CPU_OBS_general_sizeSegQ
END module SPIchorEriCoulombintegralCPUOBSGeneralModSegQSize
