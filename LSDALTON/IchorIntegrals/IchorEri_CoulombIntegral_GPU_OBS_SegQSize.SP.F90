module SPIchorEriCoulombintegralGPUOBSGeneralModSegQSize
...
private   
public :: SPICI_GPU_OBS_general_sizeSegQ  
  
CONTAINS
  
  subroutine SPICI_GPU_OBS_general_sizeSegQ(TMParray1maxsize,&
    ...
    END SELECT
  end subroutine SPICI_GPU_OBS_general_sizeSegQ
END module SPIchorEriCoulombintegralGPUOBSGeneralModSegQSize
