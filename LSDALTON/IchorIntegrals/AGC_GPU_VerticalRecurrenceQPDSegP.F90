MODULE AGC_GPU_OBS_VERTICALRECURRENCEMODDSegP
 use IchorPrecisionModule
  
 CONTAINS


subroutine VerticalRecurrenceGPUSegP1D(nPassP,nPrimP,nPrimQ,&
...
end subroutine VerticalRecurrenceGPUSegP1D

subroutine VerticalRecurrenceGPUSegP2D(nPassP,nPrimP,nPrimQ,&
...
subroutine VerticalRecurrenceGPUSegP3D(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Dcenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
