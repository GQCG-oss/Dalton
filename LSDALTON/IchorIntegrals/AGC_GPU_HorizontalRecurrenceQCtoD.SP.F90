module SPAGC_GPU_OBS_HorizontalRecurrenceRHSModCtoD
 use IchorPrecisionMod
  
 CONTAINS

!Transfer angmom from C to D
subroutine SPHorizontalRR_GPU_RHS_Q1C1D0CtoD(nContPQ,nPasses,nlmP,&
         & Qdistance12,ThetaP2,ThetaP,lupri,iASync)
  implicit none
  integer,intent(in) :: nContPQ,nPasses,nlmP,lupri
  real(reals),intent(in) :: Qdistance12(3)
  real(reals),intent(in) :: ThetaP2(nContPQ*nPasses,nlmP,    4)
  real(reals),intent(inout) :: ThetaP(nContPQ*nPasses,nlmP,    2:    4,    1:    1)
...
!$ACC PRESENT(nPasses,ThetaP,ThetaP2) ASYNC(iASync)
  DO iP = 1,nContPQ*nPasses
    ...
    ENDDO
  ENDDO
end subroutine SPHorizontalRR_GPU_RHS_Q1C1D0CtoD

!Transfer angmom from C to D
subroutine SPHorizontalRR_GPU_RHS_Q2C1D1CtoD(nContPQ,nPasses,nlmP,&
         & Qdistance12,ThetaP2,ThetaP,lupri,iASync)
  implicit none
  integer,intent(in) :: nContPQ,nPasses,nlmP,lupri
  real(reals),intent(in) :: Qdistance12(3)
  real(reals),intent(in) :: ThetaP2(nContPQ*nPasses,nlmP,   10)
  real(reals),intent(inout) :: ThetaP(nContPQ*nPasses,nlmP,    2:    4,    2:    4)
  integer(kind=acckind),intent(in) :: iASync
  !Local variables
...
!$ACC PRESENT(nPasses,Qdistance12,ThetaP,ThetaP2) ASYNC(iASync)
  DO iP = 1,nContPQ*nPasses
   ...
   Zcd = Qdistance12(3)
    ...
    ENDDO
  ENDDO
end subroutine SPHorizontalRR_GPU_RHS_Q2C1D1CtoD

!Transfer angmom from C to D
subroutine SPHorizontalRR_GPU_RHS_Q2C2D0CtoD(nContPQ,nPasses,nlmP,&
         & Qdistance12,ThetaP2,ThetaP,lupri,iASync)
  implicit none
  integer,intent(in) :: nContPQ,nPasses,nlmP,lupri
  real(reals),intent(in) :: Qdistance12(3)
  real(reals),intent(in) :: ThetaP2(nContPQ*nPasses,nlmP,   10)
  real(reals),intent(inout) :: ThetaP(nContPQ*nPasses,nlmP,    5:   10,    1:    1)
  integer(kind=acckind),intent(in) :: iASync
  !Local variables
  integer :: iP,ilmP,iTUVC
!  real(reals) :: Tmp(nTUVA,nTUVB) ordering
...
!$ACC PRESENT(nPasses,ThetaP,ThetaP2) ASYNC(iASync)
  DO iP = 1,nContPQ*nPasses
    ...
    ENDDO
  ENDDO
end subroutine SPHorizontalRR_GPU_RHS_Q2C2D0CtoD

!Transfer angmom from C to D
subroutine SPHorizontalRR_GPU_RHS_Q3C2D1CtoD(nContPQ,nPasses,nlmP,&
         & Qdistance12,ThetaP2,ThetaP,lupri,iASync)
  implicit none
  integer,intent(in) :: nContPQ,nPasses,nlmP,lupri
  real(reals),intent(in) :: Qdistance12(3)
  real(reals),intent(in) :: ThetaP2(nContPQ*nPasses,nlmP,   20)
  real(reals),intent(inout) :: ThetaP(nContPQ*nPasses,nlmP,    5:   10,    2:    4)
  integer(kind=acckind),intent(in) :: iASync
  !Local variables
  integer :: iP,iC,iPassQ,ilmP,iTUVC
  real(reals) :: Xcd,Ycd,Zcd
...
!$ACC PRESENT(nPasses,Qdistance12,ThetaP,ThetaP2) ASYNC(iASync)
  DO iP = 1,nContPQ*nPasses
   ...
   Zcd = Qdistance12(3)
    ...
    ENDDO
  ENDDO
end subroutine SPHorizontalRR_GPU_RHS_Q3C2D1CtoD

!Transfer angmom from C to D
subroutine SPHorizontalRR_GPU_RHS_Q4C2D2CtoD(nContPQ,nPasses,nlmP,&
         & Qdistance12,ThetaP2,ThetaP,lupri,iASync)
  implicit none
  integer,intent(in) :: nContPQ,nPasses,nlmP,lupri
  real(reals),intent(in) :: Qdistance12(3)
  real(reals),intent(in) :: ThetaP2(nContPQ*nPasses,nlmP,   35)
  real(reals),intent(inout) :: ThetaP(nContPQ*nPasses,nlmP,    5:   10,    5:   10)
  integer(kind=acckind),intent(in) :: iASync
  !Local variables
  integer :: iP,iC,iPassQ,ilmP,iTUVC
  real(reals) :: Xcd,Ycd,Zcd
...
!$ACC PRESENT(nPasses,Qdistance12,ThetaP,ThetaP2) ASYNC(iASync)
  DO iP = 1,nContPQ*nPasses
   ...
   Zcd = Qdistance12(3)
    ...
    ENDDO
  ENDDO
end subroutine SPHorizontalRR_GPU_RHS_Q4C2D2CtoD
end module
