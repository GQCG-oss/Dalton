module SPAGC_GPU_OBS_VERTICALRECURRENCEMODDSegQ
 use IchorPrecisionMod
  
 CONTAINS


subroutine SPVerticalRecurrenceGPUSegQ1D(nPassP,nPrimP,nPrimQ,&
...
end subroutine SPVerticalRecurrenceGPUSegQ1D

subroutine SPVerticalRecurrenceGPUSegQ2D(nPassP,nPrimP,nPrimQ,&
...
subroutine SPVerticalRecurrenceGPUSegQ3D(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Dcenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray,iASync)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
