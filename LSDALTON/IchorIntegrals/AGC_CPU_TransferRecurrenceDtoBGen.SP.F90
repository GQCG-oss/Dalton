module SPAGC_CPU_OBS_TRMODDtoBGen
 use IchorPrecisionMod
  
 CONTAINS
 subroutine SPTransferRecurrenceCPUP1Q2DtoBGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
...
!$OMP END DO
 end subroutine SPTransferRecurrenceCPUP1Q2DtoBGen
 subroutine SPTransferRecurrenceCPUP1Q3DtoBGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & Pexp,Qexp,Pdistance12,Qdistance12,Cexp,Aexp,nPrimA,nPrimB,nPrimC,nPrimD,&
         & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,Aux,Aux2)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ,nPrimA,nPrimB,nPrimC,nPrimD,nAtomsA,nAtomsB,MaxPasses
...
!    Hopefully Tmp0 is small enough that it can be in cache. 
  ...
  ENDDO !iP = 1,nPrimQ*nPrimP*nPasses
!$OMP END DO
 end subroutine SPTransferRecurrenceCPUP1Q3DtoBGen
 subroutine SPTransferRecurrenceCPUP2Q3DtoBGen(nPasses,nPrimP,nPrimQ,reducedExponents,&
         & Pexp,Qexp,Pdistance12,Qdistance12,Cexp,Aexp,nPrimA,nPrimB,nPrimC,nPrimD,&
         & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,Aux,Aux2)
  implicit none
  integer,intent(in) :: nPasses,nPrimP,nPrimQ,nPrimA,nPrimB,nPrimC,nPrimD,nAtomsA,nAtomsB,MaxPasses
...
!    Hopefully Tmp0 is small enough that it can be in cache. 
  ...
  ENDDO !iP = 1,nPrimQ*nPrimP*nPasses
!$OMP END DO
 end subroutine SPTransferRecurrenceCPUP2Q3DtoBGen
end module
