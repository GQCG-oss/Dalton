module SPIchorEriCoulombintegralGPUOBSGeneralModSegP
...
private   
public :: SPICI_GPU_OBS_SegP
  
CONTAINS
  
  
  subroutine SPICI_GPU_OBS_SegP(nPrimA,nPrimB,nPrimC,nPrimD,&
...
!    nlmD = 2*AngmomD+1
    ...
    CASE(   0)  !Angmom(A= 0,B= 0,C= 0,D= 0) combi
        call SPVerticalRecurrenceGPUSegP0(nPasses,nPrimP,nPrimQ,&
        ...
        !No reason for the Electron Transfer Recurrence Relation 
         ...
         call SPPrimitiveContractionDGPUSegP(TMParray1,LOCALINTS,nPrimP,nPrimQ,nPasses,&
    ...
    CASE(1000)  !Angmom(A= 1,B= 0,C= 0,D= 0) combi
        call SPVerticalRecurrenceGPUSegP1A(nPasses,nPrimP,nPrimQ,reducedExponents,&
        ...
        call SPHorizontalRR_GPU_LHS_P1A1B0AtoB(nContQ,nPasses,1,&
    ...
    CASE(1010)  !Angmom(A= 1,B= 0,C= 1,D= 0) combi
        ...
        call SPVerticalRecurrenceGPUGen2A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP1Q1AtoCSegP(nPasses,nPrimP,nPrimQ,reducedExponents,&
    ...
    CASE(1100)  !Angmom(A= 1,B= 1,C= 0,D= 0) combi
        call SPBuildRJ000GPUGen2(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & TABFJW,Pcent,Qcent,IatomApass,IatomBpass,&
               & MaxPasses,nAtomsA,nAtomsB,TMParray2,iASync)
        call SPVerticalRecurrenceGPUSegP2A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & TMParray2,Pexp,Acenter,Pcent,Qcent,integralPrefactor,&
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        !No reason for the Electron Transfer Recurrence Relation 
        ...
        call SPHorizontalRR_GPU_LHS_P2A1B1AtoB(nContQ,nPasses,1,&
    ...
    CASE(1110)  !Angmom(A= 1,B= 1,C= 1,D= 0) combi
        ...
        call SPVerticalRecurrenceGPUGen3A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP2Q1AtoCSegP(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
         call SPPrimitiveContractionCGPUSegP(TMParray2,TMParray1,nPrimP,nPrimQ,nPasses,&
        ...
        call SPHorizontalRR_GPU_LHS_P2A1B1AtoB(nContQ,nPasses,4,&
            ...
            & TMParray1,lupri,iASync)
        !no Spherical Transformation LHS needed
        call SPHorizontalRR_GPU_RHS_Q1C1D0CtoD(nContQ,nPasses,9,Qdistance12,TMParray1,&
            & LOCALINTS,lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(1111)  !Angmom(A= 1,B= 1,C= 1,D= 1) combi
        ...
        call SPHorizontalRR_GPU_LHS_P2A1B1AtoB(nContQ,nPasses,10,&
            ...
            & TMParray1,lupri,iASync)
        !no Spherical Transformation LHS needed
        call SPHorizontalRR_GPU_RHS_Q2C1D1CtoD(nContQ,nPasses,9,Qdistance12,TMParray1,&
            & LOCALINTS,lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(2000)  !Angmom(A= 2,B= 0,C= 0,D= 0) combi
        ...
        !No reason for the Electron Transfer Recurrence Relation 
         ...
         call SPPrimitiveContractionDGPUSegP(TMParray2,TMParray1,nPrimP,nPrimQ,nPasses,&
               & nContQ,DCC,nPrimC,nContC,nPrimD,nContD,10,1,iASync)
        call SPHorizontalRR_GPU_LHS_P2A2B0AtoB(nContQ,nPasses,1,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray1,&
            & TMParray2,lupri,iASync)
        call SPSphericalContractOBS1_GPU_maxAngP2_maxAngA2(1,nContQ*nPasses,TMParray2,&
            & LOCALINTS,iASync)
        !no need for RHS Horizontal recurrence relations 
        !no Spherical Transformation RHS needed
    ...
    CASE(2022)  !Angmom(A= 2,B= 0,C= 2,D= 2) combi
        ...
        call SPHorizontalRR_GPU_LHS_P2A2B0AtoB(nContQ,nPasses,35,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2,&
            & TMParray1,lupri,iASync)
        call SPSphericalContractOBS1_GPU_maxAngP2_maxAngA2(35,nContQ*nPasses,TMParray1,&
            & TMParray2,iASync)
    ...
    CASE(2100)  !Angmom(A= 2,B= 1,C= 0,D= 0) combi
        call SPBuildRJ000GPUGen3(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & TABFJW,Pcent,Qcent,IatomApass,IatomBpass,&
               & MaxPasses,nAtomsA,nAtomsB,TMParray2,iASync)
        call SPVerticalRecurrenceGPUSegP3A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & TMParray2,Pexp,Acenter,Pcent,Qcent,integralPrefactor,&
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        !No reason for the Electron Transfer Recurrence Relation 
        ...
        call SPHorizontalRR_GPU_LHS_P3A2B1AtoB(nContQ,nPasses,1,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray1,&
            & TMParray2,lupri,iASync)
        call SPSphericalContractOBS1_GPU_maxAngP3_maxAngA2(1,nContQ*nPasses,TMParray2,&
            & LOCALINTS,iASync)
        !no need for RHS Horizontal recurrence relations 
        !no Spherical Transformation RHS needed
    CASE(2110)  !Angmom(A= 2,B= 1,C= 1,D= 0) combi
        ...
        call SPVerticalRecurrenceGPUGen4A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP3Q1AtoCSegP(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
         call SPPrimitiveContractionCGPUSegP(TMParray2,TMParray1,nPrimP,nPrimQ,nPasses,&
    ...
    CASE(2111)  !Angmom(A= 2,B= 1,C= 1,D= 1) combi
        ...
        call SPVerticalRecurrenceGPUGen5A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP3Q2AtoCSegP(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
         call SPPrimitiveContractionCGPUSegP(TMParray2,TMParray1,nPrimP,nPrimQ,nPasses,&
    ...
    CASE(2121)  !Angmom(A= 2,B= 1,C= 2,D= 1) combi
        ...
        call SPVerticalRecurrenceGPUGen6A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP3Q3AtoCSegP(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
         call SPPrimitiveContractionCGPUSegP(TMParray2,TMParray1,nPrimP,nPrimQ,nPasses,&
    ...
    CASE(2122)  !Angmom(A= 2,B= 1,C= 2,D= 2) combi
        ...
        call SPVerticalRecurrenceGPUGen7C(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP3Q4CtoASegP(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Dexp,Bexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
         call SPPrimitiveContractionCGPUSegP(TMParray2,TMParray1,nPrimP,nPrimQ,nPasses,&
        ...
        call SPHorizontalRR_GPU_LHS_P3A2B1AtoB(nContQ,nPasses,35,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2,&
            & TMParray1,lupri,iASync)
        call SPSphericalContractOBS1_GPU_maxAngP3_maxAngA2(35,nContQ*nPasses,TMParray1,&
            & TMParray2,iASync)
    ...
    CASE(2200)  !Angmom(A= 2,B= 2,C= 0,D= 0) combi
        call SPBuildRJ000GPUGen4(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & TABFJW,Pcent,Qcent,IatomApass,IatomBpass,&
               & MaxPasses,nAtomsA,nAtomsB,TMParray2,iASync)
        call SPVerticalRecurrenceGPUSegP4A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & TMParray2,Pexp,Acenter,Pcent,Qcent,integralPrefactor,&
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        !No reason for the Electron Transfer Recurrence Relation 
        ...
        call SPHorizontalRR_GPU_LHS_P4A2B2AtoB(nContQ,nPasses,1,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray1,&
            & TMParray2,lupri,iASync)
        call SPSphericalContractOBS1_GPU_maxAngP4_maxAngA2(1,nContQ*nPasses,TMParray2,&
            & LOCALINTS,iASync)
        !no need for RHS Horizontal recurrence relations 
        !no Spherical Transformation RHS needed
    CASE(2210)  !Angmom(A= 2,B= 2,C= 1,D= 0) combi
        ...
        call SPVerticalRecurrenceGPUGen5A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP4Q1AtoCSegP(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
         call SPPrimitiveContractionCGPUSegP(TMParray2,TMParray1,nPrimP,nPrimQ,nPasses,&
        ...
        call SPSphericalContractOBS1_GPU_maxAngP4_maxAngA2(4,nContQ*nPasses,TMParray1,&
            & TMParray2,iASync)
        call SPHorizontalRR_GPU_RHS_Q1C1D0CtoD(nContQ,nPasses,25,Qdistance12,TMParray2,&
            & LOCALINTS,lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(2211)  !Angmom(A= 2,B= 2,C= 1,D= 1) combi
        ...
        call SPVerticalRecurrenceGPUGen6A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP4Q2AtoCSegP(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
         call SPPrimitiveContractionCGPUSegP(TMParray2,TMParray1,nPrimP,nPrimQ,nPasses,&
        ...
        call SPSphericalContractOBS1_GPU_maxAngP4_maxAngA2(10,nContQ*nPasses,TMParray1,&
            & TMParray2,iASync)
        call SPHorizontalRR_GPU_RHS_Q2C1D1CtoD(nContQ,nPasses,25,Qdistance12,TMParray2,&
            & LOCALINTS,lupri,iASync)
        !no Spherical Transformation RHS needed
    CASE(2220)  !Angmom(A= 2,B= 2,C= 2,D= 0) combi
        ...
        call SPSphericalContractOBS1_GPU_maxAngP4_maxAngA2(10,nContQ*nPasses,TMParray1,&
            & TMParray2,iASync)
        call SPHorizontalRR_GPU_RHS_Q2C2D0CtoD(nContQ,nPasses,25,Qdistance12,TMParray2,&
            & TMParray1,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ2_maxAngC2(25,nContQ*nPasses,TMParray1,&
            & LOCALINTS,iASync)
    CASE(2221)  !Angmom(A= 2,B= 2,C= 2,D= 1) combi
        ...
        call SPVerticalRecurrenceGPUGen7A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP4Q3AtoCSegP(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
         call SPPrimitiveContractionCGPUSegP(TMParray2,TMParray1,nPrimP,nPrimQ,nPasses,&
        ...
        call SPSphericalContractOBS1_GPU_maxAngP4_maxAngA2(20,nContQ*nPasses,TMParray1,&
            & TMParray2,iASync)
        call SPHorizontalRR_GPU_RHS_Q3C2D1CtoD(nContQ,nPasses,25,Qdistance12,TMParray2,&
            & TMParray1,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ3_maxAngC2(25,nContQ*nPasses,TMParray1,&
            & LOCALINTS,iASync)
    CASE(2222)  !Angmom(A= 2,B= 2,C= 2,D= 2) combi
        ...
        call SPVerticalRecurrenceGPUGen8A(nPasses,nPrimP,nPrimQ,reducedExponents,&
               ...
               & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,&
               & TMParray1,iASync)
        call SPTransferRecurrenceGPUP4Q4AtoCSegP(nPasses,nPrimP,nPrimQ,reducedExponents,&
               & Pexp,Qexp,Pdistance12,Qdistance12,Bexp,Dexp,nPrimA,nPrimB,nPrimC,nPrimD,&
               & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,&
               & TMParray1,TMParray2,iASync)
         call SPPrimitiveContractionCGPUSegP(TMParray2,TMParray1,nPrimP,nPrimQ,nPasses,&
        ...
        call SPHorizontalRR_GPU_LHS_P4A2B2AtoB(nContQ,nPasses,35,&
            & Pdistance12,MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass,TMParray2,&
            & TMParray1,lupri,iASync)
        call SPSphericalContractOBS1_GPU_maxAngP4_maxAngA2(35,nContQ*nPasses,TMParray1,&
            & TMParray2,iASync)
        call SPHorizontalRR_GPU_RHS_Q4C2D2CtoD(nContQ,nPasses,25,Qdistance12,TMParray2,&
            & TMParray1,lupri,iASync)
        call SPSphericalContractOBS2_GPU_maxAngQ4_maxAngC2(25,nContQ*nPasses,TMParray1,&
            & LOCALINTS,iASync)
    CASE DEFAULT
        call ichorquit('Unknown Case in ICI_GPU_OBS_SegP',-1)
    END SELECT
  end subroutine SPICI_GPU_OBS_SegP
  
END module SPIchorEriCoulombintegralGPUOBSGeneralModSegP
