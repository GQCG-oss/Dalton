module SPAGC_GPU_OBS_Sphcontract1Mod
!Automatic Generated Code (AGC) by runSphContractOBS1.f90 in tools directory
use IchorPrecisionMod
  
 CONTAINS
  
 subroutine SPSphericalContractOBS1_GPU_maxAngP2_maxAngA2(ijkQcart,nContPasses,IN,OUT,iASync)
  implicit none
  integer,intent(in)        :: ijkQcart,nContPasses
  real(reals),intent(in)    :: IN(nContPasses,  6,ijkQcart)
  real(reals),intent(inout) :: OUT(nContPasses,  5,ijkQcart)
...
!$ACC PARALLEL LOOP PRIVATE(iP,ijkQ) PRESENT(IN,OUT) ASYNC(iASync)
  DO iP=1,nContPasses
   ...
   ENDDO
  ENDDO
end subroutine SPSphericalContractOBS1_GPU_maxAngP2_maxAngA2 
  
  
 subroutine SPSphericalContractOBS1_GPU_maxAngP2_maxAngA0(ijkQcart,nContPasses,IN,OUT,iASync)
  implicit none
  integer,intent(in)        :: ijkQcart,nContPasses
  real(reals),intent(in)    :: IN(nContPasses,  6,ijkQcart)
  real(reals),intent(inout) :: OUT(nContPasses,  5,ijkQcart)
...
!$ACC PARALLEL LOOP PRIVATE(iP,ijkQ) PRESENT(IN,OUT) ASYNC(iASync)
  DO iP=1,nContPasses
   ...
   ENDDO
  ENDDO
end subroutine SPSphericalContractOBS1_GPU_maxAngP2_maxAngA0 
  
  
 subroutine SPSphericalContractOBS1_GPU_maxAngP3_maxAngA2(ijkQcart,nContPasses,IN,OUT,iASync)
  implicit none
  integer,intent(in)        :: ijkQcart,nContPasses
  real(reals),intent(in)    :: IN(nContPasses, 18,ijkQcart)
  real(reals),intent(inout) :: OUT(nContPasses, 15,ijkQcart)
  integer(kind=acckind),intent(in) :: iASync
  integer :: iP,ijkQ
  real(reals),parameter :: SPHMAT1_3      =   -2.8867513459481292E-01_reals
  real(reals),parameter :: SPHMAT1_5      =    5.0000000000000000E-01_reals
...
!$ACC PARALLEL LOOP PRIVATE(iP,ijkQ) PRESENT(IN,OUT) ASYNC(iASync)
  DO iP=1,nContPasses
   ...
   ENDDO
  ENDDO
end subroutine SPSphericalContractOBS1_GPU_maxAngP3_maxAngA2 
  
  
 subroutine SPSphericalContractOBS1_GPU_maxAngP3_maxAngA1(ijkQcart,nContPasses,IN,OUT,iASync)
  implicit none
  integer,intent(in)        :: ijkQcart,nContPasses
  real(reals),intent(in)    :: IN(nContPasses, 18,ijkQcart)
  real(reals),intent(inout) :: OUT(nContPasses, 15,ijkQcart)
...
!$ACC PARALLEL LOOP PRIVATE(iP,ijkQ) PRESENT(IN,OUT) ASYNC(iASync)
  DO iP=1,nContPasses
   ...
   ENDDO
  ENDDO
end subroutine SPSphericalContractOBS1_GPU_maxAngP3_maxAngA1 
  
  
 subroutine SPSphericalContractOBS1_GPU_maxAngP4_maxAngA2(ijkQcart,nContPasses,IN,OUT,iASync)
  implicit none
  integer,intent(in)        :: ijkQcart,nContPasses
  real(reals),intent(in)    :: IN(nContPasses, 36,ijkQcart)
  real(reals),intent(inout) :: OUT(nContPasses, 25,ijkQcart)
  integer(kind=acckind),intent(in) :: iASync
  integer :: iP,ijkQ
...
!$ACC PARALLEL LOOP PRIVATE(iP,ijkQ) PRESENT(IN,OUT) ASYNC(iASync)
  DO iP=1,nContPasses
   ...
   ENDDO
  ENDDO
end subroutine SPSphericalContractOBS1_GPU_maxAngP4_maxAngA2 
  
  
END module SPAGC_GPU_OBS_Sphcontract1Mod
