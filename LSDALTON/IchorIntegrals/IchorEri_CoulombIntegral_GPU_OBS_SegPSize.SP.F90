module SPIchorEriCoulombintegralGPUOBSGeneralModSegPSize
...
private   
public :: SPICI_GPU_OBS_general_sizeSegP  
  
CONTAINS
  
  subroutine SPICI_GPU_OBS_general_sizeSegP(TMParray1maxsize,&
    ...
    END SELECT
  end subroutine SPICI_GPU_OBS_general_sizeSegP
END module SPIchorEriCoulombintegralGPUOBSGeneralModSegPSize
