module SPAGC_GPU_OBS_VERTICALRECURRENCEMODDSegP
 use IchorPrecisionMod
  
 CONTAINS


subroutine SPVerticalRecurrenceGPUSegP1D(nPassP,nPrimP,nPrimQ,&
...
end subroutine SPVerticalRecurrenceGPUSegP1D

subroutine SPVerticalRecurrenceGPUSegP2D(nPassP,nPrimP,nPrimQ,&
...
subroutine SPVerticalRecurrenceGPUSegP3D(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Dcenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray,iASync)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
