MODULE AGC_GPU_OBS_VERTICALRECURRENCEMODCSegQ
 use IchorPrecisionModule
  
 CONTAINS


subroutine VerticalRecurrenceGPUSegQ1C(nPassP,nPrimP,nPrimQ,&
...
end subroutine VerticalRecurrenceGPUSegQ1C

subroutine VerticalRecurrenceGPUSegQ2C(nPassP,nPrimP,nPrimQ,&
...
subroutine VerticalRecurrenceGPUSegQ3C(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Ccenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray,iASync)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
...
subroutine VerticalRecurrenceGPUSegQ4C(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Ccenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray,iASync)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
