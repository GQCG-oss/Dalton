...
!> \author T. Kjaergaard
!> \date 2013 
module SPIchorEriCoulombintegralCPUMcMspecL2EcoeffMod
use IchorPrecisionMod
use SPIchorEriCoulombintegralCPUMcMGeneralWTUVMod

CONTAINS
subroutine SPICHOR_Ecoeffn_maxAngP4_maxAngA3_LHS(nPrimP,nPass,Ecoeffn,ETIJ,PreExpFac,&
     & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass)
  implicit none
  integer,intent(in) :: nPrimP,nPass,MaxPasses,nAtomsA,nAtomsB
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(in) :: ETIJ(nprimP,nPass,0:4,0:3,0:1,3)
  real(reals),intent(in) :: PreExpFac(nPrimP,nAtomsA,nAtomsB)
  real(reals),intent(inout) :: Ecoeffn(nPrimP,nPass, 35, 30)
!  
...
!$OMP END MASTER
!$OMP BARRIER 
End subroutine SPICHOR_Ecoeffn_maxAngP4_maxAngA3_LHS
  
  
subroutine SPICHOR_Ecoeffn_maxAngP4_maxAngA2_LHS(nPrimP,nPass,Ecoeffn,ETIJ,PreExpFac,&
     & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass)
  implicit none
  integer,intent(in) :: nPrimP,nPass,MaxPasses,nAtomsA,nAtomsB
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(in) :: ETIJ(nprimP,nPass,0:4,0:2,0:2,3)
  real(reals),intent(in) :: PreExpFac(nPrimP,nAtomsA,nAtomsB)
  real(reals),intent(inout) :: Ecoeffn(nPrimP,nPass, 35, 36)
!  
  integer :: i,ii,iAtomA,iAtomB
!$OMP MASTER
!!$OMP DO COLLAPSE(2) PRIVATE(I,II)
...
!$OMP END MASTER
!$OMP BARRIER 
End subroutine SPICHOR_Ecoeffn_maxAngP4_maxAngA2_LHS
  
  
subroutine SPICHOR_Ecoeffn_maxAngP4_maxAngA1_LHS(nPrimP,nPass,Ecoeffn,ETIJ,PreExpFac,&
     & MaxPasses,nAtomsA,nAtomsB,IatomApass,IatomBpass)
  implicit none
  integer,intent(in) :: nPrimP,nPass,MaxPasses,nAtomsA,nAtomsB
  integer,intent(in) :: IatomApass(MaxPasses),IatomBpass(MaxPasses)
  real(reals),intent(in) :: ETIJ(nprimP,nPass,0:4,0:1,0:3,3)
  real(reals),intent(in) :: PreExpFac(nPrimP,nAtomsA,nAtomsB)
  real(reals),intent(inout) :: Ecoeffn(nPrimP,nPass, 35, 30)
!  
  integer :: i,ii,iAtomA,iAtomB
...
End subroutine SPICHOR_Ecoeffn_maxAngP4_maxAngA1_LHS

end module SPIchorEriCoulombintegralCPUMcMspecL2EcoeffMod
