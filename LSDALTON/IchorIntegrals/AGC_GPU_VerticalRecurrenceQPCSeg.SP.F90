module SPAGC_GPU_OBS_VERTICALRECURRENCEMODCSeg
 use IchorPrecisionMod
  
 CONTAINS


subroutine SPVerticalRecurrenceGPUSeg1C(nPassP,nPrimP,nPrimQ,&
...
!$ACC        nPrimP,nPrimQ,nPassP) ASYNC(iASync)
  ...
  ENDDO !iP = 1,nPassP
end subroutine SPVerticalRecurrenceGPUSeg1C

subroutine SPVerticalRecurrenceGPUSeg2C(nPassP,nPrimP,nPrimQ,&
...
subroutine SPVerticalRecurrenceGPUSeg3C(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Ccenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray,iASync)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
...
subroutine SPVerticalRecurrenceGPUSeg4C(nPassP,nPrimP,nPrimQ,&
         & reducedExponents,RJ000Array,Qexp,Ccenter,Pcent,Qcent,integralPrefactor,&
         & IatomApass,IatomBpass,MaxPasses,nAtomsA,nAtomsB,PpreExpFac,QpreExpFac,AUXarray,iASync)
  implicit none
  integer,intent(in) :: nPassP,nPrimP,nPrimQ
