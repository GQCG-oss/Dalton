MODULE AGC_GPU_OBS_TRMODAtoCGen1
...
!$ACC LOOP SEQ
     do ituvpminus1 = 1,10
      ...
      Tmp0(iTUVP,2) = Tmp0(iTUVP,2) + IfacX1_20(ituvpminus1)*inv2expQ*Aux(IP,ituvpminus1) 
     enddo
!$ACC LOOP SEQ
     do ituvpminus1 = 1,10
      iTUVP = TUVindexX2_35(ituvpminus1)
      Tmp0(iTUVP,3) = Tmp0(iTUVP,3) + IfacX2_20(ituvpminus1)*inv2expQ*Aux(IP,ituvpminus1) 
     enddo
!$ACC LOOP SEQ
     do ituvpminus1 = 1,10
      iTUVP = TUVindexX3_35(ituvpminus1)
      Tmp0(iTUVP,4) = Tmp0(iTUVP,4) + IfacX3_20(ituvpminus1)*inv2expQ*Aux(IP,ituvpminus1) 
     enddo
!$ACC LOOP SEQ
     do ituvpminus1 = 11,20
      iTUVP = TUVindexX1_35(ituvpminus1)
      Tmp1(iTUVP,2) = Tmp1(iTUVP,2) + IfacX1_20(ituvpminus1)*inv2expQ*Aux(IP,ituvpminus1) 
     enddo
!$ACC LOOP SEQ
     do ituvpminus1 = 11,20
      iTUVP = TUVindexX2_35(ituvpminus1)
      Tmp1(iTUVP,3) = Tmp1(iTUVP,3) + IfacX2_20(ituvpminus1)*inv2expQ*Aux(IP,ituvpminus1) 
     enddo
!$ACC LOOP SEQ
     do ituvpminus1 = 11,20
      iTUVP = TUVindexX3_35(ituvpminus1)
      Tmp1(iTUVP,4) = Tmp1(iTUVP,4) + IfacX3_20(ituvpminus1)*inv2expQ*Aux(IP,ituvpminus1) 
     enddo
!$ACC LOOP SEQ
     do iTUVP = 1,20
...
END MODULE AGC_GPU_OBS_TRMODAtoCGen1
