...
/* fun-pw91c.c:
   ...
   "Automatic code generation framework for analytical functional
    ...
    1. add "extern Functional pw91cFunctional;" to 'lsdalton_functionals.h'
...
static integer pw91c_read(const char *conf_line, real *hfweight);
...
/* IMPLEMENTATION PART */
static integer
pw91c_read(const char *conf_line, real *hfweight)
{
    return 1;
}
