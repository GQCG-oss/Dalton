...
static integer camb3lyp_read(const char *conf_line, real *hfweight);
static void camb3lyp_report(integer lupri);
...
static integer
camb3lyp_read(const char *conf_line, real *hfweight)
{
