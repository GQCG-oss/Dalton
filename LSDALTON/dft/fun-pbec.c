...
/* fun-pbec.c:
   ...
   derivative evaluation", Pawel Salek, 2005
    ...
    1. add "extern Functional pbecFunctional;" to 'lsdalton_functionals.h'
...
static integer pbec_read(const char *conf_line, real *hfweight);
...
/* IMPLEMENTATION PART */
static integer
pbec_read(const char *conf_line, real *hfweight)
{
    return 1;
}
