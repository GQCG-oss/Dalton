...
call mat_dhmul(omen,R(xxx),R(x),'n','n',-dble(32*m),1.0_realk,P)
call mat_dhmul(omen,R(yyy),R(y),'n','n',-dble(32*m),1.0_realk,P)
call mat_dhmul(omen,R(zzz),R(z),'n','n',-dble(32*m),1.0_realk,P)
...
call mat_dhmul(omen*dia(:,xx),R(x),temp,'n','n',dble(48*m),1.0_realk,P)
call mat_clone(temp,KURT%carmomMO(y))
call mat_dhmul(omen*dia(:,yy),R(y),temp,'n','n',dble(48*m),1.0_realk,P)
call mat_clone(temp,KURT%carmomMO(z))
call mat_dhmul(omen*dia(:,zz),R(z),temp,'n','n',dble(48*m),1.0_realk,P)

call mat_dhmul(omen*dia(:,x),R(x),R(xx),'n','n',dble(96*m),1.0_realk,P)
call mat_dhmul(omen*dia(:,y),R(y),R(yy),'n','n',dble(96*m),1.0_realk,P)
call mat_dhmul(omen*dia(:,z),R(z),R(zz),'n','n',dble(96*m),1.0_realk,P)
...
call mat_clone(temp,KURT%carmomMO(x))
call mat_dhmul(omen*dia(:,x)*dia(:,x),R(X),temp,'n','n',-dble(144*m),1.0_realk,P)
call mat_clone(temp,KURT%carmomMO(y))
call mat_dhmul(omen*dia(:,y)*dia(:,y),R(y),temp,'n','n',-dble(144*m),1.0_realk,P)
call mat_clone(temp,KURT%carmomMO(z))
call mat_dhmul(omen*dia(:,z)*dia(:,z),R(z),temp,'n','n',-dble(144*m),1.0_realk,P)

if (KURT%crossterms) then
   call mat_dhmul(omen*dia(:,xx),R(y),R(y),'n','n',dble(4*4*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,yy),R(x),R(x),'n','n',dble(4*4*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,xx),R(z),R(z),'n','n',dble(4*4*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,zz),R(x),R(x),'n','n',dble(4*4*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,yy),R(z),R(z),'n','n',dble(4*4*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,zz),R(y),R(y),'n','n',dble(4*4*m),1.0_realk,P) 
  

   call mat_dhmul(omen*dia(:,x),R(x),R(yy),'n','n',dble(2*16*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,y),R(y),R(xx),'n','n',dble(2*16*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,x),R(x),R(zz),'n','n',dble(2*16*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,z),R(z),R(xx),'n','n',dble(2*16*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,y),R(y),R(zz),'n','n',dble(2*16*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,z),R(z),R(yy),'n','n',dble(2*16*m),1.0_realk,P) 
    
   call mat_dhmul(omen,R(x),R(xyy),'n','n',-dble(2*16*m),1.0_realk,P) 
   call mat_dhmul(omen,R(y),R(xxy),'n','n',-dble(2*16*m),1.0_realk,P) 
   call mat_dhmul(omen,R(x),R(xzz),'n','n',-dble(2*16*m),1.0_realk,P) 
   call mat_dhmul(omen,R(z),R(xxz),'n','n',-dble(2*16*m),1.0_realk,P) 
   call mat_dhmul(omen,R(y),R(yzz),'n','n',-dble(2*16*m),1.0_realk,P) 
   call mat_dhmul(omen,R(z),R(yyz),'n','n',-dble(2*16*m),1.0_realk,P) 
   
   call mat_dhmul(omen*dia(:,x),R(y),R(xy),'n','n',dble(2*32*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,y),R(x),R(xy),'n','n',dble(2*32*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,x),R(z),R(xz),'n','n',dble(2*32*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,z),R(x),R(xz),'n','n',dble(2*32*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,y),R(z),R(yz),'n','n',dble(2*32*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,z),R(y),R(yz),'n','n',dble(2*32*m),1.0_realk,P) 

   call mat_dhmul(omen*dia(:,xy),R(x),R(y),'n','n',dble(64*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,xz),R(x),R(z),'n','n',dble(64*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,yz),R(y),R(z),'n','n',dble(64*m),1.0_realk,P) 
  
  
   call mat_dhmul(omen*dia(:,x)*dia(:,y),R(x),R(y),'n','n',-dble(24*4*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,y)*dia(:,x),R(y),R(x),'n','n',-dble(24*4*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,x)*dia(:,z),R(x),R(z),'n','n',-dble(24*4*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,z)*dia(:,x),R(z),R(x),'n','n',-dble(24*4*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,y)*dia(:,z),R(y),R(z),'n','n',-dble(24*4*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,z)*dia(:,y),R(z),R(y),'n','n',-dble(24*4*m),1.0_realk,P) 
  

   call mat_dhmul(omen*dia(:,y)*dia(:,y),R(x),R(x),'n','n',-dble(12*4*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,x)*dia(:,x),R(y),R(y),'n','n',-dble(12*4*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,x)*dia(:,x),R(z),R(z),'n','n',-dble(12*4*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,z)*dia(:,z),R(x),R(x),'n','n',-dble(12*4*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,z)*dia(:,z),R(y),R(y),'n','n',-dble(12*4*m),1.0_realk,P) 
   call mat_dhmul(omen*dia(:,y)*dia(:,y),R(z),R(z),'n','n',-dble(12*4*m),1.0_realk,P) 
...
if (m>1) then
    ...
    call mat_zero(Pt)
    call mat_daxpy(dble(-2*m),R(xxxx),Pt)
    call mat_daxpy(dble(-2*m),R(yyyy),Pt)
    call mat_daxpy(dble(-2*m),R(zzzz),Pt)
    
    call mat_dmul(dia(:,x),R(xxx),'n',dble(8*m),1.0_realk,Pt)
    call mat_dmul(dia(:,y),R(yyy),'n',dble(8*m),1.0_realk,Pt)
    call mat_dmul(dia(:,z),R(zzz),'n',dble(8*m),1.0_realk,Pt)
    
    call mat_dmul(dia(:,xxx),R(x),'n',dble(8*m),1.0_realk,Pt)
    call mat_dmul(dia(:,yyy),R(y),'n',dble(8*m),1.0_realk,Pt)
    call mat_dmul(dia(:,zzz),R(z),'n',dble(8*m),1.0_realk,Pt)
    
    call mat_dmul(dia(:,x)*dia(:,x),R(xx),'n',-dble(12*m),1.0_realk,Pt)
    call mat_dmul(dia(:,y)*dia(:,y),R(yy),'n',-dble(12*m),1.0_realk,Pt)
    call mat_dmul(dia(:,z)*dia(:,z),R(zz),'n',-dble(12*m),1.0_realk,Pt)
    
    call mat_dmul(dia(:,xx)*dia(:,x),R(x),'n',-dble(24*m),1.0_realk,Pt)
    call mat_dmul(dia(:,yy)*dia(:,y),R(y),'n',-dble(24*m),1.0_realk,Pt)
    call mat_dmul(dia(:,zz)*dia(:,z),R(z),'n',-dble(24*m),1.0_realk,Pt)
    
    call mat_dmul(dia(:,x)*dia(:,x)*dia(:,x),R(x),'n',dble(24*m),1.0_realk,Pt)
    call mat_dmul(dia(:,y)*dia(:,y)*dia(:,y),R(y),'n',dble(24*m),1.0_realk,Pt)
    call mat_dmul(dia(:,z)*dia(:,z)*dia(:,z),R(z),'n',dble(24*m),1.0_realk,Pt)

    if (KURT%crossterms) then
       call mat_daxpy(-dble(4*m),R(xxyy),Pt)  
       call mat_daxpy(-dble(4*m),R(xxzz),Pt)  
       call mat_daxpy(-dble(4*m),R(yyzz),Pt)  
      
       call mat_dmul(dia(:,x)*dia(:,y),R(xy),'n',-dble(16*m),1.0_realk,Pt)
       call mat_dmul(dia(:,x)*dia(:,z),R(xz),'n',-dble(16*m),1.0_realk,Pt)
       call mat_dmul(dia(:,z)*dia(:,y),R(yz),'n',-dble(16*m),1.0_realk,Pt)

       call mat_dmul(dia(:,xx)*dia(:,y),R(y),'n',-dble(8*m),1.0_realk,Pt)
       call mat_dmul(dia(:,yy)*dia(:,x),R(x),'n',-dble(8*m),1.0_realk,Pt)
       call mat_dmul(dia(:,xx)*dia(:,z),R(z),'n',-dble(8*m),1.0_realk,Pt)
       call mat_dmul(dia(:,zz)*dia(:,x),R(x),'n',-dble(8*m),1.0_realk,Pt)
       call mat_dmul(dia(:,yy)*dia(:,z),R(z),'n',-dble(8*m),1.0_realk,Pt)
       call mat_dmul(dia(:,zz)*dia(:,y),R(y),'n',-dble(8*m),1.0_realk,Pt)

       call mat_dmul(dia(:,x)*dia(:,x)*dia(:,y),R(y),'n',dble(24*m),1.0_realk,Pt)
       call mat_dmul(dia(:,y)*dia(:,y)*dia(:,x),R(x),'n',dble(24*m),1.0_realk,Pt)
       call mat_dmul(dia(:,x)*dia(:,x)*dia(:,z),R(z),'n',dble(24*m),1.0_realk,Pt)
       call mat_dmul(dia(:,z)*dia(:,z)*dia(:,x),R(x),'n',dble(24*m),1.0_realk,Pt)
       call mat_dmul(dia(:,y)*dia(:,y)*dia(:,z),R(z),'n',dble(24*m),1.0_realk,Pt)
       call mat_dmul(dia(:,z)*dia(:,z)*dia(:,y),R(y),'n',dble(24*m),1.0_realk,Pt)

       call mat_dmul(dia(:,x)*dia(:,xy),R(y),'n',-dble(16*m),1.0_realk,Pt)
       call mat_dmul(dia(:,y)*dia(:,xy),R(x),'n',-dble(16*m),1.0_realk,Pt)
       call mat_dmul(dia(:,x)*dia(:,xz),R(z),'n',-dble(16*m),1.0_realk,Pt)
       call mat_dmul(dia(:,z)*dia(:,xz),R(x),'n',-dble(16*m),1.0_realk,Pt)
       call mat_dmul(dia(:,y)*dia(:,yz),R(z),'n',-dble(16*m),1.0_realk,Pt)
       call mat_dmul(dia(:,z)*dia(:,yz),R(y),'n',-dble(16*m),1.0_realk,Pt)

       call mat_dmul(dia(:,xxy),R(y),'n',dble(8*m),1.0_realk,Pt)
       call mat_dmul(dia(:,xyy),R(x),'n',dble(8*m),1.0_realk,Pt)
       call mat_dmul(dia(:,xxz),R(z),'n',dble(8*m),1.0_realk,Pt)
       call mat_dmul(dia(:,xzz),R(x),'n',dble(8*m),1.0_realk,Pt)
       call mat_dmul(dia(:,yyz),R(z),'n',dble(8*m),1.0_realk,Pt)
       call mat_dmul(dia(:,yzz),R(y),'n',dble(8*m),1.0_realk,Pt)

       call mat_dmul(dia(:,x)*dia(:,x),R(yy),'n',-dble(4*m),1.0_realk,Pt)
       call mat_dmul(dia(:,y)*dia(:,y),R(xx),'n',-dble(4*m),1.0_realk,Pt)
       call mat_dmul(dia(:,x)*dia(:,x),R(zz),'n',-dble(4*m),1.0_realk,Pt)
       call mat_dmul(dia(:,z)*dia(:,z),R(xx),'n',-dble(4*m),1.0_realk,Pt)
       call mat_dmul(dia(:,y)*dia(:,y),R(zz),'n',-dble(4*m),1.0_realk,Pt)
       call mat_dmul(dia(:,z)*dia(:,z),R(yy),'n',-dble(4*m),1.0_realk,Pt)

       call mat_dmul(dia(:,x),R(xyy),'n',dble(8*m),1.0_realk,Pt)
       call mat_dmul(dia(:,y),R(xxy),'n',dble(8*m),1.0_realk,Pt)
       call mat_dmul(dia(:,x),R(xzz),'n',dble(8*m),1.0_realk,Pt)
       call mat_dmul(dia(:,z),R(xxz),'n',dble(8*m),1.0_realk,Pt)
       call mat_dmul(dia(:,y),R(yzz),'n',dble(8*m),1.0_realk,Pt)
       call mat_dmul(dia(:,z),R(yyz),'n',dble(8*m),1.0_realk,Pt)
    end if
...
call mat_daxpy(2.0_realk,R(xxxx),KF)
call mat_daxpy(2.0_realk,R(yyyy),KF)
call mat_daxpy(2.0_realk,R(zzzz),KF)

call mat_dmul(dia(:,x),R(xxx),'n',-8.0_realk,1.0_realk,KF)
call mat_dmul(dia(:,y),R(yyy),'n',-8.0_realk,1.0_realk,KF)
call mat_dmul(dia(:,z),R(zzz),'n',-8.0_realk,1.0_realk,KF)

call mat_dmul(dia(:,xxx),R(x),'n',-8.0_realk,1.0_realk,KF)
call mat_dmul(dia(:,yyy),R(y),'n',-8.0_realk,1.0_realk,KF)
call mat_dmul(dia(:,zzz),R(z),'n',-8.0_realk,1.0_realk,KF)

call mat_dmul(dia(:,x)*dia(:,x),R(xx),'n',12.0_realk,1.0_realk,KF)
call mat_dmul(dia(:,y)*dia(:,y),R(yy),'n',12.0_realk,1.0_realk,KF)
call mat_dmul(dia(:,z)*dia(:,z),R(zz),'n',12.0_realk,1.0_realk,KF)

call mat_dmul(dia(:,x)*dia(:,xx),R(x),'n',24.0_realk,1.0_realk,KF)
call mat_dmul(dia(:,y)*dia(:,yy),R(y),'n',24.0_realk,1.0_realk,KF)
call mat_dmul(dia(:,z)*dia(:,zz),R(z),'n',24.0_realk,1.0_realk,KF)

call mat_dmul(dia(:,x)*dia(:,x)*dia(:,x),R(x),'n',-24.0_realk,1.0_realk,KF)
call mat_dmul(dia(:,y)*dia(:,y)*dia(:,y),R(y),'n',-24.0_realk,1.0_realk,KF)
call mat_dmul(dia(:,z)*dia(:,z)*dia(:,z),R(z),'n',-24.0_realk,1.0_realk,KF)

if (KURT%crossterms) then
  call mat_init(tmp,KURT%norb,KURT%norb)
  call mat_zero(tmp)
  call mat_daxpy(4.0_realk,R(xxyy),tmp)  
  call mat_daxpy(4.0_realk,R(xxzz),tmp)  
  call mat_daxpy(4.0_realk,R(yyzz),tmp)  

  call mat_dmul(dia(:,x)*dia(:,y),R(xy),'n',16.0_realk,1.0_realk,tmp)
  call mat_dmul(dia(:,x)*dia(:,z),R(xz),'n',16.0_realk,1.0_realk,tmp)
  call mat_dmul(dia(:,y)*dia(:,z),R(yz),'n',16.0_realk,1.0_realk,tmp)
  
  call mem_alloc(tmpvec,KURT%norb)
  tmpvec =  dia(:,xx)*dia(:,y)-dia(:,xxy)-3.0_realk*dia(:,y)*dia(:,x)*dia(:,x)+2.0_realk*dia(:,x)*dia(:,xy) 
  call mat_dmul(tmpvec,R(y),'n',8.0_realk,1.0_realk,tmp)
  tmpvec =  dia(:,yy)*dia(:,x)-dia(:,xyy)-3.0_realk*dia(:,x)*dia(:,y)*dia(:,y)+2.0_realk*dia(:,y)*dia(:,xy) 
  call mat_dmul(tmpvec,R(x),'n',8.0_realk,1.0_realk,tmp)

  tmpvec =  dia(:,xx)*dia(:,z)-dia(:,xxz)-3.0_realk*dia(:,z)*dia(:,x)*dia(:,x)+2.0_realk*dia(:,x)*dia(:,xz) 
  call mat_dmul(tmpvec,R(z),'n',8.0_realk,1.0_realk,tmp)
  ...
  call mat_dmul(dia(:,y),R(xxy),'n',-8.0_realk,1.0_realk,tmp)
  call mat_dmul(dia(:,x),R(xyy),'n',-8.0_realk,1.0_realk,tmp)
  call mat_dmul(dia(:,z),R(xxz),'n',-8.0_realk,1.0_realk,tmp)
  call mat_dmul(dia(:,x),R(xzz),'n',-8.0_realk,1.0_realk,tmp)
  call mat_dmul(dia(:,z),R(yyz),'n',-8.0_realk,1.0_realk,tmp)
  call mat_dmul(dia(:,y),R(yzz),'n',-8.0_realk,1.0_realk,tmp)


  call mat_dmul(dia(:,x)*dia(:,x),R(yy),'n',4.0_realk,1.0_realk,tmp) 
  call mat_dmul(dia(:,y)*dia(:,y),R(xx),'n',4.0_realk,1.0_realk,tmp) 

  call mat_dmul(dia(:,x)*dia(:,x),R(zz),'n',4.0_realk,1.0_realk,tmp) 
  call mat_dmul(dia(:,z)*dia(:,z),R(xx),'n',4.0_realk,1.0_realk,tmp) 

  call mat_dmul(dia(:,y)*dia(:,y),R(zz),'n',4.0_realk,1.0_realk,tmp) 
  call mat_dmul(dia(:,z)*dia(:,z),R(yy),'n',4.0_realk,1.0_realk,tmp) 
