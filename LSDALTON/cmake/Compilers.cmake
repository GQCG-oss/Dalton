...
if(CMAKE_Fortran_COMPILER_ID MATCHES GNU) # this is gfortran
    ...
    set(CMAKE_Fortran_FLAGS_DEBUG   "-O0 -g -DVAR_DEBUG")
...
#    set_source_files_properties(${OWN_LAPACK_SOURCES} #${OWN_BLAS_SOURCES}
#        PROPERTIES COMPILE_FLAGS
#        "-ffloat-store"
#        )
...
if(CMAKE_Fortran_COMPILER_ID MATCHES Intel)
  ...
  # endif()
    ...
    set(CMAKE_Fortran_FLAGS_DEBUG   "-O0 -g -traceback -DVAR_DEBUG")
...
if(CMAKE_Fortran_COMPILER_ID MATCHES PGI)
    ...
    set(CMAKE_Fortran_FLAGS_DEBUG   "-g -O0 -Mlarge_arrays -mcmodel=medium -DVAR_DEBUG")
...
if(CMAKE_Fortran_COMPILER_ID MATCHES XL)
    ...
    set(CMAKE_Fortran_FLAGS_DEBUG   "-g -DVAR_DEBUG")
    ...
    set_source_files_properties(${LSDALTONMAIN_FORTRAN_SOURCES} ${LINEARS_SOURCES} ${RSPSOLVER_SOURCES} ${SOLVERUTIL_SOURCES} ${GEOOPT_SOURCES} ${LSUTIL_PRECISION_SOURCES} ${LSUTIL_COMMON_SOURCES} ${LSUTIL_MATRIXM_SOURCES} ${LSUTIL_MATRIXO_SOURCES} ${LSUTIL_MATRIXU_SOURCES} ${LSUTIL_TYPE_SOURCES} ${LSUTILLIB_SOURCES} ${INTERESTLIB_SOURCES} ${LSINT_SOURCES} ${RSP_PROPERTIES_SOURCES} ${LSLIB_SOURCES}
        PROPERTIES COMPILE_FLAGS
        "-qfree -qsuffix=f=f90:cpp=f90 -d"
        )
...
if(CMAKE_C_COMPILER_ID MATCHES GNU)
    ...
    set(CMAKE_C_FLAGS_DEBUG   "-O0 -g3 -DVAR_DEBUG")
...
if(CMAKE_C_COMPILER_ID MATCHES Intel)
    ...
    set(CMAKE_C_FLAGS_DEBUG   "-g -O0 -DVAR_DEBUG")
...
if(CMAKE_C_COMPILER_ID MATCHES PGI)
    ...
    set(CMAKE_C_FLAGS_DEBUG   "-g -O0 -c9x -DVAR_DEBUG")
