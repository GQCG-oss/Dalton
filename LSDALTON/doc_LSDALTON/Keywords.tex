...
For the most effcient orbital localization for large molecular systems, the .ARH, .START/TRILEVEL  and .LCM options are recommended for the *DENSOPT section described in Section \ref{subsec:densopt}.  
