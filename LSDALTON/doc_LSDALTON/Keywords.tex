...
for the lowext NEXCIT excited states (i.e. excited states 1 to NEXCIT) 
...
This choice can be modified activating the \Key{SYM\_SOLVER} and \Key{PAIR\_SOLVER}, as described below.
\begin{description}
...
\item Simulate the MCD spectrum based on the calculated $\mathcal{B}$ terms by associating a Lorentzian lineshape function (with lineshape parameter of 0.005 a.u.) to each $\mathcal{B}$ term (See Ref. \cite{KjaergaardMCD}). 
