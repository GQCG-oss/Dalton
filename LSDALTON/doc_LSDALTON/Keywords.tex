...
\verb|<Damping parameter gamma>|\newline
The $\gamma$ parameter is treated as an imaginary component of a frequency of interest and describes a broadening of
the spectrum~\cite{dampedresponse}.
\item[\Key{OLSEN}] \verb| | \newline
