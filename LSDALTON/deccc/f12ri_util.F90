...
contains
  ...
  subroutine F12RIB4(nBA,CalphaG,n1,n2,CalphaD,nD1,nD2,EJK,&
       & offset,dopair_occ_in)
    implicit none
  ...
  subroutine F12RIB9(nBA,CalphaG,n3,n1,CalphaD,nD1,nD2,EJK,noccfull,dopair_occ_in)
    implicit none
    integer,intent(in)        :: nBA,n1,n3,noccfull,nD1,nD2
    real(realk),intent(in)    :: CalphaG(nBA,n3,n1)
    real(realk),intent(in)    :: CalphaD(nBA,n1,n3)
    ...
    !$OMP noccfull,n1,n3,CalphaG,CalphaD,dopair_occ) REDUCTION(+:ED,EJ,EK)
    DO p=1,n3 !ncabs
       DO a=noccfull+1,n3 !nvirt
          DO j=1,n1 !nocc
             IF(dopair_occ(J,J)) THEN
  ...
  subroutine F12RIB9MPI(nBA,CalphaG,n3,n1,CalphaD,nD1,nD2,EJK,noccfull,&
    ...
    !$OMP PARALLEL DO COLLAPSE(3) DEFAULT(none) PRIVATE(p,a,i,j,alpha,&
    !$OMP tmpR,tmpRJ1,tmpRJ2,tmpG,tmpGJ1,tmpGJ2) SHARED(nBA,&
    !$OMP noccfull,n1,n3,CalphaGMPI,NBA2,CalphaG,CalphaD,dopair_occ) REDUCTION(+:ED,EJ,EK)
    DO p=1,n3 !ncabs
       DO a=noccfull+1,n3 !nvirt
          DO j=1,n1 !nocc
             IF(dopair_occ(J,J)) THEN
  ...
  subroutine F12RIB5(nBA,CalphaD,n1,n2,CalphaG,nbasis,nG1,&
       & CalphaGcabs,nGcabs1,nGcabs2,EJK,n3,dopair_occ_in)
    implicit none
  ...
  subroutine F12RIB5MPI(nBA,CalphaD,n1,n2,CalphaG,nbasis,nG1,&
       & CalphaGcabs,nGcabs1,nGcabs2,EJK,n3,NBA2,CalphaDMPI,CalphaGMPI,dopair_occ_in)
    implicit none
  ...
  subroutine F12RIB8(nBA,CalphaG,nocv,n1,CalphaR,nR1,n2,CalphaD,nD1,noccfull,EJK,offset,dopair_occ_in)
    implicit none
  ...
  !CalphaG(alpha1,m,j)*CalphaR(alpha1,i,p) * CalphaR(beta1,i,p)*CalphaD(beta1,j,m)
  subroutine F12RIB8MPI(nBA,CalphaG,nocv,n1,CalphaR,nR1,n2,CalphaD,nD1,noccfull,EJK,offset,NBA2,CalphaGMPI,CalphaRMPI,dopair_occ_in)
    implicit none
    ...
    !$OMP tmpR,tmpRJ1,tmpRJ2,tmpG,tmpGJ1,tmpGJ2) SHARED(nBA,n1,n2,&
    !$OMP nocv,noccfull,CalphaR,CalphaG,CalphaD,dopair_occ,CalphaRMPI,CalphaGMPI,&
