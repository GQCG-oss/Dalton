...
!$acc kernels present(ccsd_doubles_portions_i,ccsd_doubles_portions_j)
                    ccsd_doubles_portions_j = ccsd_doubles_portions_i
!$acc end kernels
...
!$acc enter data copyin(ccsd_doubles(:,:,:,k))
                    ...
                    if ((tuple_type .eq. 1) .or. (tuple_type .eq. 3)) then
                       ...
                       call array_reorder_3d(1.0E0_realk,ccsd_doubles(:,:,:,k),nvirt,nvirt,&
                               & nocc,[3,2,1],0.0E0_realk,ccsd_doubles_portions_k)
#endif
                    else ! tuple_type .eq. 2

!$acc kernels present(ccsd_doubles_portions_j,ccsd_doubles_portions_k)
                       ccsd_doubles_portions_k = ccsd_doubles_portions_j
!$acc end kernels
