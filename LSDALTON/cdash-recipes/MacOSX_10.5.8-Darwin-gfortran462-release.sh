...
CC=/sw/bin/gcc-4
FC=/sw/bin/gfortran
TMP_DIR=/Users/patrime/NightlyTestingCdash/tmp/Dalton-gfortran-Release
SCRATCH_DIR=$TMP_DIR/scratch
BUILD_NAME=build-release
BUILDNAME="MacOSX_10.5.8-Darwin-gfortran462-release"
...
./setup --fc=$FC --cc=$CC  --build=$BUILD_NAME --scratch=$SCRATCH_DIR -D BUILDNAME=$BUILDNAME
