...
TMP_DIR=/Users/patrime/NightlyTestingCdash/tmp/Dalton-gfortran-MPI-debug
SCRATCH_DIR=$TMP_DIR/scratch
BUILD_NAME=build-debug-mpi
BUILDNAME="MacOSX_10.5.8-Darwin-gfortran462-MPI-debug"
...
./setup --fc=$FC --cc=$CC --debug --mpi --build=$BUILD_NAME --scratch=$SCRATCH_DIR -D BUILDNAME=$BUILDNAME
