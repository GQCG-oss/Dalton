...
!!$
  ...
  SUBROUTINE LD0008(X,Y,Z,W,N)
    DOUBLE PRECISION X(  8)
    DOUBLE PRECISION Y(  8)
    DOUBLE PRECISION Z(  8)
    DOUBLE PRECISION W(  8)
    INTEGER N
    DOUBLE PRECISION A,B,V
!!$
!!$    LEBEDEV    8-POINT ANGULAR GRID
!!$
    N=1
    V=0.125D+0
    ...
    N=N-1
    RETURN
  END SUBROUTINE LD0008

  SUBROUTINE LD0012(X,Y,Z,W,N)
    DOUBLE PRECISION X(  12)
    DOUBLE PRECISION Y(  12)
    DOUBLE PRECISION Z(  12)
    DOUBLE PRECISION W(  12)
    INTEGER N
    DOUBLE PRECISION A,B,V
!!$
!!$    LEBEDEV   12-POINT ANGULAR GRID
!!$
    N=1
    V=0.0833333333333333D+0
    Call GEN_OH( 2, N, X(N), Y(N), Z(N), W(N), A, B, V)
    N=N-1
    RETURN
  END SUBROUTINE LD0012
