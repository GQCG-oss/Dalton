...
cbs   7. B2U: (0,1,0)
cbs   8. B3U: (1,0,0)
      integer*4 ipow2ired,iredorder,incrLM,shiftIRED,shiftIRIR
      integer*4 shiftIREDold
     ...
     *shiftIREDold(8),! shifts to get to old order 
     ...
     *mult(8,8),
     *iadditional(8), ! additional functions per IR
     ...
     *numballcart ! Number of cartesian functions   
cbs
