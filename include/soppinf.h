CPFP: TRIPLET was addes due to EXCTRP is in cbiexc.h and 
C     ccsdinp.h and cbiexc.h are incompatible. Also MAGPRP 
C     is adde in order to avoid the use of cbiexc.h
C
C      LOGICAL AOSOP, AORPA, SOPCHK, AOTEST, DCRPA, AOSOC
      LOGICAL AOSOP, AORPA, AOHRP, SOPCHK, AOTEST, DCRPA, AOSOC
C      LOGICAL TRIPLET
      LOGICAL TRIPLET, MAGPRP
Cend-PFP
...
Cend-PFP
     ...
     &                 LUGPVE, LUSOLA, LUGPV1, LUGPV2
CPFP
C      COMMON /SOPPEXC/ NEXCI2(8),THREX2
      COMMON /SOPPEXC/ NEXCI2(8),THREX2, N2P2HOP(8)
Cend-PFP
