...
C
     ...
     &        SQHDOL, SQHDOR, SQHD2O, S1ELE,  S1ELB,  ONEELD, THETA,
...
C
     ...
     &                SDKE,   DSOKE,  PSOOZ, DAR2EL, EFBDER, EFB2DR,
     &                MAGQDP, MQDPTS, ORBORB, DERAM, DIPANH
