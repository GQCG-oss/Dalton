C --- FILE: qm3.h ---
      ...
      LOGICAL PRFQM3, INTDIR, FORQM3, REDCNT, LGSPOL
      LOGICAL MMPCM
C 
C ---------------------------------------------------------
...
C 
      ...
      INTEGER NTOTIN, NUALIS, IQMBAS,NMMBA1, NREPMT
      INTEGER ISIGEPS, NSIGEPS, MXQ, NSTATES, ICQM3
      INTEGER NOSIMOLD, NOSIMFIRST
C
...
C
     ...
     *                MXDIIT, IQMBAS, NREPMT, NSIGEPS, NOSIMOLD,
     *                NOSIMFIRST
