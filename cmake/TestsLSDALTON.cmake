...
if(ENABLE_MPI)
    if(DEFINED ENV{DALTON_TEST_MPI})
        ...
        message(" -- DALTON_TEST_MPI defaults to 2")
...
add_test(LSint/LSDALTON_LSlib                           ${TEST_BASE} ${TEST_ARGS} LSint/LSDALTON_LSlib                          )
...
add_test(dectests/decmp2_energy                         ${TEST_BASE} ${TEST_ARGS} dectests/decmp2_energy                        )
add_test(dectests/decmp2_density                        ${TEST_BASE} ${TEST_ARGS} dectests/decmp2_density                       )
add_test(dectests/decmp2_gradient                       ${TEST_BASE} ${TEST_ARGS} dectests/decmp2_gradient                      )
add_test(dectests/decmp2_geoopt                         ${TEST_BASE} ${TEST_ARGS} dectests/decmp2_geoopt                        )
add_test(dectests/fullmp2_energy                        ${TEST_BASE} ${TEST_ARGS} dectests/fullmp2_energy                       )
add_test(dectests/fullcc2                               ${TEST_BASE} ${TEST_ARGS} dectests/fullcc2                              )
add_test(dectests/fullccsd_high                         ${TEST_BASE} ${TEST_ARGS} dectests/fullccsd_high                        )
add_test(dectests/fullccsd_3                            ${TEST_BASE} ${TEST_ARGS} dectests/fullccsd_3                           )
add_test(dectests/fullccsd_2                            ${TEST_BASE} ${TEST_ARGS} dectests/fullccsd_2                           )
add_test(dectests/arraytest                             ${TEST_BASE} ${TEST_ARGS} dectests/arraytest                            )
add_test(dectests/reordertest                           ${TEST_BASE} ${TEST_ARGS} dectests/reordertest                          )
add_test(dectests/decmp2_gradient_debug                 ${TEST_BASE} ${TEST_ARGS} dectests/decmp2_gradient_debug                )
...
if(NOT ENABLE_RELEASE)
  add_test(LSint/LSDALTON_uncontAObatch                  ${TEST_BASE} ${TEST_ARGS} LSint/LSDALTON_uncontAObatch                  )
  ...
  add_test(dectests/fullmp2_f12                           ${TEST_BASE} ${TEST_ARGS} dectests/fullmp2_f12                          )
  add_test(dectests/fullmp2_local_f12                     ${TEST_BASE} ${TEST_ARGS} dectests/fullmp2_local_f12                    )
  add_test(dectests/fullccsd_f12                          ${TEST_BASE} ${TEST_ARGS} dectests/fullccsd_f12                         )
  add_test(dectests/fullccsd_1                            ${TEST_BASE} ${TEST_ARGS} dectests/fullccsd_1                           )
  add_test(dectests/fullccsd_low                          ${TEST_BASE} ${TEST_ARGS} dectests/fullccsd_low                         )
  add_test(dectests/fullccsdpt                            ${TEST_BASE} ${TEST_ARGS} dectests/fullccsdpt                           )
  add_test(dectests/decccsdpt                             ${TEST_BASE} ${TEST_ARGS} dectests/decccsdpt                            )
  add_test(dectests/decccsdpt_simfull                     ${TEST_BASE} ${TEST_ARGS} dectests/decccsdpt_simfull                    )
  add_test(dectests/decmp2_gradient_debug2                ${TEST_BASE} ${TEST_ARGS} dectests/decmp2_gradient_debug2               )
  add_test(dectests/decmp2_energy_FO                      ${TEST_BASE} ${TEST_ARGS} dectests/decmp2_energy_FO                     )
  add_test(dectests/decmp2_geoopt_FO                      ${TEST_BASE} ${TEST_ARGS} dectests/decmp2_geoopt_FO                     )
  add_test(dectests/decccsd                               ${TEST_BASE} ${TEST_ARGS} dectests/decccsd                              )
