...
if(ENABLE_MPI AND ENABLE_SCALAPACK AND NOT USE_32BIT_MPI_INTERFACE)
    ...
    add_lsdalton_test(SCALAPACK/linsca_energy_SCALAPACK               "linsca;scalapack")
...
if(ENABLE_XCFUN)
    add_lsdalton_test(LSresponse/LSresponse_xcfun_lda_molgrad "linsca;xcfun")
    add_lsdalton_test(LSresponse/LSresponse_xcfun_gga_molgrad "linsca;xcfun")
    add_lsdalton_test(LSresponse/LSresponse_xcfun_lda_linrsp  "linsca;xcfun")
    add_lsdalton_test(LSresponse/LSresponse_xcfun_gga_linrsp  "linsca;xcfun")
endif()
...
#   add_lsdalton_test(csr/LSDALTON_DENSFIT_FMM_csr            "linsca;csr")
    ...
    add_lsdalton_test(linsca/linsca_admm                             "linsca")
    add_lsdalton_test(linsca/linsca_admm_df                          "linsca")
    add_lsdalton_test(linsca/linsca_ADMM1                            "linsca")
    add_lsdalton_test(linsca/linsca_ADMM2                            "linsca")
    add_lsdalton_test(linsca/linsca_ADMMQ                            "linsca")
    add_lsdalton_test(linsca/linsca_ADMMP                            "linsca")
    add_lsdalton_test(linsca/linsca_ADMMS                            "linsca")
    add_lsdalton_test(linsca/linsca_ADMMS-KT3X                       "linsca")
...
#   add_lsdalton_test(linsca/linsca_direct_dens                      "linsca")
    ...
    add_lsdalton_test(linsca/linsca_atoms                            "linsca")
    add_lsdalton_test(linsca/linsca_trilevel                         "linsca")
    add_lsdalton_test(linsca/lsdalton_dft_ssfgrid                    "linsca")
    add_lsdalton_test(linsca/test_kurtosis                           "linsca")
    add_lsdalton_test(linsca/PipekMezeyLowdin                        "linsca")
    add_lsdalton_test(linsca/linsca_lcm_nongc                        "linsca")
    add_lsdalton_test(linsca/test_soeo                               "linsca")
    add_lsdalton_test(LSint/LSDALTON_b3lyp_water                     "linsca")
    add_lsdalton_test(LSint/LSDALTON_pure                            "linsca")
...
if(NOT ENABLE_MPI)
    ...
    add_lsdalton_test(LSint/LSDALTON_dftfunc_pbe0                    "linsca")
    add_lsdalton_test(LSint/LSDALTON_dftfunc_pw86x                   "linsca")
    add_lsdalton_test(LSint/LSDALTON_dftfunc_vwn3                    "linsca")
    add_lsdalton_test(LSint/LSDALTON_dftfunc_GGAKey                  "linsca")
    add_lsdalton_test(LSint/LSDALTON_ethane_df_dft_molgrad           "linsca")
    ...
    add_lsdalton_test(LSint/LSDALTON_ethane_dft_molgrad              "linsca")
...
#   add_lsdalton_test(LSint/LSDALTON_fmm_twoel_gradient              "linsca")
    ...
    add_lsdalton_test(LSint/LSDALTON_Link                            "linsca")
    ...
    add_lsdalton_test(LSint/LSDALTON_ethane_pari_b3lyp               "linsca")
    add_lsdalton_test(LSint/LSDALTON_ethane_pari_b3lyp_unconstrained "linsca")
    add_lsdalton_test(LSint/LSDALTON_ethane_pari_b3lyp_ChgConst      "linsca")
    add_lsdalton_test(LSint/LSDALTON_ethane_pari_b3lyp_ChgDipConst   "linsca")
    add_lsdalton_test(LSint/LSDALTON_UNCONT                          "linsca")
    add_lsdalton_test(LSint/LSDALTON_ethane_dft_disp                 "linsca")
    add_lsdalton_test(LSint/LSDALTON_ethane_dft_D2disp               "linsca")
    add_lsdalton_test(LSint/LSDALTON_ethane_dft_D3disp               "linsca")
    add_lsdalton_test(LSint/LSDALTON_ethane_dft_D3bjdisp             "linsca")
...
#    add_lsdalton_test(LSresponse/LSresponse_HF_alpha_aK              "linsca")
    ...
    add_lsdalton_test(LSresponse/LSresponse_HF_dtpa                  "linsca")
    add_lsdalton_test(LSresponse/LSresponse_HF_esd                   "linsca")
    add_lsdalton_test(LSresponse/LSresponse_HF_esg                   "linsca")
    add_lsdalton_test(LSresponse/LSresponse_HF_gamma                 "linsca")
    add_lsdalton_test(LSresponse/LSresponse_HF_gamma_lcm             "linsca")
    add_lsdalton_test(LSresponse/LSresponse_HF_molgra                "linsca")
    add_lsdalton_test(LSresponse/LSresponse_HF_opa                   "linsca")
    add_lsdalton_test(LSresponse/LSresponse_HF_tpa                   "linsca")
    add_lsdalton_test(LSresponse/LSresponse_DFT_alpha                "linsca")
    add_lsdalton_test(LSresponse/LSresponse_DFT_alpha_aptv           "linsca")
    add_lsdalton_test(LSresponse/LSresponse_DFT_beta                 "linsca")
    add_lsdalton_test(LSresponse/LSresponse_DFT_dipole               "linsca")
    ...
    add_lsdalton_test(LSresponse/LSresponse_DFT_tpa                  "linsca")
    add_lsdalton_test(LSresponse/LSresponse_NMR_SHIELD               "linsca")
    add_lsdalton_test(LSresponse/LSresponse_mcd                      "linsca")
    add_lsdalton_test(LSresponse/LSresponse_mcd2                     "linsca")
    add_lsdalton_test(LSresponse/LSresponse_mcd3                     "linsca")
    add_lsdalton_test(LSresponse/LSresponse_mcd_calc                 "linsca")
    add_lsdalton_test(LSresponse/LSresponse_excit_cs00               "linsca")
    add_restart_test(LSresponse/LSresponse_excit_restart             "linsca,restart")
    add_lsdalton_test(geomopt/Excited_state_opt                      "linsca")
    ...
    add_lsdalton_test(ddynam/H2O_NHchain                             "linsca")
    add_lsdalton_test(ddynam/HCN_ddyn                                "linsca")
    add_lsdalton_test(ddynam/HF_vib                                  "linsca")
    add_lsdalton_test(ddynam/H2O_fmd                                 "linsca")
    add_lsdalton_test(dectests/decmp2_StressTest                     "linsca;dec")
    add_lsdalton_test(dectests/decmp2_energy                         "linsca;dec")
    add_lsdalton_test(dectests/decmp2_density                        "linsca;dec")
    add_lsdalton_test(dectests/decmp2_gradient                       "linsca;dec")
    add_lsdalton_test(dectests/decmp2_geoopt                         "linsca;dec")
    add_lsdalton_test(dectests/fullmp2_energy                        "linsca;dec;fulldec")
    add_lsdalton_test(dectests/fullcc2                               "linsca;dec;fulldec")
    add_lsdalton_test(dectests/fullccsd_high                         "linsca;dec;fulldec")
if(ENABLE_MPI)
...
if(ENABLE_ICHOR)
    ...
    add_lsdalton_test(IchorTestDir/IchorThermiteTesting1   "linsca;ichor")
    add_lsdalton_test(IchorTestDir/IchorThermiteTesting2   "linsca;ichor")
    add_lsdalton_test(IchorTestDir/IchorThermiteTesting3   "linsca;ichor")
    add_lsdalton_test(IchorTestDir/IchorThermiteTesting4   "linsca;ichor")
    add_lsdalton_test(IchorTestDir/IchorThermiteTesting5   "linsca;ichor")
    add_lsdalton_test(IchorTestDir/IchorThermiteTesting6   "linsca;ichor")
    ...
    add_lsdalton_test(LSint/LSDALTON_UHF_JENGINE_LINK      "linsca")
    ...
    add_lsdalton_test(LSresponse/LSresponse_DFT_excit_beta "linsca")
    add_lsdalton_test(LSresponse/LSresponse_HF_gamma_SVD   "linsca")
    add_lsdalton_test(dectests/fullmp2_f12                 "linsca;dec;fulldec;f12")
    add_lsdalton_test(dectests/decmp2f12                   "linsca;dec;f12")
    add_lsdalton_test(dectests/decmp2f12_h2                "linsca;dec;f12")
    ...
    add_lsdalton_test(dectests/fullccsdpt                  "linsca;dec;fulldec")
    add_lsdalton_test(dectests/fullccsd_mo                 "linsca;dec;fulldec")
    add_lsdalton_test(dectests/decccsdpt                   "linsca;dec")
    add_lsdalton_test(dectests/decccsdpt_fragopt           "linsca;dec")
    add_lsdalton_test(dectests/decccsdpt_virt              "linsca;dec")
    add_lsdalton_test(dectests/decccsdpt_simfull           "linsca;dec")
    add_lsdalton_test(dectests/decmp2_gradient_debug2      "linsca;dec")
    add_lsdalton_test(dectests/decmp2_energy_FO            "linsca;dec")
    add_lsdalton_test(dectests/decmp2_geoopt_FO            "linsca;dec")
    add_lsdalton_test(dectests/decccsd                     "linsca;dec;decccsd")
    add_lsdalton_test(dectests/decccsd_Bind                "linsca;dec;decccsd")
    add_lsdalton_test(dectests/decccsd_BSSE                "linsca;dec;decccsd")
    add_restart_test(dectests/decccsd_restart              "linsca;dec;decccsd;restart")
    add_lsdalton_test(dectests/decccsd_mo_local            "linsca;dec;decccsd")
    add_lsdalton_test(dectests/decccsd_mo_pdm              "linsca;dec;decccsd")
    add_lsdalton_test(dectests/deccc2_mo                   "linsca;dec")
    add_lsdalton_test(dectests/decrpa_energy               "linsca;dec;rpa")
    add_lsdalton_test(dectests/fullccsd_debug_mult         "linsca;dec;fulldec")
    add_lsdalton_test(dectests/decccsd_pno                 "linsca;dec;decccsd")
    add_lsdalton_test(dectests/arraytest                   "linsca;dec")
if(NOT ENABLE_MPI)
    add_lsdalton_test(pbc2/pbc2_h2fock                     "linsca;pbc")
    add_lsdalton_test(pbc2/pbc2_h2SCF_iter1                "linsca;pbc")
    add_lsdalton_test(pbc2/pbc2_h2STO6G                    "linsca;pbc")
    add_lsdalton_test(pbc2/pbc2_h2mol                      "linsca;pbc")
endif()
endif()
if(NOT ENABLE_MPI)
#   add_lsdalton_test(LSresponse/LSresponse_HF_molHessian  "linsca")
endif()
