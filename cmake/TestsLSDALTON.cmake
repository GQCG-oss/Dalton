...
add_lsdalton_runtest(LSresponse/LSresponse_NMR_DF_SHIELD_NoOpenRSP "linsca;lsresponse")
...
if(ENABLE_DEC)
  ...
  if(ENABLE_LARGE_TEST)
    add_lsdalton_runtest(dectests/large_decrimp2                 "linsca;dec;large;restart")
    add_lsdalton_runtest(dectests/large_dec_ccsdpt               "linsca;dec;large;decccsd")
...
if(DEVELOPMENT_CODE AND NOT ENABLE_RELEASE)
   ...
   if(ENABLE_DEC)
      ...
      endif(ENABLE_REAL_SP)

      if(ENABLE_LARGE_TEST)
         add_lsdalton_runtest(dectests/large_full_ccsdpt     "linsca;dec;large;fulldec")
      endif(ENABLE_LARGE_TEST)
   endif(ENABLE_DEC)
...
endif(DEVELOPMENT_CODE AND NOT ENABLE_RELEASE)
