...
# JMHO: in test directory but were not here before
add_dalton_test(prop_exci_aorpa_sing             "dalton;prop;unknown")
add_dalton_test(prop_exci_aorpa_trip             "dalton;prop;unknown")
add_dalton_test(prop_exci_morpa_trip             "dalton;prop;unknown")
...
# JMHO: in test directory but were not here before
add_dalton_test(rsp_socorr_dir                   "dalton;rsp;unknown")
add_dalton_test(rsp_socorr2_dir                  "dalton;rsp;unknown")
add_dalton_test(rsp_socorr3_dir                  "dalton;rsp;unknown")
#
...
if(DEVELOPMENT_CODE AND NOT ENABLE_RELEASE)
    add_dalton_runtest(qmmm7                         "dalton;runtest;qmmm;unknown")
endif()
...
add_dalton_test(ccr3_exci                        "dalton;cc;unknown")
...
add_dalton_test(cc2_r12_aux_ch4_a2               "dalton;ccr12;verylong")
add_dalton_test(cc2_r12_aux_ch4_sym_a2           "dalton;ccr12;verylong")
...
add_dalton_runtest(pcm_dipole                    "dalton;runtest;pcm;unknown")
add_dalton_runtest(pcm_polar                     "dalton;runtest;pcm;unknown")
add_dalton_runtest(pcm_ecd                       "dalton;runtest;pcm;long")
add_dalton_runtest(pcm_lf_hfnosym_linres         "dalton;runtest;pcm;short")
add_dalton_runtest(pcm_lf_dipole                 "dalton;runtest;pcm;unknown")
