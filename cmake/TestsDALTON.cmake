...
# medium, between 1 min and 5 min on GitLab ci-runner
# long, above 5 min on GitLab ci-runner
if (ENABLE_SRDFT) 
   ...
   add_dalton_runtest(rsp_hf_srVWN5_c_mu_zero_fermi_nosymm "dalton;srdft;rsp;runtest;short;parallel;essential")
   add_dalton_runtest(rsp_hf_srLDA_x_mu_zero_fermi_nosymm  "dalton;srdft;rsp;runtest;short;parallel;essential")
   add_dalton_runtest(rsp_mc_srPBE_mu_04_fermi             "dalton;srdft;rsp;runtest;long;parallel")
   add_dalton_runtest(rsp_mc_srPBE_mu_zero_fermi_nosymm    "dalton;srdft;rsp;runtest;medium;parallel")
   ...
   add_dalton_runtest(rsp_mc_srLDA_mu_zero_fermi_nosymm    "dalton;srdft;rsp;runtest;short;parallel")
   ...
   add_dalton_runtest(rsp_hf_srLDA_mu_zero_fermi_nosymm    "dalton;srdft;rsp;runtest;short;parallel")
   add_dalton_runtest(rsp_hf_srPBE_mu_zero_fermi_nosymm    "dalton;srdft;rsp;runtest;medium;parallel")
   add_dalton_runtest(rsp_hf_srPBE_x_mu_zero_fermi_nosymm  "dalton;srdft;rsp;runtest;short;parallel;essential")
   add_dalton_runtest(rsp_hf_srPBE_c_mu_zero_fermi_nosymm  "dalton;srdft;rsp;runtest;short;parallel;essential")
