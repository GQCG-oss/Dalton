...
if(ENABLE_PELIB)
    ...
    add_dalton_runtest(pehf_restart                  "dalton;pelib;runtest;multistep;short")
    ...
    add_dalton_runtest(pesoppa_excit                 "dalton;serial;pelib;runtest;soppa;short")
    ...
    add_dalton_runtest(pehf_geoopt                   "dalton;pelib;geo;runtest;short")
    add_dalton_runtest(pdehf                         "dalton;pelib;runtest;multistep;short;essential")
    if(ENABLE_QFITLIB)
        add_dalton_runtest(pdehf_couplings_top           "dalton;pelib;qfit;runtest;short")
        add_dalton_runtest(pdehf_embedded_couplings_top  "dalton;pelib;qfit;runtest;short")
        add_dalton_runtest(pehf_trcube                   "dalton;pelib;qfit;runtest;short")
    endif()
endif()
