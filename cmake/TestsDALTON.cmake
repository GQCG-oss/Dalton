...
add_dalton_runtest(newcc3_h2o                    "dalton;serial;cc;runtest;short;essential")
...
if(ENABLE_PELIB)
    ...
    add_dalton_runtest(pecc_cc2                      "dalton;serial;pelib;runtest;short")
    add_dalton_runtest(pecc_ccsd                     "dalton;serial;pelib;runtest;short")
    add_dalton_runtest(pecc_ccr3                     "dalton;serial;pelib;runtest;short;essential")
...
if (ENABLE_SRDFT) 
   ...
   add_dalton_runtest(energy_srTPSS_openshell              "dalton;srdft;runtest;energy;short;parallel;essential")
