...
set(CPACK_PACKAGE_INSTALL_DIRECTORY    "DALTON ${DALTON_VERSION}")
set(CPACK_SOURCE_INSTALLED_DIRECTORIES "${EXPORT_DIR};/")

include(CPack)

set(DIRS_TO_RELEASE basis cmake CMakeLists.txt COPYING CTestConfig.cmake DALTON external INSTALL.rst LSDALTON setup TESTING.rst update VERSION)
...
add_custom_target(
    ...
    COMMAND rm -rf ${EXPORT_DIR}/external/pe-lib/.git
