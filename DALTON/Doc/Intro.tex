...
based on an HF, HF-srDFT, DFT, MP2, coupled cluster,
CI, MCSCF, MC-srDFT, NEVPT2 reference wave function.
...
well sd density functional theory, in particular second-order static
