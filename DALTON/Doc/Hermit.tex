...
\texttt{AOPROPER}\index{AOPROPER}\index{integral label}.
...
Note that the following AO property integrals \index{property integral} are
...
the \Key{GAUGEO} keyword in this input section.
...
\molinp\ file, and \verb|ab| is the number of the
...
first letters in the name of this atom, as given in the
\molinp\ file, and \verb|cd| is the number of the
symmetry-adapted nucleus.
\end{list}
...
orbitals}. Note that the gauge origin is controlled by the keyword \Key{GAUGEO}.
...
\index{CTOCD-DZ!diamagnetic magnetizability} see Ref.~\cite{paololazz1,paololazz2}.
...
\index{CTOCD-DZ!diamagnetic nuclear shieldings}  
...
\item[\Key{SKIP}] Skip the calculation of one-electron Hamiltonian
