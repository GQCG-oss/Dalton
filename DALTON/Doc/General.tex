...
\item[\Key{HJJTRA}]\verb| |\newline
\verb|READ (LUCMD, *) HJJTRA_TYPE|
\index{integral transformation!direct"} Requests that the
direct two-electron integral transformation routines of Hans J\o rgen Aagaard Jensen (2014)
are used.
