...
\begin{enumerate}
\item{\bf QFIT library - fitting charges, possibly dipoles and possibly quadrupoles to simulate electrostatic potential from QM wave functions (Main author: Casper Steinmann) }
\end{enumerate}
