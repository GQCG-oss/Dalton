...
\begin{list}{}{}
\item PE library: J.~M.~H.~Olsen. The polarizable embedding (PE) library (version 1.2), 2014
...
\item PE-CC: K.~Sneskov, T.~Schwabe, J.~Kongsted and O.~Christiansen. \newblock {\em J.~ Chem.~Phys.}, {\bf 134}, 104108, (2011) and D.~Hr\v{s}ak, J.~M.~H.~Olsen and J.~Kongsted. \newblock {\em J.~ Chem.~Theor.~Comput.}, {\bf 14}, 1351, (2018).
...
does not support point-group symmetry or analytical molecular Hessians.
