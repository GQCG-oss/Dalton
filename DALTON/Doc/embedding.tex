...
10 6  7  8  9
\end{verbatim}
where the values have been truncated for readability. Note, that the input is actually not case-sensitive even though we have used uppercase letters in the example. In the following we describe the contents of each section.\\
