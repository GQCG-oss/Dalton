...
\index{polarizable embedding}\index{PE}\index{environment model}\index{embedding model}\index{multiscale model}\index{multiscale}\index{embedding}\index{QM/MM}\index{quantum mechanics / molecular mechanics}\index{solvent effects}\index{enviroment effects}
...
10 6  7  8  9
\end{verbatim}
where the values have been truncated for readability. Note, that the
input is actually not case-sensitive even though we have used
