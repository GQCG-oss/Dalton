...
\newcommand{\pot}{{\sc potential}\index{\sc potential}}
...
\newcommand{\dalinp}{{DALTON.INP}\index{dalton input file}}
\newcommand{\molinp}{{MOLECULE.INP}\index{molecule input file}}
\newcommand{\potinp}{{POTENTIAL.INP}\index{potential input file}}
