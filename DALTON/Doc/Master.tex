...
\newcommand{\dalinp}{{\tt DALTON.INP}\index{dalton input file}}
\newcommand{\molinp}{{\tt MOLECULE.INP}\index{molecule input file}}
\newcommand{\potinp}{{\tt POTENTIAL.INP}\index{potential input file}}
