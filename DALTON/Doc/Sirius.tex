...
\item[\Key{SRFUN}] \ \\
  \kw{READ (LUINP,'(A80)') LINE} \\
  Specification of functional used for \quotekw{.HFSRDFT} and \qoutekw{.MCSRDFT} calculations.

\item[\Key{HFXFAC}] \ \\
  \kw{READ (LUINP,'(A80)') LINE} \\
  Specification of the full-range Hartree-Fock like exchange for \quotekw{.HFSRDFT} and \qoutekw{.MCSRDFT} calculations.
