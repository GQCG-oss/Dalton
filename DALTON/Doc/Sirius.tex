...
In addition a number of double-hybrid functionals (energies only) are availble,
...
\item[B2TPLYP] is a modification of the B2PLYP functional for theromdynamics~\cite{dft:b2tplyp}
