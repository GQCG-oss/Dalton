      SUBROUTINE GET_FVVEC_LR(UDV,UDVTR,CMO,BOVECS,FVVEC,IDIM,NSIM,    &
     &                        WORK,LWORK)
!
! Purpose:
...
!
      ...
      SUBROUTINE GET_XYVEC_LR(FMQVEC,CMO,IDIM,nsim,FXYVEC,WORK,LWORK)
!
! Purpose:
...
#include "infrsp.h"
!
      real(8) :: FMQVEC(nsim*IDIM), CMO(NORBT*NBAST)
      real(8) :: FXYVEC(nsim*N2ORBX), WORK(LWORK)
      integer :: lwork
!
      LOGICAL TOFILE,TRIMAT,EXP1VL
      integer :: INTREP(9*MXCENT), INTADR(9*MXCENT)
