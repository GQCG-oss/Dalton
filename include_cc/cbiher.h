C
C$Id: cbiher.h,v 1.1 2001-02-12 18:21:46 vebjornb Exp $
C
     ...
     &        DPLGRA, QUAGRA, OCTGRA, ROTSTR, THRMOM, SOMM, SOFLD,
     &        DEROVL, DERHAM
     ...
     &                THETA, DPLGRA, QUAGRA, OCTGRA, ROTSTR, THRMOM,
     &                SOFLD, SOMM, DEROVL, DERHAM
